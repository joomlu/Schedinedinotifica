...
return [
    ...
    "titolo" => "Titolo",
    "titoli" => "Titoli",
    "lista_titoli" => "Lista Titoli",
    "nuovo_titolo" => "Nuovo Titolo",
    "modifica_titolo" => "Modifica Titolo",
    "elimina_titolo" => "Elimina Titolo",
    "nome_titolo" => "Nome",
    "descrizione_titolo" => "Descrizione",
    "azioni" => "Azioni",
    "conferma_eliminazione_titolo" => "Sei sicuro di voler eliminare questo titolo?",
    "titolo_creato_successo" => "Titolo creato con successo.",
    "titolo_aggiornato_successo" => "Titolo aggiornato con successo.",
    "titolo_eliminato_successo" => "Titolo eliminato con successo.",
    "errore_titolo" => "Si è verificato un errore con il titolo.",
    "nessun_titolo" => "Nessun titolo presente.",
    "cerca_titolo" => "Cerca Titolo...",
    "paginazione_titolo" => "Mostra da :from a :to di :total titoli",
    "TipoVia" => "Tipo Via",
    "menu"=>"Menù",
