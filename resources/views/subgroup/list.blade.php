...
@slot('title') @lang('translation.SubGroups') @endslot
@endcomponent
...
<form method="POST" action="{{route('subgroup.store')}}">
@csrf 
<div>
                    ...
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a  href="{{ route('subgroup.destroy',['id' => $group->id] )}}" onclick="
                      ...
                      <i class="ri-delete-bin-5-line"></i><a>     
                                ...
                                <div id="ModalEdit{{$group->id}}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="myModalEditLabel">@lang('translation.edit') @lang('translation.SubGroup')</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                                            </div>
                                            <div class="modal-body">
                                                    <form method="POST" action="{{route('subgroup.update', $group->id)}}">
                                                    @csrf 
                                                    @method('PUT') 
                                                                <div>
                                                                    <label for="basiInput" class="form-label">@lang('translation.Name')</label>
