        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-tabs-custom flex-nowrap overflow-auto mb-4" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ $activeTab === 'dati' ? 'active' : '' }}" data-bs-toggle="tab" data-bs-target="#struttura-pane-dati" type="button" role="tab">Dati struttura</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ $activeTab === 'relazione' ? 'active' : '' }}" data-bs-toggle="tab" data-bs-target="#struttura-pane-relazione" type="button" role="tab">Relazione e pagamenti</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ $activeTab === 'licenze' ? 'active' : '' }}" data-bs-toggle="tab" data-bs-target="#struttura-pane-licenze" type="button" role="tab">Licenze</button>
                </li>
            </ul>

            <form id="superadmin-struttura-main-form" method="POST" action="{{ $mode === 'create' ? route('superadmin.strutture.store') : route('superadmin.strutture.update', $struttura->id) }}">
                @csrf
                @if($mode === 'edit')
                    @method('PUT')
                @endif
                <input type="hidden" name="return_to_owner_id" value="{{ $returnToOwnerId ?? '' }}">
                <input type="hidden" name="active_tab" id="struttura_active_tab" value="{{ $activeTab }}">
            </form>

            <div class="tab-content">
                    <div class="tab-pane fade {{ $activeTab === 'dati' ? 'show active' : '' }}" id="struttura-pane-dati" role="tabpanel">
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="border rounded-3 p-3 bg-light-subtle">
                                    <div class="fw-semibold mb-1">Scheda struttura</div>
                                    <div class="text-muted small">Qui salvi i dati principali della struttura. La parte commerciale e licenze resta separata nei tab dedicati.</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Nome struttura</label>
                                <input type="text" name="nome_struttura" class="form-control" form="superadmin-struttura-main-form" value="{{ old('nome_struttura', $struttura->nome_struttura) }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Città</label>
                                <input type="text" name="citta" class="form-control" form="superadmin-struttura-main-form" value="{{ old('citta', $struttura->citta) }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Provincia</label>
                                <input type="text" name="provincia" class="form-control" form="superadmin-struttura-main-form" value="{{ old('provincia', $struttura->provincia) }}">
                            </div>
                            <div class="col-md-9">
                                <label class="form-label">Proprietario</label>
                                <x-ui.select name="proprietario_id" form="superadmin-struttura-main-form">
                            ...
                            <div class="col-md-3">
                                ...
                                <x-ui.select name="attiva" form="superadmin-struttura-main-form">
                    ...
                    <div class="tab-pane fade {{ $activeTab === 'relazione' ? 'show active' : '' }}" id="struttura-pane-relazione" role="tabpanel">
                        <div class="row g-3">
                            <div class="col-lg-4">
                                <div class="card border shadow-sm mb-0 h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @else
                                            <div class="alert alert-info mb-0">Questa struttura non ha ancora un proprietario assegnato. Puoi salvarla ora e completare la relazione dopo.</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                ...
                                                <x-calendario name="scadenza_servizio" variant="single" form="superadmin-struttura-main-form" :value="old('scadenza_servizio', optional($struttura->scadenza_servizio)->format('Y-m-d'))" />
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label">Piano</label>
                                                <input type="text" name="piano" class="form-control" form="superadmin-struttura-main-form" value="{{ old('piano', $struttura->piano) }}">
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label">Stato pagamento</label>
                                                <input type="text" name="stato_pagamento" class="form-control" form="superadmin-struttura-main-form" value="{{ old('stato_pagamento', $struttura->stato_pagamento) }}">
                                            </div>
                                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="card border shadow-sm mb-0">
                                    ...
                                    <div class="card-body d-flex flex-wrap gap-2">
                                        ...
                                        @endif
                                        <a href="{{ route('superadmin.pagamenti.index', ['tab' => 'conto', 'conto_struttura_id' => $struttura->id]) }}" class="btn btn-soft-secondary">Apri stato conto struttura</a>
                ...
                <div class="tab-pane fade {{ $activeTab === 'licenze' ? 'show active' : '' }}" id="struttura-pane-licenze" role="tabpanel">
                        ...
                        @else
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    <div class="border rounded-3 p-3 h-100">
                                        ...
                                        <div class="fw-bold fs-4">{{ $licenzeAssegnate->where('attiva', true)->count() }}</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="border rounded-3 p-3 h-100">
                                        <div class="text-muted small text-uppercase mb-1">Da pagare</div>
                                        <div class="fw-bold fs-4 text-danger">{{ $licenzeAssegnate->where('stato_pagamento', 'da_pagare')->count() }}</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="border rounded-3 p-3 h-100">
                                        <div class="text-muted small text-uppercase mb-1">Totale licenze</div>
                                        <div class="fw-bold fs-4">{{ number_format((float) $licenzeAssegnate->sum('prezzo'), 2, ',', '.') }}</div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table align-middle mb-0">
                                            ...
                                            <tbody>
                                                @forelse($licenzeAssegnate as $assegnazione)
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="d-inline-flex gap-1">
                                                                <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal" data-bs-target="#modalStrutturaLicenzaEdit{{ $assegnazione->id }}" title="Modifica licenza">
                                                                    <i class="ri-edit-line fs-16 align-middle"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-soft-secondary btn-sm" onclick="window.open('{{ route('superadmin.pagamenti.licenze.print', $assegnazione->id) }}', '_blank')" title="Stampa licenza">
                                                                    <i class="ri-printer-line fs-16 align-middle"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-soft-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalStrutturaLicenzaDelete{{ $assegnazione->id }}" title="Elimina licenza">
                                                    ...
                                                    <div class="modal fade" id="modalStrutturaLicenzaEdit{{ $assegnazione->id }}" tabindex="-1" aria-labelledby="modalStrutturaLicenzaEditLabel{{ $assegnazione->id }}" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <div>
                                                                        <h5 class="modal-title mb-1" id="modalStrutturaLicenzaEditLabel{{ $assegnazione->id }}">Modifica licenza struttura</h5>
                                                                ...
                                                                <form method="POST" action="{{ route('superadmin.pagamenti.licenze.update', $assegnazione->id) }}">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="modal-body">
                                                                        <div class="row g-3">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <input type="text" class="form-control" value="{{ $ownerAdmin?->name ?: 'Nessun admin' }}" readonly>
                                                                                <input type="hidden" name="admin_id" value="{{ $assegnazione->admin_id }}">
                                                                            </div>
                                                                            <div class="col-md-3">
                                                    ...
                                                    <div class="modal fade" id="modalStrutturaLicenzaDelete{{ $assegnazione->id }}" tabindex="-1" aria-labelledby="modalStrutturaLicenzaDeleteLabel{{ $assegnazione->id }}" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="modalStrutturaLicenzaDeleteLabel{{ $assegnazione->id }}">Elimina licenza struttura</h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Chiudi"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form method="POST" action="{{ route('superadmin.pagamenti.licenze.destroy', $assegnazione->id) }}">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <input type="hidden" name="return_to_structure_id" value="{{ $struttura->id }}">
                                                                        <input type="hidden" name="active_tab" value="licenze">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <button
                                                                ...
                                                                onclick="window.location.href='{{ route('superadmin.proprietari.proforme.show', ['proprietario' => $movimento->proprietario_id, 'proforma' => $movimento->id]) }}'"
                            ...
                            <div class="card border shadow-sm mb-0">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('superadmin.pagamenti.licenze.store') }}" class="row g-3">
                                        @csrf
                                        <input type="hidden" name="return_to_structure_id" value="{{ $struttura->id }}">
                                        <input type="hidden" name="active_tab" value="licenze">
                                        <input type="hidden" name="proprietario_id" value="{{ $struttura->proprietario_id }}">
                                        <input type="hidden" name="admin_id" value="{{ $ownerAdmin?->id }}">
                                        <input type="hidden" name="struttura_id" value="{{ $struttura->id }}">

                                        <div class="col-md-6">
                                            <label class="form-label">Articolo / licenza</label>
                                            <select name="articolo_id" class="form-select" id="struttura_licenza_articolo" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="struttura_licenza_accesso" class="form-control" value="Si compila dal catalogo articolo" readonly>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label">Quantita</label>
                                        ...
                                        <div class="col-md-2">
                                            <label class="form-label">Prezzo</label>
                                            <input type="number" name="prezzo" id="struttura_licenza_prezzo" class="form-control" step="0.01" min="0" value="0">
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label">Attiva</label>
                                            <select name="attiva" class="form-select">
                ...
                <div class="d-flex justify-content-end mt-4">
                    <a href="{{ !empty($returnToOwnerId) ? route('superadmin.proprietari.edit', ['id' => $returnToOwnerId, 'tab' => 'strutture']) : route('superadmin.strutture.index') }}" class="btn btn-outline-secondary me-2">Annulla</a>
                    <button type="submit" form="superadmin-struttura-main-form" class="btn btn-success">Salva</button>
                </div>
        </div>
    </div>
@endsection
...
document.addEventListener('DOMContentLoaded', function () {
    var articoloSelect = document.getElementById('struttura_licenza_articolo');
    var prezzoInput = document.getElementById('struttura_licenza_prezzo');
    var accessoInput = document.getElementById('struttura_licenza_accesso');
    ...
    document.querySelectorAll('[data-bs-toggle="tab"]').forEach(function (tabButton) {
        tabButton.addEventListener('shown.bs.tab', function (event) {
            ...
            var tabName = target.replace('#struttura-pane-', '');
