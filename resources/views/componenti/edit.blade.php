                        ...
                        <div class="live-preview">
                            ...
                            <div class="col-xxl-3 col-md-3">
                                ...
                                <div>
                                        ...
                                        <input type="date" class="form-control" name="date_nac" value="{{$componenti->date_nac}}" data-provider="flatpickr" data-date-format="{{ config('app.date.backend_format') }}" data-altFormat="{{ config('app.date.display_format') }}">
                                    </div>
                                </div>
