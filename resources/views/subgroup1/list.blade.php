...
@section('title') @lang('translation.SubGroups1') @endsection
@section('css')
<!--datatable css-->
...
@slot('title')@lang('translation.SubGroup1') @endslot
@endcomponent
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">@lang('translation.new') @lang('translation.SubGroup')</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="@lang('translation.buttons.close')"> </button>
            </div>
            <div class="modal-body">
<form method="POST" action="{{route('subgroup1.store')}}" data-sa-confirm="create">
@csrf 
<div>
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">@lang('translation.SubGroups1')</h5>
            </div>
            <div class="card-body">
                    ...
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a  href="{{ route('subgroup1.destroy',['id' => $group->id] )}}" data-sa-confirm="delete" type="button"  class="btn btn-danger btn-icon waves-effect waves-light" title="@lang('translation.actions.delete')" aria-label="@lang('translation.actions.delete')">
                                ...
                                <div id="ModalEdit{{$group->id}}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    <form method="POST" action="{{route('subgroup1.update', $group->id)}}" data-sa-confirm="update">
                                                    @csrf 
                                                    @method('PUT') 
                                                                <div>
                                                                    <label for="basiInput" class="form-label">@lang('translation.Name')</label>
