                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="expire_reg" value="{{$customer->expire_reg}}" data-provider="flatpickr" data-date-format="{{ config('app.date.backend_format') }}" data-altFormat="{{ config('app.date.display_format') }}">
                                        ...
                                        <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="released_reg" value="{{$customer->released_reg}}" data-provider="flatpickr" data-date-format="{{ config('app.date.backend_format') }}" data-altFormat="{{ config('app.date.display_format') }}">
