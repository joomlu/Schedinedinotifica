...
<div class="row config-page">
    <div class="col-lg-12">
        <x-crud-table
            ...
            searchId="tipoAlloggiatoSearch"
            createText="Nuovo Tipo Alloggiato"
            createTarget="#"
            tableId="tipoAlloggiatoTable"
            :paginator="$tipiAlloggiato"
            :createDisabled="true"
        ...
        >
            ...
            <x-slot name="rows">
                @foreach($tipiAlloggiato as $tipo)
                    <tr class="data-row"
                        data-id="{{ $tipo->id }}"
