                        ...
                        <div class="card-body p-0">
                            <div>
                                <div id="countries_charts"
                                    data-colors='["--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary-rgb, 0.5", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary"]'
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card card-height-100">
                ...
                <div class="card-body p-0">
                    <div>
                        <div id="audiences-sessions-country-charts" data-colors='["--vz-success", "--vz-primary"]'
                            class="apex-charts" dir="ltr"></div>
                    </div>
                </div><!-- end cardbody -->
            </div><!-- end card -->
