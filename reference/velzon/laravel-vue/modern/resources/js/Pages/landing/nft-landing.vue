            ...
            <BContainer>
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        <li class="nav-item">
                            <BLink class="nav-link fs-15" href="#hero" @click.prevent="scrollToSection('hero')">Home</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15" href="#wallet" @click.prevent="scrollToSection('wallet')">Wallet
                            </BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15" href="#marketplace" @click.prevent="scrollToSection('marketplace')">Marketplace</BLink>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <BLink class="nav-link fs-15" href="#creators" @click.prevent="scrollToSection('creators')">
                                Creators</BLink>
                        </li>
                    </ul>
