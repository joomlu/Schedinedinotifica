        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body class="overflow-hidden shadow-none">
                    <BCardBody class="bg-danger-subtle text-danger fw-semibold d-flex">
                        <marquee class="fs-14">
                ...
                <BCard no-body class="explore-box">
                    <BCardBody>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0">
                                <Blink href="/apps/nft-item-detail" class="text-body">Patterns arts & culture</Blink>
                            </h6>
                        </div>
                    </BCardBody>
                </BCard>
                ...
                <BCard no-body>
                    ...
                    <BCardBody class="text-center">
                        <img src="@assets/images/nft/img-04.jpg" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                        <h5 class="mt-3 mb-1">
                            <Link href="/pages/profile" class="text-body">Kevin Dawson</Link>
                        </h5>
                ...
                <BCard no-body>
                    ...
                    <BCardBody class="text-center">
                        <img src="@assets/images/nft/img-06.jpg" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                        <h5 class="mt-3 mb-1">
                            <Link href="/pages/profile" class="text-body">Herbert Stokes</Link>
                        </h5>
                ...
                <BCard no-body>
                    ...
                    <BCardBody class="text-center">
                        <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                        <h5 class="mt-3 mb-1">
                            <Link href="/pages/profile" class="text-body">James Price</Link>
                        </h5>
