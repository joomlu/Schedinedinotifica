          ...
          <BCardHeader>
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <Link href="/invoices/detail" class="btn btn-secondary btn-sm"><i
        ...
        <BCard no-body>
          <BCardHeader>
            <div class="d-flex">
              ...
              <div class="flex-shrink-0">
                <BLink href="javascript:void(0);" class="badge bg-primary-subtle text-primary fs-12">Track Order</BLink>
              </div>
            </div>
          </BCardHeader>
          <BCardBody>
