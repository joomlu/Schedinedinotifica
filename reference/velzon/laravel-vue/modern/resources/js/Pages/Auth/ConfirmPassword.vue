                        ...
                        <BCard no-body class="mt-4">
                            ...
                            <BCardBody class="p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted"> This is a secure area of the application. Please confirm your
                                ...
                                <div class="p-2 mt-4">
                                    <form @submit.prevent="submit">
                                        ...
                                        <TextInput id="username" type="text" class="" style="display: none;"
                                            autocomplete="username" />
                                        <!-- end -->
                                        <div class="mb-3">
                                            <InputLabel  for="password" value="Password" />
                                            <TextInput id="password" ref="passwordInput" v-model="form.password"
                                                type="password" class="" required placeholder="Enter your password"
