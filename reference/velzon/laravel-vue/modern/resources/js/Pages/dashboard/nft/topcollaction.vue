...
<template>
    <BCard no-body>
        <BCardHeader class="d-flex align-items-center">
            ...
            <Link href="/apps/nft-collection" type="button" class="btn btn-soft-primary btn-sm flex-shrink-0">
    ...
    <BCard no-body>
        <BCardHeader class="d-flex align-items-center">
            ...
            <Link href="/apps/nft-creators" type="button" class="btn btn-soft-primary btn-sm flex-shrink-0">
                See All <i class="ri-arrow-right-line align-bottom"></i>
            </Link>
        </BCardHeader>
        <BCardBody>
