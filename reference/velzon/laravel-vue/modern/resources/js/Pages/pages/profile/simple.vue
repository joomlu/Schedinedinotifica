                              ...
                              <BCard no-body class="profile-project-card shadow-none profile-project-success mb-0">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                      <BBadge variant="warning-subtle" class="bg-warning-subtle text-warning fs-11">
                                        Inprogress
                                      </BBadge>
                                    </div>
                                  </div>
                              ...
                              <BCard no-body class="profile-project-card shadow-none profile-project-danger mb-0">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                      <BBadge variant="success-subtle" class="bg-success-subtle text-success fs-11">
                                        Completed
                                      </BBadge>
                                    </div>
                                  </div>
                      ...
                      <BCard no-body class="profile-project-card shadow-none profile-project-success">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 ms-2">
                              <BBadge variant="primary-subtle" class="bg-primary-subtle text-primary fs-11">
                                Progress
                              </BBadge>
                            </div>
                          </div>
                      ...
                      <BCard no-body class="profile-project-card shadow-none profile-project-info">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 ms-2">
                              <BBadge variant="info-subtle" class="bg-info-subtle text-info fs-11">New</BBadge>
                            </div>
                          </div>
