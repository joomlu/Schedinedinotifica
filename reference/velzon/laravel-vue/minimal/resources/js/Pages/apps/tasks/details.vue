                        ...
                        <ul class="list-unstyled vstack gap-3 mb-0">
                            <li>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <h6 class="mb-1">
                                            <Link href="/pages/profile" class="link-secondary">Tonya Noble</Link>
                                        </h6>
                                        <p class="text-muted mb-0">Full Stack Developer</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <BDropdown variant="link" toggle-class="btn btn-icon btn-sm fs-16 text-muted arrow-none" menu-class="dropdown-menu-end">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <h6 class="mb-1">
                                            <Link href="/pages/profile" class="link-secondary">Thomas Taylor</Link>
                                        </h6>
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <h6 class="mb-1">
                                            <Link href="/pages/profile" class="link-secondary">Nancy Martino</Link>
                                        </h6>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                        <div class="d-flex gap-1">
                                            ...
                                            <BDropdown variant="link" toggle-class="btn btn-icon text-muted btn-sm fs-18 arrow-none" menu-class="dropdown-menu-end">
                                                <template #button-content>
                                ...
                                <simplebar data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                    <div class="d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-13">
                                                <Link href="/pages/profile">Joseph Parker</Link> <small class="text-muted">20 Dec 2021 - 05:47AM</small>
                                            </h5>
                                    ...
                                    <div class="d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-13">
                                                <Link href="/pages/profile">Thomas Taylor</Link> <small class="text-muted">24 Dec 2021 - 05:20PM</small>
                                            </h5>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-13">
                                                <Link href="/pages/profile">Tonya Noble</Link> <small class="text-muted">26 min ago</small>
                                            </h5>
                                    ...
                                    <table class="table table-borderless align-middle mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>21 Dec, 2021</td>
                                                <td>
                                                    <BDropdown toggle-class="btn btn-light btn-icon arrow-none p-0" no-caret>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 ms-2">
                                                            <Link href="/pages/profile" class="fw-medium link-secondary">Thomas
                                                                Taylor</Link>
                                                        </div>
                                                    </div>
                                                </th>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 ms-2">
                                                            <Link href="/pages/profile" class="fw-medium link-secondary">Tonya
                                                                Noble</Link>
                                                        </div>
                                                    </div>
                                                </td>
