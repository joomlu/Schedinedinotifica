            ...
            <BContainer>
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#hero" @click.prevent="scrollToSection('hero')">Home</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#wallet" @click.prevent="scrollToSection('wallet')">Wallet
                            </BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#marketplace" @click.prevent="scrollToSection('marketplace')">Marketplace</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#categories" @click.prevent="scrollToSection('categories')">
                                Categories</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#creators" @click.prevent="scrollToSection('creators')">
                                Creators</BLink>
                        </li>
                    </ul>

                    <div class="">
                        <Link href="/apps/nft-wallet" class="btn btn-primary btn-sm">Wallet Connect</Link>
                    </div>
                </BCollapse>
                    ...
                    <BCol lg="8" sm="10">
                        <div class="text-center">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                <Link href="/apps/nft-create" class="btn btn-primary">Create Own <i class="ri-arrow-right-line align-middle ms-1"></i></Link>
                                <Link href="/apps/nft-explore" class="btn btn-secondary">Explore Now <i class="ri-arrow-right-line align-middle ms-1"></i></Link>
                            </div>
                        </div>
                    </BCol>
                </BRow>
                    ...
                    <BCol lg="4">
                        <BCard no-body class="text-center border shadow-none">
                            <BCardBody class="py-5 px-4">
                                ...
                                <h5>Metamask</h5>
                                <p class="text-muted fs-14 pb-1">MetaMask is a software cryptocurrency wallet used to
                    ...
                    <BCol lg="4">
                        <BCard no-body class="text-center border shadow-none">
                            <BCardBody class="py-5 px-4">
                                ...
                                <p class="text-muted fs-14 pb-1">Coinbase Wallet is a software product that gives you
                    ...
                    <BCol lg="4">
                        <BCard no-body class="text-center border shadow-none">
                            <BCardBody class="py-5 px-4">
                                ...
                                <h5>Binance</h5>
                                <p class="text-muted fs-14 pb-1">Binance offers a relatively secure, versatile way to
                    ...
                    <BCol lg="4" class="product-item artwork crypto-card 3d-style">
                        <BCard no-body class="explore-box card-animate">
                            ...
                            <BCardBody>
                                ...
                                <h5 class="mb-1 fs-16">
                                    <Link href="/apps/nft-item-detail" class="text-body">Creative Filtered
                                        Portrait</Link>
                                </h5>
                        ...
                        <BCard no-body class="explore-box card-animate">
                            ...
                            <BCardBody>
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    23.63k </p>
                                <h5 class="mb-1 fs-16">
                                    <Link href="/apps/nft-item-detail" class="text-body">The Chirstoper</Link>
                                </h5>
                        ...
                        <BCard no-body class="explore-box card-animate">
                            ...
                            <BCardBody>
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    15.93k </p>
                                <h5 class="mb-1 fs-16">
                                    <Link href="/apps/nft-item-detail" class="text-body">Evolved Reality</Link>
                                </h5>
                    ...
                    <BCol lg="4" class="product-item crypto-card 3d-style">
                        <BCard no-body class="explore-box card-animate">
                            ...
                            <BCardBody>
                                ...
                                <h5 class="mb-1 fs-16">
                                    <Link href="/apps/nft-item-detail" class="text-body">Abstract Face Painting</Link>
                                </h5>
                    ...
                    <BCol lg="4" class="product-item games music 3d-style">
                        <BCard no-body class="explore-box card-animate">
                            ...
                            <BCardBody>
                                ...
                                <h5 class="mb-1 fs-16">
                                    <Link href="/apps/nft-item-detail" class="text-body">Long-tailed Macaque</Link>
                                </h5>
                    ...
                    <BCol lg="4" class="product-item artwork music crypto-card">
                        <BCard no-body class="explore-box card-animate">
                            ...
                            <BCardBody>
                                ...
                                <h5 class="mb-1 fs-16">
                                    <Link href="/apps/nft-item-detail" class="text-body">Robotic Body Art</Link>
                                </h5>
                                <p class="text-muted fs-14 mb-0">Artwork</p>
                            </BCardBody>
                            <BCardFooter class="border-top border-top-dashed">
                        ...
                        <div class="b-card no-body shadow-none">
                            <BCardBody>
                                ...
                                <p class="text-muted fs-14">You have to choose whether to use a hot wallet a cold
                                    wallet.</p>
                                <BLink href="#!" class="link-primary fs-14">Read More <i class="ri-arrow-right-line align-bottom"></i></BLink>
                            </BCardBody>
                        </div>
                    </BCol>
                    <BCol lg="3">
                ...
                <BRow>
                    <BCol lg="12">
                        <div class="swiper mySwiper pb-4">
                            <swiper class="swiper responsive-swiper rounded gallery-light pb-4" :loop="true" :autoplay="true" :modules="[Autoplay, Pagination]" :slidesPerView="1" :spaceBetween="10" :pagination="{ el: '.swiper-pagination', clickable: true, }" :breakpoints="{ 640: { slidesPerView: 2, spaceBetween: 20 }, 768: { slidesPerView: 3, spaceBetween: 40 }, 1200: { slidesPerView: 4, spaceBetween: 50 }, }">
                                <swiper-slide>
                                    <BCard no-body>
                                        <BCardBody>
                                            <BRow class="g-1 mb-3">
                                            ...
                                            <BLink href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></BLink>
                                            <h5 class="mb-0 fs-15">
                                                <BLink href="#!" class="text-body">Artwork <BBadge variant="secondary-subtle" class="bg-secondary-subtle text-secondary">206</BBadge>
                                                </BLink>
                                            </h5>
                                        </BCardBody>
                                    </BCard>
                                ...
                                <swiper-slide>
                                    <BCard no-body>
                                        <BCardBody>
                                            ...
                                            <BLink href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></BLink>
                                            <h5 class="mb-0 fs-15">
                                                <BLink href="#!" class="text-body">Crypto Card <BBadge variant="secondary-subtle" class="bg-secondary-subtle text-secondary">743</BBadge>
                                                </BLink>
                                            </h5>
                                        </BCardBody>
                                    </BCard>
                                    ...
                                    <div class="swiper-slide">
                                        <BCard no-body>
                                            <BCardBody>
                                                ...
                                                <BLink href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></BLink>
                                                <h5 class="mb-0 fs-15">
                                                    <BLink href="#!" class="text-body">Music <BBadge variant="secondary-subtle" class="bg-secondary-subtle text-secondary">679</BBadge>
                                                    </BLink>
                                                </h5>
                                            </BCardBody>
                                        </BCard>
                                ...
                                <swiper-slide>
                                    <BCard no-body>
                                        <BCardBody>
                                            ...
                                            <BLink href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></BLink>
                                            <h5 class="mb-0 fs-15">
                                                <BLink href="#!" class="text-body">Games <BBadge variant="secondary-subtle" class="bg-secondary-subtle text-secondary">341</BBadge>
                                                </BLink>
                                            </h5>
                                        </BCardBody>
                                    </BCard>
                                ...
                                <swiper-slide>
                                    <BCard no-body>
                                        <BCardBody>
                                            ...
                                            <BLink href="#!" class="float-end fs-14"> View All <i class="ri-arrow-right-line align-bottom"></i></BLink>
                                            <h5 class="mb-0 fs-15">
                                                <BLink href="#!" class="text-body">Photography <BBadge variant="secondary-subtle" class="bg-secondary-subtle text-secondary">1452</BBadge>
                                                </BLink>
                                            </h5>
                                        </BCardBody>
                                    </BCard>
                ...
                <BRow class="justify-content-center">
                    <BCol lg="12">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <Link href="/apps/nft-explore" class="btn btn-secondary">View All <i class="ri-arrow-right-line align-bottom"></i></Link>
                        </div>
                    </BCol>
                </BRow>
                <BRow>
                        ...
                        <BCard no-body class="explore-box card-animate border">
                            <BCardBody>
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0">
                                        <Link href="/apps/nft-item-detail" class="text-body">Patterns arts &amp;
                                            culture</Link>
                                    </h6>
                                </div>
                            </BCardBody>
                        ...
                        <BCard no-body class="explore-box card-animate border">
                            <BCardBody>
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="bookmark-icon">
                                        <BButton type="button" class="btn btn-icon" data-bs-toggle="button" aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i></BButton>
                                    </div>
                                </div>
                                <div class="explore-place-bid-img overflow-hidden rounded">
                        ...
                        <BCard no-body class="explore-box card-animate border">
                            <BCardBody>
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0">
                                        <Link href="/apps/nft-item-detail" class="text-body">Long-tailed
                                            macaque</Link>
                                    </h6>
                                </div>
                            </BCardBody>
                            ...
                            <BCardBody>
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <p class="text-muted fs-14 mb-0"><i class="mdi mdi-ethereum text-primary fs-14"></i>
                                            4,754 ETH</p>
                                    </div>
                                    <div>
                                        <BDropdown variant="ghost-primary" right toggle-class="arrow-none btn-icon" class="float-end" no-caret>
                            ...
                            <BCardBody>
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <p class="text-muted mb-0 fs-14"><i class="mdi mdi-ethereum text-primary fs-14"></i>
                                            81,369 ETH</p>
                                    </div>
                                    <div>
                                        <BDropdown variant="ghost-primary" right toggle-class="arrow-none btn-icon" class="float-end" no-caret>
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <BContainer>
                <BRow class="align-items-center gy-4">
                    ...
                    <BCol sm="auto">
                        <div>
                            <Link href="/apps/nft-create" class="btn bg-gradient btn-danger mx-1">Create NFT
                            </Link>
                            <Link href="/apps/nft-explore" class="btn btn-secondary">Discover More
                            </Link>
                        </div>
                    </BCol>
