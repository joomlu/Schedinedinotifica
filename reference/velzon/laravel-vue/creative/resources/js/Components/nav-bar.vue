      ...
      <div class="navbar-header">
        ...
        <div class="d-flex align-items-center">
          ...
          <BDropdown variant="ghost-secondary" dropstart :offset="{ alignmentAxis: 57, crossAxis: 0, mainAxis: -42 }"
            ...
            <div class="p-3 border-top-0 border-start-0 dropdown-head border-end-0 border-dashed border dropdown-menu-xl">
              <BRow class="align-items-center">
                ...
                <BCol cols="auto">
                  <BBadge variant="info-subtle" class="bg-info-subtle text-info fs-13"><span
          ...
          <BDropdown variant="ghost-dark" dropstart class="ms-1 dropdown"
            ...
            <div class="dropdown-head bg-secondary bg-pattern rounded-top dropdown-menu-lg">
              <div class="p-3">
                <BRow class="align-items-center">
                  <BCol>
            ...
            <BTabs nav-class="dropdown-tabs nav-tab-custom bg-secondary px-2 pt-2">
            ...
            <template #button-content>
              <span class="d-flex align-items-center">
                ...
                <span class="text-start ms-xl-2">
                  <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text">{{ $page.props.auth.user.name }}</span>
