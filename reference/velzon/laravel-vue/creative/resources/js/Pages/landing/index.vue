            ...
            <BContainer>
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        <li class="nav-item">
                            <BLink class="nav-link fs-15 fw-semibold" href="#hero" @click.prevent="scrollToSection('hero')">Home</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15 fw-semibold" href="#services" @click.prevent="scrollToSection('services')">Services</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15 fw-semibold" href="#features" @click.prevent="scrollToSection('features')">Features</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15 fw-semibold" href="#plans" @click.prevent="scrollToSection('plans')">Plans</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15 fw-semibold" href="#reviews" @click.prevent="scrollToSection('reviews')">Reviews</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15 fw-semibold" href="#team" @click.prevent="scrollToSection('team')">Team</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15 fw-semibold" href="#contact" @click.prevent="scrollToSection('contact')">Contact</BLink>
                        </li>
                    </ul>
                    ...
                    <BCol lg="4">
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div>
                                    <router-link to="#" class="fs-13 fw-semibold">Learn More <i
                    ...
                    <BCol lg="8">
                        <div class="text-center mb-5">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <div>
                                    <h5 class="fs-15 mb-0">Annual <BBadge variant="success-subtle"
                ...
                <BRow class="g-lg-5 g-4">
                    <BCol lg="6">
                        ...
                        <BAccordion class="custom-accordionwithicon custom-accordion-border accordion-border-box"
                            ...
                            <BAccordionItem title="What is the purpose of using themes ?" class="fs-15 fw-semibold" visible>
                            ...
                            <BAccordionItem title="Can a theme have more than one theme?" class="fs-15 fw-semibold">
                                <div class="ff-secondary">
                            ...
                            <BAccordionItem title="What are theme features?" class="fs-15 fw-semibold">
                                <div class="ff-secondary">
                            ...
                            <BAccordionItem title="What is simple theme?" class="fs-15 fw-semibold">
                                <div class="ff-secondary">
                    ...
                    <BCol lg="6">
                        ...
                        <BAccordion class="custom-accordionwithicon custom-accordion-border accordion-border-box"
                            ...
                            <BAccordionItem title="Does Word have night mode?" class="fs-15 fw-semibold">
                                <div class="ff-secondary">
                            ...
                            <BAccordionItem title="Is theme an opinion?" visible class="fs-15 fw-semibold">
                                <div class="ff-secondary">
                            ...
                            <BAccordionItem title="How do you develop a theme?" class="fs-15 fw-semibold">
                                <div class="ff-secondary">
                            ...
                            <BAccordionItem title="Do stories need themes?" class="fs-15 fw-semibold">
                                <div class="ff-secondary">
                                    A story can have as many themes as the reader can identify based on recurring
                                    patterns and parallels within the story
                                    itself. In looking at ways to separate themes into a hierarchy, we might find it
