            ...
            <BContainer fluid class="custom-container">
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        <li class="nav-item">
                            <BLink class="nav-link fs-16" href="#hero" @click.prevent="scrollToSection('hero')">Home
                            </BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-16" href="#process" @click.prevent="scrollToSection('process')">
                                Process
                            </BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-16" href="#categories" @click.prevent="scrollToSection('categories')">
                                Categories</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-16" href="#findJob" @click.prevent="scrollToSection('findJob')">Find
                                Jobs</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-16" href="#candidates" @click.prevent="scrollToSection('candidates')">
                                Candidates</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-16" href="#blog" @click.prevent="scrollToSection('blog')">Blog</BLink>
                        </li>
                    </ul>

                    <div class="">
                        <router-link to="/auth/signin-basic" class="btn btn-soft-danger"><i
                        ...
                        <div>
                            ...
                            <ul class="treding-keywords list-inline mb-0 mt-3 fs-13">
                                ...
                                <li class="list-inline-item">
                                    <BLink href="#" class="link-secondary">Design,</BLink>
                                </li>
                                <li class="list-inline-item">
                                    <BLink href="#" class="link-secondary">Development,</BLink>
                                </li>
                                <li class="list-inline-item">
                                    <BLink href="#" class="link-secondary">Manager,</BLink>
                                </li>
                                <li class="list-inline-item">
                                    <BLink href="#" class="link-secondary">Senior</BLink>
                                </li>
                            </ul>
                        </div>
                    </BCol>
                ...
                <BRow class="justify-content-center">
                    <BCol lg="8">
                        <div class="text-center mb-5">
                            <h1 class="mb-3 ff-secondary fw-bold lh-base">How <span class="text-primary">it's
                ...
                <BRow class="align-items-center justify-content-lg-between justify-content-center gy-4">
                            ...
                            <BCard no-body class="rounded shadow-lg inquiry-box d-none d-lg-block">
                                <BCardBody class="d-flex align-items-center">
                                    ...
                                    <h5 class="fs-15 lh-base mb-0">Search Over <span
                                            class="text-secondary fw-bold">1,00,000+</span> Jobs</h5>
                                </BCardBody>
                            </BCard>
                    ...
                    <BCol lg="6">
                        <div class="text-muted">
                            <h1 class="mb-3 fw-bold lh-base">Find Your <span class="text-primary">Dream Job</span> in One Place
                            </h1>
                            ...
                            <div>
                                <BLink href="#!" class="btn btn-secondary">Find Your Jobs <i
        ...
        <section class="section bg-light" id="categories">
            <BContainer>
                <BRow class="justify-content-center">
                    <BCol lg="7">
                        <div class="text-center mb-5">
                            <h1 class="mb-3 ff-secondary fw-bold text-capitalize lh-base">High demand jobs <span
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <BContainer>
                <BRow class="align-items-center gy-4">
                    <BCol sm>
                        <div>
                            <h4 class="text-white fw-bold mb-2">Ready to Started?</h4>
        ...
        <section class="section" id="findJob">
            <BContainer>
                <BRow class="justify-content-center">
                    <BCol lg="7">
                        <div class="text-center mb-5">
                            <h1 class="mb-3 ff-secondary fw-bold text-capitalize lh-base">Find Your <span
                ...
                <BRow>
                    ...
                    <BCol lg="12">
                        <div class="text-center mt-4">
                            <BLink href="#!" class="btn btn-ghost-info">View More Jobs <i
                ...
                <BRow class="align-items-center gy-4">
                    <BCol lg="6" order="2" order-lg="1">
                        <div class="text-muted mt-5 mt-lg-0">
                            <h5 class="fs-12 text-uppercase text-danger fw-semibold">Hot Featured Company</h5>
                            <h1 class="mb-3 ff-secondary fw-bold text-capitalize lh-base">Get <span
                            ...
                            <div class="mt-4">
                                <router-link to="/" class="btn btn-primary">View More Companies <i
                    ...
                    <BCol lg="4" sm="7" cols="10" order="1" order-lg="2" class="ms-lg-auto mx-auto">
                        <div>
                            ...
                            <BCard no-body class="shadow-lg bg-secondary mb-0 features-company-widgets rounded-3">
                                <BCardBody>
        ...
        <section class="section bg-light" id="candidates">
            ...
            <BContainer>
                <BRow class="justify-content-center">
                    <BCol lg="8">
                        <div class="text-center mb-5">
                            <h1 class="mb-3 ff-secondary fw-bold text-capitalize lh-base">Hire Experts <span
                            ...
                            <swiper-slide>
                                <BCard no-body class="text-center">
                                    <BCardBody class="p-4">
                                        ...
                                        <BLink href="#!" class="btn btn-secondary w-100">View Profile</BLink>
                                    </BCardBody>
                                </BCard>
                            </swiper-slide>
                            <swiper-slide>
        ...
        <section class="section" id="blog">
            <BContainer>
                <BRow class="justify-content-center">
                    <BCol lg="8">
                        <div class="text-center mb-5">
                            <h1 class="mb-3 ff-secondary fw-bold text-capitalize lh-base">Our Latest <span
                        ...
                        <BRow>
                            <BCol sm="4" class="mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list fs-15">
                                        ...
                                        <li>
                                            <router-link to="/pages/team">Team</router-link>
                                        </li>
                                        <li>
                            ...
                            <BCol sm="4" class="mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list fs-15">
                                        <li>
                                            <router-link to="/jobs/lists">Job List</router-link>
                                        </li>
                                        <li>
                                            <router-link to="/jobs/application">application</router-link>
                                        </li>
                                        <li>
                                            <router-link to="/jobs/new">New Job</router-link>
                                        </li>
                                        <li>
                                            <router-link to="/jobs/companies-list">Company List</router-link>
                                        </li>
                                    </ul>
                                </div>
                            </BCol>
                            <BCol sm="4" class="mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list fs-15">
                                        <li>
                                            <router-link to="/pages/faqs">FAQ</router-link>
                                        </li>
                                        <li>
                                            <router-link to="/pages/faqs">Contact</router-link>
                                        </li>
                                    </ul>
                                </div>
                            </BCol>
                    ...
                    <BCol sm="6">
                        <div class="text-sm-end mt-3 mt-sm-0">
                            <ul class="list-inline mb-0 footer-list gap-4 fs-15">
                                ...
                                <li class="list-inline-item">
                                    <router-link to="/pages/term-conditions">Terms & Conditions</router-link>
                                </li>
                                <li class="list-inline-item">
                                    <router-link to="/pages/privacy-policy">Security</router-link>
                                </li>
                            </ul>
                        </div>
                    </BCol>
