...
<template>
    <Layout>
        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    <CardHeader title="Default Table" />
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">
                                                <BLink  href="#" class="fw-semibold">#VZ2110</BLink >
                                            </th>
                                            <td>Bobby Davis</td>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <BLink  href="#" class="fw-semibold">#VZ2109</BLink >
                                            </th>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <BLink  href="#" class="fw-semibold">#VZ2108</BLink >
                                            </th>
                                            <td>Monkey Karry</td>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <BLink  href="#" class="fw-semibold">#VZ2107</BLink >
                                            </th>
                                            <td>James White</td>
        ...
        &lt;/table&gt;</code></pre>
            ...
            <BCol xl="6">
                <BCard no-body>
                    <CardHeader title="Striped Rows" />

                    <BCardBody>
                        <p class="text-muted">Use <code>table-striped</code> class to add zebra-striping to any table
                            row within the &lt;tbody&gt;.</p>
                        <div class="live-preview">
                            <div class="table-responsive">
        ...
        <BRow>
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Striped columns" />

                    <BCardBody>
                        <p class="text-muted mb-4">Use .<code>table-striped-columns</code> to add zebra-striping to any
                            table column.</p>
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <CardHeader title="Tables Colors" />
                    ...
                    <BCardBody>
                        <p class="text-muted">Use <code>table-dark</code> class to set dark color table body and
                            ...
                            use <code>table-</code> class with different color variation to set required table body
                            color.
                        </p>
                        <div class="live-preview">
                            <BRow>
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <CardHeader title="Hoverable Rows" />
                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <BLink  href="#" class="fw-semibold">#VL2110</BLink >
                                            </td>
                                            <td>William Elmore</td>
                                            <td>07 Oct, 2021</td>
                                            <td>$24.05</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <BLink  href="#" class="fw-semibold">#VL2109</BLink >
                                            </td>
                                            <td>Georgie Winters</td>
                                            <td>07 Oct, 2021</td>
                                            <td>$26.15</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <BLink  href="#" class="fw-semibold">#VL2108</BLink >
                                            </td>
                                            <td>Whitney Meier</td>
                                            <td>06 Oct, 2021</td>
                                            <td>$21.25</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <BLink  href="#" class="fw-semibold">#VL2107</BLink >
                                            </td>
                                            <td>Justin Maier</td>
                                            <td>05 Oct, 2021</td>
                                            <td>$25.03</td>
        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    <CardHeader title="Active Tables" />
        ...
        &lt;/table&gt;</code></pre>
            ...
            <BCol xl="6">
                <BCard no-body>
                    <CardHeader title="Bordered Tables" />
                                ...
                                <table class="table table-bordered align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$4,521</td>
                                            <td>
                                                <BDropdown variant="link" toggle-class="arrow-none p-0" no-caret>
        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    <CardHeader title="Tables Border Colors" />

                    <BCardBody>
                        <p class="text-muted">Use <code>border-</code> class with color variation class to set table
                            border color.</p>
        ...
        &lt;/table&gt;</code></pre>
            ...
            <BCol xl="6">
                <BCard no-body>
                    <CardHeader title="Tables Without Borders" />
        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    <CardHeader title="Small Tables" />

                    <BCardBody>
                        <p class="text-muted">Use <code>table-sm</code> class to create any table more compact by
                            cutting all cell padding in half.</p>
        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    <CardHeader title="Table Foot" />

                    <BCardBody>
                        <p class="text-muted">Add <code>&lt;tbody&gt;</code> attribute to group footer content in an
                            HTML table.</p>
        ...
        &lt;/table&gt;</code></pre>
            ...
            <BCol xl="6">
                <BCard no-body>
                    ...
                    <BCardBody>
                        <p class="text-muted">You can also put the <code>&lt;caption&gt;</code> attribute on the top of
                            the table with <code>caption-top</code> class.</p>
        ...
        <BRow>
            <BCol xl="6">
                <BCard no-body>
                    <CardHeader title="Table Nesting" />
        ...
        <BRow>
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Vertical alignment" />

                    <BCardBody>

                        <p class="text-muted">Table cells of <code>&lt;thead&gt;</code> are always vertical aligned to
                            the bottom. Table cells in <code>&lt;tbody&gt;</code> inherit their alignment from
        ...
        <BRow>
            <BCol xl="12">
                <BCard no-body>
                    ...
                    <BCardBody>
                        <p class="text-muted">Use <code>table-responsive</code> class to make any table responsive
                            across all viewports. Responsive tables allow tables to be scrolled horizontally with ease.
                        </p>
                        <div class="live-preview">
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <BLink  href="#" class="fw-semibold">#VZ2106</BLink >
                                            </td>
                                            <td>10 Nov, 07:20</td>
                                            <td class="text-success"><i
                                                    class="ri-checkbox-circle-line fs-17 align-middle"></i> Paid</td>
