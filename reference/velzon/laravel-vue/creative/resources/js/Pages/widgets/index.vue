      ...
      <BCol xl="3" md="6">
        <BCard no-body class="card-animate bg-info">
          <BCardBody>
            <div class="d-flex align-items-center">
              <div class="flex-grow-1">
                <p class="text-uppercase fw-semibold text-white-50 mb-0">
                  Orders
                </p>
              </div>
              <div class="flex-shrink-0">
            ...
            <div class="d-flex align-items-end justify-content-between mt-4">
              <div>
                <h4 class="fs-22 fw-bold ff-secondary mb-4 text-white">
          ...
          <BCardBody>
            <div class="d-flex justify-content-between">
              <div>
                ...
                <h2 class="mt-4 ff-secondary fw-bold text-white">
        ...
        <BCard no-body class="bg-success card-height-100">
          <BCardBody>
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 ms-3">
                <p class="text-uppercase fw-semibold text-white-50 mb-3">
                  Total Sales
                </p>
      ...
      <BCol xl="3" md="6">
        <BCard no-body class="card-height-100">
          <BCardBody>
            ...
            <BLink href="#!">
              <h6 class="fs-15 fw-bold">Marketing Director <span class="text-muted fs-13">(2-4 Yrs Exp.)</span></h6>
            </BLink>
      ...
      <BCol xl="3" md="6">
        <BCard no-body class="card-height-100">
          <BCardBody>
            ...
            <BLink href="#!">
              <h6 class="fs-15 fw-bold">Sr. Web Designer <span class="text-muted fs-13">(2+ Yrs Exp.)</span></h6>
            </BLink>
            <p class="text-muted mb-0"><i class="ri-building-line align-bottom"></i> Themesbrand <span class="ms-2"><i
                  class="ri-map-pin-2-line align-bottom"></i> California</span></p>
          </BCardBody>
              ...
              <BCol sm="8">
                <div class="p-3">
                  <p class="fs-16 lh-base text-white">
                    Upgrade your plan from a
                    <span class="fw-bold">Free trial</span>, to ‘Premium
                    Plan’ <i class="mdi mdi-arrow-right"></i>
                  </p>
                  <div class="mt-3">
        ...
        <BCard no-body>
          <BCardBody class="p-0">
            ...
            <div class="d-flex p-3">
              ...
              <div>
                <p class="fs-16 lh-base">
                  Personalized <span class="fw-bold">Gift Boxes</span>, with
              ...
              <li class="list-group-item ps-0">
                <BRow class="align-items-center g-3">
                  ...
                  <BCol>
                    ...
                    <BLink href="#" class="text-reset fs-15 mb-0">Meeting for campaign with sales team</BLink>
                  </BCol>
                  <BCol sm="auto">
              ...
              <li class="list-group-item ps-0">
                <BRow class="align-items-center g-3">
                  ...
                  <BCol>
                    ...
                    <BLink href="#" class="text-reset fs-15 mb-0">Weekly closed sales won checking with sales team
                    </BLink>
                  </BCol>
                  <BCol sm="auto">
                    <div class="avatar-group">
            ...
            <BRow class="align-items-center mt-2 text-center text-sm-start">
              <BCol sm>
                <div class="text-muted">
                  Showing<span class="fw-bold">4</span> of
                  <span class="fw-bold">125</span> Results
                </div>
              </BCol>
              <BCol sm="auto">
                <ul class="
            ...
            <BCard no-body class="card-height-100">
              ...
              <BCardBody class="p-0">
                <div class="align-items-center p-3 justify-content-between d-flex">
                  <div class="flex-shrink-0">
                    <div class="text-muted">
                      <span class="fw-bold">4</span> of
                      <span class="fw-bold">10</span> remaining
                    </div>
                  </div>
          ...
          <BCardBody>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="flex-grow-1">
                ...
                <h5 class="fs-15 fw-bold mb-0">Half Sleeve T-Shirts (Blue)</h5>
              </div>
            </div>
            ...
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-grow-1">
                <h5 class="text-primary fs-18 mb-0 product-price"><span>$22.45</span> <small
                    class="text-decoration-line-through text-muted fs-13 product-price-line">$37.45</small></h5>
              </div>
            ...
            <BLink href="#!" class="btn btn-soft-secondary d-block">Add to Cart</BLink>
      ...
      <BCol xl="3" md="6">
        <BCard no-body class="card-height-100">
          <BCardBody class="position-relative">
            <h5 class="mb-3 fw-semibold">Select Bank</h5>
            ...
            <div class="notification-elem" id="notification-overlay">
              <div class="text-center">
                ...
                <div class="mt-4 pt-2">
                  ...
                  <div>
                    <BButton variant="danger" type="button" size="sm" class="w-sm" id="back-btn" @click="selectBankback">
        ...
        <BCard no-body class="card-height-100">
          <BCardBody>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="flex-grow-1">
                <p class="text-muted mb-2">Adidas</p>
                <h5 class="fs-15 fw-bold mb-0">Half Sleeve T-Shirts (Pink)</h5>
              </div>
            </div>
            <p class="text-muted pb-1">If you couldn't relate to the information in the previous point, you might be
              looking for the singlet T-shirt, which is also known as the half T-shirt.</p>
            ...
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-grow-1">
                <h5 class="text-primary fs-18 mb-0 product-price"><span>$48.20</span> <small
                    class="text-decoration-line-through text-muted fs-13 product-price-line">$124.10</small></h5>
              </div>
          ...
          <BRow class="g-0">
            ...
            <BCol lg="6">
              <BCardBody class="text-center">
                ...
                <div>
                  <BButton type="button" variant="danger" class="rounded-pill w-sm"><i
