...
<template>
  <Layout>
    ...
    <BModal v-model="eventModal" :title="this.editevent.editTitle" hide-footer
      ...
      <div class="event-details">
        ...
        <div class="d-flex align-items-center mb-2">
          ...
          <div class="flex-grow-1">
            <h6 class="d-block fw-bold mb-0"><span id="event-timepicker1-tag"></span> - <span
        ...
        <div class="d-flex align-items-center mb-2">
          ...
          <div class="flex-grow-1">
            <h6 class="d-block fw-bold mb-0"> <span id="event-location-tag">
