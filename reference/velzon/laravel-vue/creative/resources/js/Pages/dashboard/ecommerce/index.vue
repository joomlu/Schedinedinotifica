      ...
      <BCol>
        <div class="h-100">
          ...
          <BRow>
                ...
                <BCardBody>
                  ...
                  <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      ...
                      <BLink href="" class="text-decoration-underline text-white-50">View net earnings</BLink>
                    </div>
            ...
            <BCol xl="3" md="6">
              <BCard no-body class="card-animate bg-secondary">
                <BCardBody>
                  <div class="d-flex align-items-center">
                    <div class="flex-grow-1 overflow-hidden">
                      <p class="text-uppercase fw-bold text-white-50 text-truncate mb-0">
            ...
            <BCol xl="3" md="6">
              <BCard no-body class="card-animate bg-success">
                <BCardBody>
                  <div class="d-flex align-items-center">
                    <div class="flex-grow-1 overflow-hidden">
                      <p class="text-uppercase fw-bold text-white-50 text-truncate mb-0">
                  ...
                  <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      ...
                      <BLink href="" class="text-decoration-underline text-white-50">See details</BLink>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
                      <span class="avatar-title bg-white bg-opacity-10 rounded fs-3">
              ...
              <BCard no-body class="card-animate bg-info">
                <BCardBody>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                      <h5 class="text-white fs-14 mb-0">+0.00 %</h5>
                    </div>
                  </div>
                  <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      ...
                      <BLink href="" class="text-decoration-underline text-white-50">Withdraw money</BLink>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
                      <span class="avatar-title bg-white bg-opacity-10 rounded fs-3">
                ...
                <BCardHeader class="align-items-center d-flex py-0">
                  ...
                  <div class="flex-shrink-0">
                    <BDropdown variant="link" class="card-header-dropdown"
                      ...
                      <template #button-content><span class="fw-bold text-uppercase fs-12">Sort by: </span><span
                  ...
                  <div class="table-responsive table-card">
                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <Link href="/ecommerce/order-details" class="fw-medium link-primary">#VZ2112
                            </Link>
                          </td>
                          <td>
                            <div class="d-flex align-items-center">
                          ...
                          <td>
                            <h5 class="fs-14 fw-medium mb-0">
                              5.0<span class="text-muted fs-13 ms-1">(61 votes)</span>
                            </h5>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <Link href="/ecommerce/order-details" class="fw-medium link-primary">#VZ2111
                            </Link>
                          </td>
                          <td>
                            <div class="d-flex align-items-center">
                          ...
                          <td>
                            <h5 class="fs-14 fw-medium mb-0">
                              4.5<span class="text-muted fs-13 ms-1">(61 votes)</span>
                            </h5>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <Link href="/ecommerce/order-details" class="fw-medium link-primary">#VZ2109
                            </Link>
                          </td>
                          <td>
                            <div class="d-flex align-items-center">
                          ...
                          <td>
                            <h5 class="fs-14 fw-medium mb-0">
                              4.9<span class="text-muted fs-13 ms-1">(89 votes)</span>
                            </h5>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <Link href="/ecommerce/order-details" class="fw-medium link-primary">#VZ2108
                            </Link>
                          </td>
                          <td>
                            <div class="d-flex align-items-center">
                          ...
                          <td>
                            <h5 class="fs-14 fw-medium mb-0">
                              4.3<span class="text-muted fs-13 ms-1">(47 votes)</span>
                            </h5>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <Link href="/ecommerce/order-details" class="fw-medium link-primary">#VZ2107
                            </Link>
                          </td>
                          <td>
                            <div class="d-flex align-items-center">
                          ...
                          <td>
                            <h5 class="fs-14 fw-medium mb-0">
                              4.7<span class="text-muted fs-13 ms-1">(161 votes)</span>
                            </h5>
                          </td>
                        </tr>
                      </tbody>
        ...
        <div class="layout-rightside">
          <BCard no-body class="h-100 rounded-0">
            <BCardBody class="p-0">
              ...
              <div class="p-3 mt-2">
                <h6 class="text-muted mb-3 text-uppercase fw-bold fs-13">
                  Top 10 Categories
                </h6>
              ...
              <div class="p-3">
                ...
                <div class="text-center">
                  <div class="text-muted">
                    Total <span class="fw-semibold">5.50k</span> reviews
                  </div>
                </div>
