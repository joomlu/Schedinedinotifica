        ...
        <BRow class="g-2">
          ...
          <BCol lg="auto">
            <div class="hstack gap-2">
              ...
              <BButton variant="danger" @click="modalShow = !modalShow">
      ...
      <BCol xl="3" lg="6" v-for="(item, index) of resultQuery" :key="index">
        <BCard no-body class="ribbon-box right overflow-hidden">
          <BCardBody class="text-center p-4">
            ...
            <h5 class="mb-1 mt-4">
              <Link href="/ecommerce/seller-details" class="link-primary">{{ item.label }}</Link>
            </h5>
            ...
            <div class="mt-4">
              <Link href="/ecommerce/seller-details" class="btn btn-light w-100">View Details</Link>
            </div>
          </BCardBody>
        </BCard>
      </BCol>
