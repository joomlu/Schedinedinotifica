    ...
    <Layout>
                            ...
                            <BRow>
                                <BCol md>
                                    <BRow class="align-items-center">
                                        ...
                                        <BCol md>
                                            <h4>#VLZ135 - Create an Excellent UI for a Dashboard
                                            </h4>
        ...
        <BRow>
            <BCol xxl="9">
                <BCard no-body>
                    <BCardBody class="p-4">
                        <h6 class="fw-bold text-uppercase mb-3">Ticket Description</h6>
                        ...
                        <div class="mt-4">
                            <h6 class="fw-bold text-uppercase mb-3">Here is the code you've requested</h6>
                            <div>
