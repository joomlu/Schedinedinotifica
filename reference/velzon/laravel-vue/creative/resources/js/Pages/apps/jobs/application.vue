          ...
          <BCardBody class="border border-dashed border-end-0 border-start-0">
            <BForm>
              <BRow class="g-3">
                ...
                <BCol xxl="1" sm="4">
                  <div>
                    <BButton type="button" variant="danger" @click="SearchData" class="w-100"> <i
                ...
                <table class="table table-nowrap align-middle" id="jobListTable">
                  ...
                  <tbody class="list form-check-all" v-for="(data, index) of resultQuery" :key="index">
                    <tr v-if="statuscategory == 'All' || statuscategory == data.status">
                      ...
                      <td class="id">
                        <BLink href="#" class="fw-semibold link-primary">#VZ{{ data.id }}</BLink>
                      </td>
                      <td class="company">
                      ...
                      <td>
                        <ul class="list-inline hstack gap-2 mb-0">
                          <li class="list-inline-item" v-b-tooltip.hover title="View">
                            <Link href="/jobs/details" class="text-primary d-inline-block">
          ...
          <div class="position-relative d-inline-block">
            ...
            <div class="avatar-lg p-1">
              <div class="avatar-title bg-light rounded-circle">
                <img :src="event.img || multi_user_img" id="companylogo-img"
