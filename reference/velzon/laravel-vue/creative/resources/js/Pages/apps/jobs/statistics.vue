  ...
  setup() {
    return {
      ...
      visitorgraphchartOptions: {
        ...
        colors: getChartColorsArray('["--vz-danger", "--vz-success", "--vz-warning", "--vz-info","--vz-secondary", "--vz-primary"]'),
        plotOptions: {
          treemap: {
            distributed: true,
            enableShades: false,
              ...
              <table class="table table-borderless table-sm table-centered align-middle table-nowrap mb-0">
                <tbody class="border-0">
                  <tr>
                    ...
                    <td>
                      <p class="text-muted mb-0">
                        <UsersIcon width="24" height="24" class="me-2 icon-sm align-middle" />78.56k
                      </p>
                    </td>
                    <td class="text-end">
                  ...
                  <tr>
                    ...
                    <td>
                      <p class="text-muted mb-0">
                        <UsersIcon width="24" height="24" class="me-2 icon-sm align-middle" />105.02k
                      </p>
                    </td>
                    <td class="text-end">
                  ...
                  <tr>
                    ...
                    <td>
                      <p class="text-muted mb-0">
                        <UsersIcon width="24" height="24" class="me-2 icon-sm align-middle" />42.89k
                      </p>
                    </td>
                    <td class="text-end">
                      <p class="text-danger fw-medium fs-12 mb-0"><i
            ...
            <div class="flex-shrink-0">
              <BDropdown variant="link" class="card-header-dropdown"
                ...
                <template #button-content>
                  <span class="fw-bold text-uppercase fs-12">Sort by: </span><span class="text-muted">Current Year<i
