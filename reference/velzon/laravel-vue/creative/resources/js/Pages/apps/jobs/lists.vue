...
import sImg9 from "@assets/images/small/img-9.jpg";
import multi_user_img from "@assets/images/users/multi-user.jpg";
  ...
  data() {
    return {
      ...
      chartOptions: {
        ...
        colors: getChartColorsArray('["--vz-success", "--vz-primary", "--vz-danger", "--vz-danger", "--vz-info"]'),
      },
      //
      submitted: false,
      event: {
...
<template>
  <Layout>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardBody class="bg-light-subtle">
            <div class="d-flex align-items-center">
              <h6 class="card-title mb-0 flex-grow-1 fw-bold">Search Jobs</h6>
              <div class="flex-shrink-0">
                <BButton variant="secondary" @click="toggleModal"><i class="ri-add-line align-bottom me-1"></i> Create New
                  Job</BButton>
              </div>
            </div>
      ...
      <BCol xxl="3">
        <BCard no-body class="job-list-view-card overflow-hidden" id="job-overview">
          ...
          <BCardBody>
            ...
            <div class="mt-3">
              ...
              <div class="py-3 border border-dashed border-start-0 border-end-0 mt-4">
                <BRow>
                  <BCol lg="4" sm="6">
                    <div>
                      <p class="mb-2 text-uppercase fw-semibold fw-medium fs-12 text-muted">Job Type</p>
                      <h5 class="fs-14 mb-0 view-type">Full Time</h5>
                    </div>
                  </BCol>
                  <BCol lg="4" sm="6">
                    <div>
                      <p class="mb-2 text-uppercase fw-semibold fw-medium fs-12 text-muted">Post Date</p>
                      <h5 class="fs-14 mb-0 view-postdate">15 Sep, 2022</h5>
                    </div>
                  </BCol>
                  <BCol lg="4" sm="6">
                    <div>
                      <p class="mb-2 text-uppercase fw-semibold fw-medium fs-12 text-muted">Experience</p>
            ...
            <div class="mt-4">
              <BButton type="button" variant="info" class="w-100">Apply Now</BButton>
            </div>
          </BCardBody>
        </BCard>
      </BCol>
