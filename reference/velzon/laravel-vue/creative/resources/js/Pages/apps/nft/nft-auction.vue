                    ...
                    <BCardHeader class="border-0">
                        <div class="d-lg-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="card-title mb-0 fw-bold">Live Auction</h5>
                            </div>
                    ...
                    <BCol xxl="3" lg="4" md="6" class="product-item upto-30">
                        <BCard no-body class="explore-box card-animate">
                            ...
                            <BCardBody>
                                ...
                                <h6 class="fs-16 mb-3">
                                    <Link href="/apps/nft-item-detail" class="text-body">Patterns arts & culture</Link>
                                </h6>
                                <div>
            ...
            <BCol xxl="3">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-2">
                                                    <Link href="/apps/nft-item-detail">
                ...
                <BCard no-body>
                    <BCardHeader class="d-flex align-items-center">
                        ...
                        <Link class="text-muted" href="/apps/nft-item-detail">
                            See All <i class="ri-arrow-right-line align-bottom"></i>
                        </Link>
                    </BCardHeader>
                    <BCardBody>
