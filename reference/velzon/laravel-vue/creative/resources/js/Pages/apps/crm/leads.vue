                ...
                <div class="offcanvas-body">
                  <div class="mb-4">
                    <label for="datepicker-range"
                      class="form-label text-muted text-uppercase fw-bold fs-13 mb-3">Date</label>
                  ...
                  <div class="mb-4">
                    <label for="leadscore" class="form-label text-muted text-uppercase fw-bold fs-13 mb-3">Lead
                      Score</label>
              ...
              <div class="position-relative d-inline-block">
                ...
                <div class="avatar-lg p-1">
                  <div class="avatar-title bg-light rounded-circle">
                    <img :src="event.image_src || user_dummy_image" id="lead-img"
