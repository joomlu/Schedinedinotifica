    ...
    <Layout>
        ...
        <div class="tasks-board mb-3" id="kanbanboard">
                ...
                <div class="d-flex mb-3">
                    ...
                    <div class="flex-shrink-0">
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="p-0 arrow-none"
                            ...
                            <template #button-content><span class="fw-medium text-muted fs-14">Priority<i
            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-16 text-uppercase fw-semibold mb-0">To Do <BBadge tag="small" variant="secondary"
                                class="align-bottom ms-1">2</BBadge>
                        </h6>
                    </div>
                    <div class="flex-shrink-0">
            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-14 text-uppercase fw-bold mb-0">Inprogress
            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-14 text-uppercase fw-bold mb-0">Completed
            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-14 text-uppercase fw-bold mb-0">new <BBadge tag="small" variant="success"
