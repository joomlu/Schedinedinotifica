        ...
        <BCard no-body id="company-overview">
            ...
            <div class="text-center">
              ...
              <ul class="list-inline mb-0">
                <li class="list-inline-item avatar-xs">
                  <BLink href="javascript:void(0);" class="avatar-title bg-body text-body fs-15 rounded">
          ...
          <BCardBody>
            ...
            <div class="table-responsive table-card">
              <table class="table table-borderless mb-4">
                <tbody>
                  ...
                  <tr>
                    <td class="fw-semibold" scope="row">Vacancy</td>
            ...
            <div class="hstack gap-3">
              <BButton type="button" variant="soft-primary" class="custom-toggle w-100" data-bs-toggle="button">
          ...
          <BCardBody class="bg-danger-subtle">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 ms-2">
                <h6 class="fs-16 fw-bold">Free trial</h6>
                <p class="text-muted mb-0">28 days left</p>
              </div>
              <div>
                <Link href="/pages/pricing" class="btn btn-danger">Upgrade</Link>
              </div>
            </div>
          </BCardBody>
