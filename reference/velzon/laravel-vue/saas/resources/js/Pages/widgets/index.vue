            ...
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-grow-1">
                <h5 class="text-primary fs-18 mb-0 product-price"><span>$22.45</span> <small
                    class="text-decoration-line-through text-muted fs-13 product-line-price">$37.45</small></h5>
              </div>
            ...
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-grow-1">
                <h5 class="text-primary fs-18 mb-0 product-price"><span>$48.20</span> <small
                    class="text-decoration-line-through text-muted fs-13 product-line-price">$124.10</small></h5>
              </div>
