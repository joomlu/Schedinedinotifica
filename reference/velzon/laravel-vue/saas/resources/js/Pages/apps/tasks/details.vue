                                ...
                                <simplebar data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                    <div class="d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-13">
                                                <Link href="/pages/profile" class="text-body">Joseph Parker</Link> <small class="text-muted">20 Dec 2021 - 05:47AM</small>
                                            </h5>
                                    ...
                                    <div class="d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-13">
                                                <Link href="/pages/profile" class="text-body">Thomas Taylor</Link> <small class="text-muted">24 Dec 2021 - 05:20PM</small>
                                            </h5>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-13">
                                                <Link href="/pages/profile" class="text-body">Tonya Noble</Link> <small class="text-muted">26 min ago</small>
                                            </h5>
