            ...
            <BContainer>
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        <li class="nav-item">
                            <BLink class="nav-link fs-14 fw-semibold" href="#hero" @click.prevent="scrollToSection('hero')">Home</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14 fw-semibold" href="#wallet" @click.prevent="scrollToSection('wallet')">Wallet
                            </BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14 fw-semibold" href="#marketplace" @click.prevent="scrollToSection('marketplace')">Marketplace</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14 fw-semibold" href="#categories" @click.prevent="scrollToSection('categories')">
                                Categories</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14 fw-semibold" href="#creators" @click.prevent="scrollToSection('creators')">
                                Creators</BLink>
                        </li>
                    </ul>

                    <div class="">
                        <Link href="/apps/nft-wallet" class="btn btn-success">Wallet Connect</Link>
                    </div>
                </BCollapse>
                    ...
                    <BCol lg="8" sm="10">
                        <div class="text-center">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                ...
                                <Link href="/apps/nft-explore" class="btn btn-danger">Explore Now <i
                                        class="ri-arrow-right-line align-middle ms-1"></i></Link>
                            </div>
                        </div>
                    </BCol>
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <BContainer>
                <BRow class="align-items-center gy-4">
                    ...
                    <BCol sm="auto">
                        <div>
                            <Link href="/apps/nft-create" class="btn bg-gradient btn-danger">Create NFT
                            </Link>
                            <Link href="/apps/nft-explore" class="btn bg-gradient btn-info">Discover More
                            </Link>
                        </div>
                    </BCol>
