...
<template>
    <BCard no-body>
        <BCardHeader class="align-items-center d-flex py-0">
            <BCardTitle class="mb-0 flex-grow-1">Recent NFTs</BCardTitle>
            <div class="flex-shrink-0">
                <BDropdown variant="link" class="card-header-dropdown" toggle-class="text-reset dropdown-btn arrow-none shadow-none"
                    ...
                    <template #button-content> <span class="fw-semibold text-uppercase fs-12">Sort by: </span><span
                            class="text-muted">Popular
                            <i class="mdi mdi-chevron-down ms-1"></i></span>
                    </template>
                    <BDropdownItem>Popular</BDropdownItem>
                    <BDropdownItem>Newest</BDropdownItem>
                    <BDropdownItem>Oldest</BDropdownItem>
                </BDropdown>
            </div>
        </BCardHeader>
        <BCardBody>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <Link href="/apps/nft-item-detail" class="text-body">Abstract Face
                                                Painting</Link>
                                        </h6>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <Link href="/apps/nft-item-detail" class="text-body">Robotic Body
                                                Art</Link>
                                        </h6>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <Link href="/apps/nft-item-detail" class="text-body">Smillevers
                                                Crypto</Link>
                                        </h6>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <Link href="/apps/nft-item-detail" class="text-body">Creative
                                                Filtered Portrait</Link>
                                        </h6>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <Link href="/apps/nft-item-detail" class="text-body">The
                                                Chirstoper</Link>
                                        </h6>
