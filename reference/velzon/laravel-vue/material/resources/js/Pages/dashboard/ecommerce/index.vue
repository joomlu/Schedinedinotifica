                ...
                <div class="mt-3 mt-lg-0">
                  <form action="javascript:void(0);">
                    <BRow class="g-3 mb-0 align-items-center">
                      ...
                      <div class="col-auto">
                        <BButton type="button" variant="soft-success" class="shadow-none">
                          <i class="ri-add-circle-line align-middle me-1"></i>
                          Add Product
                        </BButton>
                      </div>
                      <div class="col-auto">
                        <BButton type="button" variant="soft-info" class="btn-icon waves-effect layout-rightside-btn shadow-none"
                          @click="rightcolumn">
                ...
                <BCardHeader class="align-items-center d-flex py-0">
                  ...
                  <div class="flex-shrink-0">
                    <BDropdown variant="link" class="card-header-dropdown"
                      toggle-class="text-reset dropdown-btn arrow-none shadow-none" menu-class="dropdown-menu-end"
            ...
            <BCol xl="8">
              <BCard no-body>
                <BCardHeader class="align-items-center d-flex">
                  ...
                  <div class="flex-shrink-0">
                    <BButton type="button" variant="soft-info" size="sm" class="shadow-none">
              ...
              <div class="p-3">
                ...
                <div class="mt-3">
                  <BRow class="align-items-center g-2">
                    ...
                    <BCol>
                      <div class="p-1">
                        <BProgress variant="success" class="animated-progess bg-success-subtle progress-sm" :value="50.16" />
                      </div>
                    </BCol>
                    <div class="col-auto">
                      <div class="p-1">
                  ...
                  <BRow class="align-items-center g-2">
                    ...
                    <BCol>
                      <div class="p-1">
                        <BProgress variant="success" class="animated-progess bg-success-subtle progress-sm" :value="29.32" />
                      </div>
                    </BCol>
                    <div class="col-auto">
                      <div class="p-1">
                  ...
                  <BRow class="align-items-center g-2">
                    ...
                    <BCol>
                      <div class="p-1">
                        <BProgress variant="warning" class="animated-progess bg-success-subtle progress-sm" :value="18.12" />
                      </div>
                    </BCol>
                    <div class="col-auto">
                      <div class="p-1">
                  ...
                  <BRow class="align-items-center g-2">
                    ...
                    <BCol>
                      <div class="p-1">
                        <BProgress variant="success" class="animated-progess bg-success-subtle progress-sm" :value="4.98" />
                      </div>
                    </BCol>
                  ...
                  <BRow class="align-items-center g-2">
                    ...
                    <BCol>
                      <div class="p-1">
                        <BProgress variant="danger" class="animated-progess bg-success-subtle progress-sm" :value="7.42" />
                      </div>
                    </BCol>
                    <div class="col-auto">
                      <div class="p-1">
