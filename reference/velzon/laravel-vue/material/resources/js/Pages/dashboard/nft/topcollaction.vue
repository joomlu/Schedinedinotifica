...
<template>
    <BCard no-body>
        <BCardHeader class="d-flex align-items-center">
            ...
            <Link href="/apps/nft-collection" type="button" class="btn btn-soft-primary btn-sm shadow-none flex-shrink-0">
            ...
            <div class="swiper collection-slider">
                <div class="swiper-wrapper">
                    <swiper class="swiper responsive-swiper rounded gallery-light" :loop="true" :slidesPerView="1"
                        :spaceBetween="10" :autoplay="{ delay: 2500, disableOnInteraction: false }" :modules="[Autoplay]">
                        <swiper-slide>
    ...
    <BCard no-body>
        <BCardHeader class="d-flex align-items-center">
            ...
            <Link href="/apps/nft-creators" type="button" class="btn btn-soft-primary shadow-none btn-sm flex-shrink-0">
                See All <i class="ri-arrow-right-line align-bottom"></i>
            </Link>
        </BCardHeader>
        <BCardBody>
                                ...
                                <div>
                                    <div class="dropdown float-end">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <Link class="dropdown-item" href="javascript:void(0);">View</Link>
                                            </li>
                                            <li>
                                                <Link class="dropdown-item" href="javascript:void(0);">Share</Link>
                                            </li>
                                            <li>
