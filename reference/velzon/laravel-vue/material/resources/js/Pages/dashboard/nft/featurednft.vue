                        ...
                        <BCard no-body class="explore-box card-animate rounded">
                            ...
                            <BCardBody style="position: relative">
                                <p class="fw-medium mb-0 mt-3 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    37.41k </p>
                                <h5 class="mb-1">
                                    <Link href="/apps/nft-item-detail" class="text-body">Walking On Air</Link>
                                </h5>
                        ...
                        <BCard no-body class="explore-box card-animate rounded">
                            ...
                            <BCardBody style="position: relative">
                                <p class="fw-medium mb-0 mt-3 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    19.29k </p>
                                <h5 class="mb-1">
                                    <Link href="/apps/nft-item-detail" class="text-body">Filtered Portrait
                                    </Link>
                                </h5>
                        ...
                        <BCard no-body class="explore-box card-animate rounded">
                            ...
                            <BCardBody style="position: relative">
                                <p class="fw-medium mb-0 mt-3 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    8.42k </p>
                                <h5 class="mb-1">
                                    <Link href="/apps/nft-item-detail" class="text-body">Patterns Arts & Culture
                                    </Link>
                                </h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </BCardBody>
