  ...
  <BCard no-body>
    <BCardHeader class="d-flex align-items-center">
      ...
      <div class="flex-shrink-0">
        <BLink href="javascript:void(0);" class="btn btn-soft-info btn-sm shadow-none">Export Report</BLink>
      </div>
    </BCardHeader>
    <BCardBody>
            ...
            <tr v-for="(item, index) of activeProjects" :key="index">
              ...
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <BProgress class="progress-sm bg-primary-subtle flex-grow-1 rounded" :value="53" variant="primary" />
                </div>
              </td>
              <td>
