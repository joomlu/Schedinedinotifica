          ...
          <div class="">
            <BCardHeader class="border-0 align-items-center d-flex">
              ...
              <div class="hstack gap-1">
                <BButton type="button" variant="soft-secondary" size="sm" class="shadow-none">
                  ALL
                </BButton>
                <BButton type="button" variant="soft-secondary" size="sm" class="shadow-none">
                  1M
            ...
            <div class="w-100">
              <div class="d-flex align-items-center">
                ...
                <BDropdown variant=" link" class="card-header-dropdown"
                  toggle-class="align-middle text-muted arrow-none shadow-none" menu-class="dropdown-menu-end"
