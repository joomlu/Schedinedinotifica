                    ...
                    <BCol lg="4">
                        <BCard no-body class="text-center border">
                            <BCardBody class="py-5 px-4">
                                ...
                                <h5>Metamask</h5>
                                <p class="text-muted pb-1 fs-13">MetaMask is a software cryptocurrency wallet used to
                    ...
                    <BCol lg="4">
                        <BCard no-body class="text-center border">
                            <BCardBody class="py-5 px-4">
                                ...
                                <p class="text-muted pb-1 fs-13">Coinbase Wallet is a software product that gives you
                    ...
                    <BCol lg="4">
                        <BCard no-body class="text-center border">
                            <BCardBody class="py-5 px-4">
                                ...
                                <h5>Binance</h5>
                                <p class="text-muted pb-1 fs-13">Binance offers a relatively secure, versatile way to
