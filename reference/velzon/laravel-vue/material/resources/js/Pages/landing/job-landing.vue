            ...
            <BContainer fluid class="custom-container">
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#hero" @click.prevent="scrollToSection('hero')">Home
                            </BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#process" @click.prevent="scrollToSection('process')">
                                Process
                            </BLink>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#findJob" @click.prevent="scrollToSection('findJob')">Find
                                Jobs</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#candidates" @click.prevent="scrollToSection('candidates')">
                                Candidates</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#blog" @click.prevent="scrollToSection('blog')">Blog</BLink>
                        </li>
                    </ul>
                ...
                <BRow class="align-items-center justify-content-lg-between justify-content-center gy-4">
                    ...
                    <BCol lg="6">
                        <div class="text-muted">
                            <h1 class="mb-3 lh-base fw-semibold">Find Your <span class="text-primary">Dream Job</span> in One Place
                            </h1>
                ...
                <BRow>
                    ...
                    <BCol lg="12">
                        <div class="text-center mt-4">
                            <BLink href="#!" class="btn btn-ghost-primary shadow-none">View More Jobs <i
