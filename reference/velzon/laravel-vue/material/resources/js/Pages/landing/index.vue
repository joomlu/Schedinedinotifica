            ...
            <BContainer>
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        ...
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#services" @click.prevent="scrollToSection('services')">Services</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#features" @click.prevent="scrollToSection('features')">Features</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#plans" @click.prevent="scrollToSection('plans')">Plans</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#reviews" @click.prevent="scrollToSection('reviews')">Reviews</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#team" @click.prevent="scrollToSection('team')">Team</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-14" href="#contact" @click.prevent="scrollToSection('contact')">Contact</BLink>
                        </li>
                    </ul>
