    ...
    return {
      orderSummary: [
        ...
        },
        {
          id: 2,
          img: pImg7,
          product: "Noise NoiseFit Endure Smart Watch",
          price: 94.99,
          quantity: 1,
          size: "32.5mm",
          color: "Black"
...
<template>
  <Layout>
    <PageHeader title="Order Details" pageTitle="Ecommerce" />
    <BRow>
      <BCol xl="9">
        <BCard no-body>
          <BCardHeader>
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <Link href="/invoices/detail" class="btn btn-success btn-sm"><i
                    ...
                    <td>
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <h5 class="fs-15">
                            <Link href="/ecommerce/product-details" class="link-primary">{{ item.product }}
                            </Link>
                          </h5>
                          <p class="text-muted mb-0">
                            Color: <span class="fw-medium">{{ item.color }}</span>
                          </p>
                          <p class="text-muted mb-0">
          ...
          <BCardHeader>
            <div class="d-sm-flex align-items-center">
              ...
              <div class="flex-shrink-0 mt-2 mt-sm-0">
                <BLink href="javascript:void(0);" class="btn btn-soft-info btn-sm mt-2 mt-sm-0 shadow-none"><i
                    class="ri-map-pin-line align-middle me-1"></i> Change
                  Address</BLink>
                <BLink href="javascript:void(0);" class="btn btn-soft-danger btn-sm mt-2 mt-sm-0 ms-1 shadow-none"><i
            ...
            <div class="profile-timeline">
              <div class="accordion accordion-flush" id="accordionFlushExample">
                ...
                <div class="accordion-item border-0">
                  ...
                  <BCollapse id="collapseThree" visible>
                    <div class="accordion-body ms-2 ps-5 pt-0">
                ...
                <div class="accordion-item border-0">
                  <div class="accordion-header" id="headingFour">
                    <BLink class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFour"
                      aria-expanded="false">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 avatar-xs">
                ...
                <div class="accordion-item border-0">
                  <div class="accordion-header" id="headingFive">
                    <BLink class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFile"
                      aria-expanded="false">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 avatar-xs">
                          <div class="avatar-title bg-light text-success rounded-circle shadow">
        ...
        <BCard no-body>
          <BCardHeader>
            <div class="d-flex">
              ...
              <div class="flex-shrink-0">
                <BLink href="javascript:void(0);" class="badge bg-primary-subtle text-primary fs-11">Track Order</BLink>
              </div>
            </div>
          </BCardHeader>
          <BCardBody>
        ...
        <BCard no-body>
          <BCardHeader>
            <div class="d-flex">
              ...
              <div class="flex-shrink-0">
                <BLink href="javascript:void(0);" class="link-secondary">View Profile</BLink>
              </div>
            </div>
          </BCardHeader>
          <BCardBody>
