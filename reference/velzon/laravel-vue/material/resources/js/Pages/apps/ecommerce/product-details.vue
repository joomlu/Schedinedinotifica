                ...
                <div class="mt-xl-0 mt-5">
                  <div class="d-flex">
                    ...
                    <div class="flex-shrink-0">
                      <div>
                        <Link href="/ecommerce/add-product" class="btn btn-light" data-bs-toggle="tooltip"
                        ...
                        <div>
                          ...
                          <div class="mt-3">
                            ...
                            <BRow class="align-items-center g-2">
                              ...
                              <BCol>
                                <div class="p-2">
                                  <BProgress variant="success" class="animated-progess bg-success-subtle progress-sm" :value="19.32" />
                                </div>
                              </BCol>
                              <div class="col-auto">
                                <div class="p-2">
                            ...
                            <BRow class="align-items-center g-2">
                              ...
                              <BCol>
                                <div class="p-2">
                                  <BProgress variant="success" class="animated-progess bg-success-subtle progress-sm" :value="18.12" />
                                </div>
                              </BCol>
                              <div class="col-auto">
                                <div class="p-2">
                            ...
                            <BRow class="align-items-center g-2">
                              ...
                              <BCol>
                                <div class="p-2">
                                  <BProgress variant="warning" class="animated-progess bg-success-subtle progress-sm" :value="7.42" />
                                </div>
                              </BCol>
                            ...
                            <BRow class="align-items-center g-2">
                              ...
                              <BCol>
                                <div class="p-2">
                                  <BProgress variant="danger" class="animated-progess bg-success-subtle progress-sm" :value="4.98" />
                                </div>
                              </BCol>
                              <div class="col-auto">
                                <div class="p-2">
                                  ...
                                  <div class="d-flex flex-grow-1 gap-2 mb-3">
                                    <BLink href="#" class="d-block">
                                      <img src="@assets/images/small/img-12.jpg" alt
                                        class="avatar-sm shadow rounded object-fit-cover" />
                                    </BLink>
                                    <BLink href="#" class="d-block">
