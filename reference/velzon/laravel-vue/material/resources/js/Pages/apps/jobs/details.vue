              ...
              <BRow class="mb-3">
                ...
                <BCol md="auto">
                  <div class="hstack gap-1 flex-wrap mt-4 mt-md-0">
                    <BButton type="button" variant="ghost-warning" size="sm" class="btn-icon fs-16 shadow-none">
                      <i class="ri-star-fill"></i>
                    </BButton>
                    <BButton type="button" variant="ghost-primary" size="sm" class="btn-icon fs-16 shadow-none">
          ...
          <BCol lg="12">
            <div class="d-flex align-items-center mb-4">
              ...
              <div class="flex-shrink-0">
                <BLink href="#!" class="btn btn-ghost-success shadow-none">View All <i
        ...
        <BCard no-body>
          ...
          <BCardBody>
            <form>
              ...
              <div class="text-end">
                <BButton type="submit" variant="secondary">Send Message</BButton>
              </div>
            </form>
          </BCardBody>
        </BCard>
