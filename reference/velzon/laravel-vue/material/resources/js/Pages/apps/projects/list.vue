...
<template>
  <Layout>
    ...
    <BRow class="g-4 mb-3">
      <BCol sm="auto">
        <div>
          <Link href="/apps/projects-create" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i>
            Add New</Link>
        </div>
      </BCol>
      <BCol sm>
          ...
          <BCardBody>
            <div class="d-flex flex-column h-100">
              <div class="d-flex">
                ...
                <div class="flex-shrink-0">
                  <div class="d-flex gap-1 align-items-center">
                    <BButton type="button" variant="transparent" class="btn avatar-xs mt-n1 p-0 favourite-btn shadow-none"
                    ...
                    <BDropdown variant="link"
                      toggle-class="btn btn-link text-muted p-1 mt-n2 py-0 text-decoration-none fs-15 arrow-none shadow-none"
                      ...
                      <BDropdownItem href="/apps/projects-overview"><i
                          class="ri-eye-fill align-bottom me-2 text-muted"></i>
                        View</BDropdownItem>
                      <BDropdownItem href="/apps/projects-create"><i
              ...
              <div class="d-flex mb-2">
                ...
                <div class="flex-grow-1">
                  <h5 class="mb-1 fs-15">
                    <Link href="/apps/projects-overview" class="text-body">{{ item.label }}</Link>
                  </h5>
              ...
              <div class="mt-auto">
                ...
                <div class="progress progress-sm animated-progess bg-success-subtle">
              ...
              <div class="flex-grow-1">
                <div class="avatar-group">
                  <BLink href="javascript: void(0);" v-for="( subitem, index ) of  item.subItem " :key="index"
                    class="avatar-group-item shadow" v-b-tooltip.hover title="Darline Williams">
          ...
          <BCardBody>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                  <div class="d-flex gap-1 align-items-center my-n2">
                    <BButton type="button" variant="transparent" class="btn avatar-xs p-0 favourite-btn active shadow-none"
                      @click="toggleFavourite">
                      <span class="avatar-title bg-transparent fs-15">
                        <i class="ri-star-fill"></i>
                      </span>
                    ...
                    <BDropdown variant="link"
                      ...
                      <BDropdownItem href="/apps/projects-overview"><i class="ri-eye-fill align-bottom me-2 text-muted"></i>
                        View</BDropdownItem>
                      <BDropdownItem href="/apps/projects-create"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                        Edit </BDropdownItem>
                      <div class="dropdown-divider"></div>
            ...
            <div class="py-3">
              ...
              <div class="d-flex align-items-center mt-3">
                ...
                <div class="avatar-group">
                  <BLink href="javascript: void(0);" v-for="( subItem, index ) of  item.subItem " :key="index"
                    class="avatar-group-item shadow" v-b-tooltip.hover title="Donna Kline">
      ...
      <BCol xxl="3" sm="6" class="project-card" v-for="( item, index ) of  projectListWidgets3 " :key="index">
        <BCard no-body>
          <BCardBody>
            ...
            <div class="py-3">
              <h5 class="fs-14 mb-3">
                <Link href="/apps/projects-overview" class="text-body">{{
                  item.label
                }}</Link>
              </h5>
              <BRow class="gy-3">
