  ...
  setup() {
    return {
      ...
      yournetworkchartchartOptions: {
        ...
        colors: getChartColorsArray('["--vz-danger", "--vz-warning"]'),
        xaxis: {
            ...
            <div class="d-flex">
              ...
              <div class="flex-shrink-0">
                <BDropdown variant="link" class="card-header-dropdown"
                  toggle-class="my-n3 text-reset dropdown-btn arrow-none shadow-none" menu-class="dropdown-menu-end"
              ...
              <table class="table table-borderless table-sm table-centered align-middle table-nowrap mb-0">
                <tbody class="border-0">
                  <tr>
                    <td>
                      <h4 class="text-truncate fs-14 fs-medium mb-0"><i
                          class="ri-stop-fill align-middle fs-18 text-secondary me-2"></i>Desktop Users</h4>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <h4 class="text-truncate fs-14 fs-medium mb-0"><i
                          class="ri-stop-fill align-middle fs-18 text-success me-2"></i>Tablet Users</h4>
                    </td>
                    <td>
                      <p class="text-muted mb-0">
      ...
      <BCol xxl="8" md="6">
        <BCard no-body class="card-height-100">
          <BCardHeader class="align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <BDropdown variant="link" class="card-header-dropdown shadow-none"
                toggle-class="my-n3 text-reset dropdown-btn arrow-none shadow-none" menu-class="dropdown-menu-end"
                aria-haspopup="true" :offset="{ alignmentAxis: -45, crossAxis: 0, mainAxis: 0 }">
