                ...
                <div class="p-4 d-flex flex-column h-100">
                    ...
                    <simplebar class="px-4 mx-n4" data-simplebar style="height: calc(100vh - 468px);">
                        <ul class="to-do-menu list-unstyled" id="projectlist-data">
                            <li>
                                <BLink v-b-toggle.velzonAdmin class="nav-link fs-14 active">
                                    Velzon
                            ...
                            <li>
                                <BLink v-b-toggle.projectManagement class="nav-link fs-14">
                                    Project
                                    Management</BLink>
                            ...
                            <li>
                                <BLink v-b-toggle.skoteAdmin class="nav-link fs-14">Skote Admin
                                    &
                                    Dashboard</BLink>
                            ...
                            <li>
                                <BLink v-b-toggle.ecommerceProject class="nav-link fs-14">Doot -
                                    Chat
                                    App Template</BLink>
                ...
                <BRow class="mb-4">
                    ...
                    <BCol order="2" order-sm="3" class="col-auto ms-auto">
                        <div class="hstack gap-2">
                            <BButton-group>
                                <BButton variant="soft-danger" class="btn btn-icon fw-semibold shadow-none"><i
                                        class="ri-arrow-go-back-line"></i></BButton>
                                <BButton variant="soft-success" class="btn btn-icon fw-semibold shadow-none"><i
        ...
        <BModal v-model="projectModal" hide-footer title="Create Project" class="v-modal-custom" modal-class="zoomIn"
            ...
            <BForm id="projectForm" autocomplete="off" class="needs-validation createProject-form" novalidate>
                ...
                <div class="hstack gap-2 justify-content-end">
                    <BButton type="button" variant="ghost-success" id="addProjectBtn-close" class="shadow-none"
