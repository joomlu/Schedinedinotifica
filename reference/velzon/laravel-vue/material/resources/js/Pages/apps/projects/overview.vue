                                ...
                                <BCard no-body>
                                    <BCardBody>
                                        <div class="text-muted">
                                            ...
                                            <div>
                                                <BButton type="button" variant="link" class="link-success p-0 shadow-none">Read
                                                    more</BButton>
                                            </div>
                                                                ...
                                                                <div class="flex-shrink-0 ms-2">
                                                                    <div class="d-flex gap-1">
                                                                        ...
                                                                        <BDropdown variant="link"
                                                                            toggle-class="btn btn-icon btn-sm fs-18 text-muted arrow-none shadow-none"
                                                                    ...
                                                                    <div class="d-flex gap-1">
                                                                        <button type="button"
                                                                            class="btn btn-icon text-muted btn-sm fs-18 shadow-none"><i
                                                                                class="ri-download-2-line"></i></button>
                                                                        <BDropdown variant="link"
                                                                            toggle-class="btn btn-icon btn-sm fs-18 shadow-none text-muted arrow-none"
                                                                            menu-class="dropdown-menu-end"
                                                                            :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                                                            <template #button-content>
                                                                                <i class="ri-more-fill"></i>
                                            ...
                                            <BRow class="g-3">
                                                ...
                                                <BCol cols="12" class="text-end">
                                                    <BButton type="button" variant="ghost-secondary"
                                                        class="btn-icon waves-effect me-1 shadow-none">
                            ...
                            <BCol xl="3" lg="4">
                                ...
                                <BCard no-body>
                                    <BCardHeader class="align-items-center d-flex border-bottom-dashed">
                                        ...
                                        <div class="flex-shrink-0">
                                            <BButton type="button" variant="soft-danger" size="sm" class="shadow-none"><i
                                ...
                                <BCard no-body>
                                    <BCardHeader class="align-items-center d-flex border-bottom-dashed">
                                        ...
                                        <div class="flex-shrink-0">
                                            <BButton type="button" variant="soft-info" size="sm" class="shadow-none"><i
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm">
                                                                <div
                                                                    class="avatar-title bg-light text-secondary rounded fs-24 shadow-none">
                                                                    <i class="ri-folder-zip-line"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <td>
                                                        <BDropdown variant="link"
                                                            toggle-class="btn btn-soft-secondary btn-sm btn-icon arrow-none shadow-none"
                                                            menu-class="dropdown-menu-end"
                                                            :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                                            <template #button-content>
                                                                <i class="ri-more-fill"></i>
