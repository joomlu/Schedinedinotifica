            ...
            <BRow class="justify-content-between gy-3">
              ...
              <BCol lg="auto">
                <div class="d-md-flex text-nowrap gap-2">
                  ...
                  <BDropdown variant="link" right toggle-class="text-decoration-none arrow-none p-0 shadow-none"
    ...
    <BRow>
      <BCol lg="12">
        <div class="text-center mb-3">
          <BButton variant="link" class="text-success shadow-none mt-2" id="loadmore"><i
