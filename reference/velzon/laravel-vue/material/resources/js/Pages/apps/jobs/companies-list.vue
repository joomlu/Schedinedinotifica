      ...
      <BCol xxl="3">
        <BCard no-body id="company-overview">
          <BCardBody>
            ...
            <div class="text-center">
              <BLink href="#!">
                <h5 class="overview-companyname fw-semibold fs-17" id="overview-companyname">Syntyce Solutions</h5>
              </BLink>
          ...
          <BCardBody>
            ...
            <div class="hstack gap-3">
              <BButton type="button" variant="soft-success" class="custom-toggle w-100 shadow-none" data-bs-toggle="button">
