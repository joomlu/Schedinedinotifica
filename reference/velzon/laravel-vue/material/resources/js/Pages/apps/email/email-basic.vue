                                                ...
                                                <tr
                                                    ...
                                                    <td class="content-block" itemprop="handler" itemscope
                                                        ...
                                                        <BLink href="#" itemprop="url"
                                                            style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: .8125rem;font-weight: 400; color: #FFF; text-decoration: none; text-align: center; cursor: pointer; display: inline-block; border-radius: .25rem; text-transform: capitalize; background-color: #3bad71; margin: 0; border-color: #3bad71; border-style: solid; border-width: 1px; padding: .5rem .9rem;"
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr
                                                    ...
                                                    <td class="content-block"
                                                        ...
                                                        <div style="text-align: center;">
                                                            <lock-icon class="icon-sm" style="color: #3bad71;fill: rgba(10,179,156,.16); height: 30px; width: 30px;"></lock-icon>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr
                                                ...
                                                <tr
                                                    ...
                                                    <td class="content-block" itemprop="handler" itemscope
                                                        ...
                                                        valign="top">
                                                        <BLink href="#" itemprop="url"
                                                            style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: .8125rem; color: #FFF; text-decoration: none; font-weight: 400; text-align: center; cursor: pointer; display: inline-block; border-radius: .25rem; text-transform: capitalize; background-color: #4b38b3; margin: 0; border-color: #4b38b3; border-style: solid; border-width: 1px; padding: .5rem .9rem;">
                                                            Reset
                                                            Password</BLink>
                                                    </td>
                                                </tr>
