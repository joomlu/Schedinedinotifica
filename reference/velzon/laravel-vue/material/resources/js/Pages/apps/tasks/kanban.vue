                ...
                <BRow class="g-2">
                    ...
                    <div class="col-auto ms-sm-auto">
                        <div class="avatar-group" id="newMembar">
                            <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Nancy">
                                <img src="@assets/images/users/avatar-5.jpg" alt="" class="rounded-circle avatar-xs">
                            </BLink>
                            <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Frank">
                                <img src="@assets/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-xs">
                            </BLink>
                            <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Tonya">
                                <img src="@assets/images/users/avatar-10.jpg" alt="" class="rounded-circle avatar-xs">
                            </BLink>
                            <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Thomas">
                                <img src="@assets/images/users/avatar-8.jpg" alt="" class="rounded-circle avatar-xs">
                            </BLink>
                            <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Herbert">
                                <img src="@assets/images/users/avatar-2.jpg" alt="" class="rounded-circle avatar-xs">
                            </BLink>
                            <BLink class="avatar-group-item shadow" @click="modalShow = !modalShow">
                                <div class="avatar-xs">
            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    ...
                    <div class="flex-shrink-0">
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="p-0 arrow-none shadow-none"
                                ...
                                <BCardBody>
                                    <div class="d-flex mb-2">
                                        <h6 class="fs-15 mb-0 flex-grow-1 text-truncate">
                                            <Link href="/apps/tasks-details" class="text-body">{{ data.title }}</Link>
                                        </h6>
                                        <BDropdown variant="link" toggle-class="text-muted p-0 arrow-none shadow-none"
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="avatar-group">
                                                <BLink href="javascript: void(0);" v-for="(item, index) of data.users"
                                                    :key="index" class="avatar-group-item shadow" v-b-tooltip.hover title="Alexis">
                            ...
                            <BCard no-body class="tasks-box" v-for="(data, index) of todo" :key="index">
                                <BCardBody>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="progress rounded-3 progress-sm bg-warning-subtle">
                                            <div class="progress-bar bg-danger" role="progressbar" style="width: 15%"
                                                aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
