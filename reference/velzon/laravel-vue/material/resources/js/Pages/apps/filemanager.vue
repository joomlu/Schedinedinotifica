                ...
                <BCard no-body class="bg-light shadow-none" id="folder-1">
                  <BCardBody>
                    <div class="d-flex mb-1">
                      ...
                      <BDropdown variant="ghost-primary" size="sm" class="btn-icon " toggle-class="arrow-none shadow-none"
                  ...
                  <tr v-for="(fileData, index) of this.filelist" :key="index">
                    ...
                    <td>
                      <div class="d-flex gap-3 justify-content-center">
                        ...
                        <BDropdown variant="light" size="sm" class="btn-icon" toggle-class="arrow-none shadow-none"
