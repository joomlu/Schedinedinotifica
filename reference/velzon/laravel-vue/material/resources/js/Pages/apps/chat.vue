          ...
          <div class="d-flex align-items-start">
            ...
            <div class="flex-shrink-0">
              <div v-b-tooltip.hover title="Add Contact">
                <BButton type="button" variant="soft-success" size="sm" class="shadow-none">
                      ...
                      <div class="flex-grow-1 overflow-hidden">
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3 ms-0">
                            <img :src="profile ? profile : user_dummy_image" class="rounded-circle avatar-xs" alt="" />
                  ...
                  <BCol sm="8" cols="4">
                    <ul class="list-inline user-chat-nav text-end mb-0">
                      ...
                      <li class="list-inline-item d-none d-lg-inline-block m-0">
                        <BButton type="button" variant="ghost-secondary" class="btn-icon shadow-none" @click="showOffcanvas = !showOffcanvas">
                          <info-icon class="icon-sm"></info-icon>
                        </BButton>
                      </li>

                      <li class="list-inline-item m-0">
                        <BDropdown variant="link" class="btn btn-ghost-secondary btn-icon shadow-none" toggle-class=" arrow-none shadow-none" menu-class="dropdown-menu" aria-haspopup="true">
                      ...
                      <div class="conversation-list">
                        ...
                        <div class="user-chat-content">
                          <div class="ctext-wrap">
                            ...
                            <BDropdown variant="link" class="dropdown align-self-start message-box-drop" toggle-class=" arrow-none shadow-none" menu-class="dropdown-menu" aria-haspopup="true">
                  ...
                  <BRow class="g-0 align-items-center">
                    ...
                    <BCol cols="auto">
                      <div class="chat-input-links ms-2">
                        <div class="links-list-item">
                          <BButton variant="primary" type="submit" class="chat-send shadow">
                ...
                <BCard no-body class="mb-0">
                  <BCardBody class="py-3">
                    <div class="replymessage-block mb-0 d-flex align-items-start">
                      ...
                      <div class="flex-shrink-0">
                        <BButton type="button" variant="link" size="sm" id="close_toggle" class="mt-n2 me-n3 fs-18 shadow-none">
