                    ...
                    <BCardBody>
                        <div class="d-flex mb-3">
                            ...
                            <div class="flex-shrink-0">
                                <BButton type="button" class="shadow-none" variant="soft-danger" size="sm" @click="modalShow = !modalShow">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-shrink-0">
                                        <BDropdown variant="link"
                                            toggle-class="btn btn-icon btn-sm fs-16 text-muted arrow-none shadow-none"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                        <div class="d-flex gap-1">
                                            ...
                                            <BDropdown variant="link"
                                                toggle-class="btn btn-icon text-muted btn-sm fs-18 arrow-none shadow-none"
                                                menu-class="dropdown-menu-end">
                                                <template #button-content>
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                        <div class="d-flex gap-1">
                                            <button type="button" class="btn btn-icon text-muted btn-sm fs-18 shadow-none"><i
                                                    class="ri-download-2-line"></i></button>
                                            <BDropdown variant="link"
                                                toggle-class="btn btn-icon text-muted btn-sm fs-18 shadow-none arrow-none"
                                                menu-class="dropdown-menu-end">
                                                <template #button-content>
                                                    <i class="ri-more-fill "></i>
                                                </template>
