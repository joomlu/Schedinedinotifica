                ...
                <div class="p-4 d-flex flex-column h-100">
                    ...
                    <simplebar class="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
                        ...
                        <div class="border-top border-top-dashed pt-3 mt-3">
                            <BLink href="#" class="btn btn-icon btn-sm btn-soft-info shadow-none btn-rounded float-end"><i class="bx bx-plus fs-16"></i></BLink>
                    ...
                    <div class="border-bottom border-bottom-dashed">
                        <BRow class="mt-n2 mb-3 mb-sm-0">
                            <BCol sm="auto" order="1" class="d-block d-lg-none">
                                <BButton type="button" variant="soft-success" size="sm" class="btn-icon fs-16 email-menu-btn">
                            ...
                            <BCol order="3" order-sm="2" sm>
                                <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                    ...
                                    <div id="email-topbar-actions">
                                        <BButton type="button" variant="ghost-secondary" size="sm" class="btn-icon fs-16 shadow-none" v-b-tooltip.hover title="Archive">
                                            <i class="ri-inbox-archive-fill align-bottom"></i>
                                        </BButton>
                                        <BButton type="button" variant="ghost-secondary" size="sm" class="btn-icon fs-16 shadow-none" v-b-tooltip.hover title="Report Spam">
                                            <i class="ri-error-warning-fill align-bottom"></i>
                                        </BButton>
                                        <BButton type="button" variant="ghost-secondary" size="sm" class="btn-icon fs-16 shadow-none" data-bs-trigger="hover" data-bs-placement="top" title="Trash" @click="deleteMail">
                                            <i class="ri-delete-bin-5-fill align-bottom"></i>
                                        </BButton>
                                    </div>
                                    <div class="vr align-self-center mx-2"></div>
                                    <BButton type="button" variant="ghost-secondary" size="sm" class="btn-icon fs-16 shadow-none" v-b-tooltip.hover title="Labels">
                            ...
                            <div class="col-auto order-2 order-sm-3">
                                <div class="d-flex gap-sm-1 email-topbar-link">
                                    <BButton type="button" variant="ghost-secondary" size="sm" class="btn-icon fs-16 shadow-none">
                                        <i class="ri-refresh-line align-bottom"></i>
                                    </BButton>
                                    <BDropdown variant="link" class="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none" toggle-class=" arrow-none shadow-none" menu-class="dropdown-menu" aria-haspopup="true">
                        ...
                        <BRow class="align-items-center mt-3">
                            <BCol>
                                <ul class="nav nav-tabs nav-tabs-custom gap-1 text-center border-bottom-0" role="tablist" id="mailfilter">
                ...
                <div class="p-4 d-flex flex-column h-100">
                    <div class="pb-4 border-bottom border-bottom-dashed">
                        <BRow>
                            <BCol>
                                <div class="">
                                    <BButton type="button" variant="soft-danger" size="sm" class="btn-icon fs-16 close-btn-email" id="close-btn-email">
                            ...
                            <div class="col-auto">
                                <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                    <BButton type="button" variant="ghost-secondary" size="sm" class=" btn-icon fs-16 favourite-btn active shadow-none">
                            ...
                            <div>
                                ...
                                <div class="bg-light px-2 py-1 rouned-bottom border">
                                    <BRow>
                                        <BCol>
                                            <b-btn-group>
                                                <BButton type="button" variant="light" size="sm" class="py-0 fs-15 shadow-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Bold"><i class="ri-bold align-bottom"></i></BButton>
                                                <BButton type="button" variant="light" size="sm" class="py-0 fs-15 shadow-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Italic"><i class="ri-italic align-bottom"></i></BButton>
                                                <BButton type="button" variant="light" size="sm" class="py-0 fs-15 shadow-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Link"><i class="ri-link align-bottom"></i></BButton>
                                                <BButton type="button" variant="light" size="sm" class="py-0 fs-15 shadow-none" data-bs-toggle="tooltip" data-bs-placement="top" title="Image"><i class="ri-image-2-line align-bottom"></i></BButton>
                                            </b-btn-group>
                                        </BCol>
                                        <div class="col-auto">
                                            <b-btn-group class="btn-group">
                                                <BButton type="button" variant="success" size="sm" class="shadow-none"><i class="ri-send-plane-2-fill align-bottom"></i></BButton>
                                                <button type="button" class="btn btn-sm btn-success dropdown-toggle dropdown-toggle-split shadow-none" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <BCardHeader class="align-items-center d-flex bg-primary text-white-50">
                    ...
                    <div class="flex-shrink-0">
                        <div class="mt-n3 me-n3">
                            <BButton type="button" variant="link" class="text-white fs-16 shadow-none text-decoration-none" id="emailchat-btn-close"><i class="ri-close-fill"></i></BButton>
                        </div>
                    </div>
                </BCardHeader>
            ...
            <div>
                <div class="mb-3 position-relative">
                    ...
                    <div class="position-absolute top-0 end-0">
                        <div class="d-flex">
                            <button class="btn btn-link text-reset fw-semibold px-2" type="button" v-b-toggle.CcRecipientsCollapse>
                                Cc
                            </button>
                            <button class="btn btn-link text-reset fw-semibold px-2" type="button" v-b-toggle.BccRecipientsCollapse>
                                Bcc
                            </button>
                        </div>
                    </div>
