    ...
    <BRow class="mb-3">
      <BCol xl="8">
        <BRow class="align-items-center gy-3 mb-3">
          ...
          <BCol sm="auto">
            <Link href="/ecommerce/products" class="link-primary text-decoration-underline">Continue Shopping
            </Link>
          </BCol>
        </BRow>
            ...
            <BRow class="gy-3">
              ...
              <BCol sm>
                <h5 class="fs-14 text-truncate">
                  <Link href="/ecommerce/product-details" class="text-body">Sweatshirt for Men (Pink)</Link>
                </h5>
        ...
        <BCard no-body class="product">
          <BCardBody>
            <BRow class="gy-3">
              ...
              <BCol sm>
                <h5 class="fs-14 text-truncate">
                  <Link href="/ecommerce/product-details" class="text-body">Noise NoiseFit Endure Smart Watch
                  </Link>
                </h5>
        ...
        <div class="text-end mb-4">
          <Link href="/ecommerce/checkout" class="btn btn-success btn-label right ms-auto"><i
          ...
          <BAlert variant="danger" :model-value="true" class="border-dashed" role="alert" show>
            <div class="d-flex align-items-center">
              ...
              <div class="ms-2">
                ...
                <button type="button" class="btn ps-0 btn-sm btn-link text-danger text-uppercase shadow-none">
                  Add Gift Wrap
                </button>
              </div>
            </div>
