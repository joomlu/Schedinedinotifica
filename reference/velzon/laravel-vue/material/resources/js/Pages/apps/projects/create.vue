          ...
          <BCardBody>
            ...
            <div>
              ...
              <div class="avatar-group">
                <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Brent Gonzalez">
                  <div class="avatar-xs">
                    <img src="@assets/images/users/avatar-3.jpg" alt="" class="rounded-circle img-fluid" />
                  </div>
                </BLink>
                <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Sylvia Wright">
                  <div class="avatar-xs">
                ...
                <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Ellen Smith">
                  <div class="avatar-xs">
                    <img src="@assets/images/users/avatar-4.jpg" alt="" class="rounded-circle img-fluid" />
                  </div>
                </BLink>
                <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Add Members">
