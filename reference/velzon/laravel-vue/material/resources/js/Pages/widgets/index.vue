  ...
  <Layout>
        ...
        <BCard no-body class="card-animate bg-info">
          <BCardBody>
            ...
            <div class="d-flex align-items-end justify-content-between mt-4">
              ...
              <div class="avatar-sm flex-shrink-0">
                <span class="avatar-title bg-white bg-opacity-25 rounded fs-3 shadow">
        ...
        <BCard no-body class="card-animate">
          <BCardBody>
            <div class="d-flex justify-content-between">
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-info-subtle rounded-circle fs-2 shadow">
        ...
        <BCard no-body class="card-animate bg-primary">
          <BCardBody>
            <div class="d-flex justify-content-between">
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-white bg-opacity-25 rounded-circle fs-2 shadow">
      ...
      <BCol xl="3" md="6">
        <BCard no-body class="bg-success card-height-100">
          <BCardBody>
            <div class="d-flex align-items-center">
              <div class="avatar-sm flex-shrink-0">
                <span class="avatar-title bg-white bg-opacity-25 text-white rounded-2 fs-2 shadow">
      ...
      <BCol xl="3" md="6">
        <BCard no-body class="card-height-100">
          <BCardBody>
            <div class="d-flex align-items-center">
              <div class="avatar-sm flex-shrink-0">
                <span class="avatar-title bg-danger-subtle text-danger rounded-2 fs-2 shadow">
      ...
      <BCol xl="3" md="6">
        <BCard no-body class="card-height-100">
          <BCardBody>
            <div class="d-flex align-items-center">
              <div class="avatar-sm flex-shrink-0">
                <span class="avatar-title bg-info-subtle text-info rounded-2 fs-2 shadow">
    ...
    <BRow>
      <BCol xl="3" md="6">
        <BCard no-body class="card-height-100">
          <BCardBody>
            <BDropdown variant="link" right toggle-class="text-decoration-none arrow-none p-0 shadow-none" class="float-end" no-caret>
    ...
    <BRow>
      <BCol lg="4">
        <BCard no-body>
          ...
          <BProgress class="animated-progress rounded-bottom rounded-0 bg-primary-subtle" style="height: 6px">
      ...
      <BCol xxl="5">
        <BCard no-body class="card-height-100">
          <BCardHeader class="align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <BDropdown variant="link" right toggle-class="text-decoration-none arrow-none p-0 shadow-none" class="card-header-dropdown" no-caret>
                <template #button-content> <span class="text-muted fs-18"><i class="mdi mdi-dots-vertical"></i></span>
                </template>
          ...
          <BCardBody class="pt-0">
            <ul class="list-group list-group-flush border-dashed">
              ...
              <li class="list-group-item ps-0">
                <BRow class="align-items-center g-3">
                  <BCol cols="auto">
                    <div class="avatar-sm p-1 py-2 h-auto bg-light rounded-3 shadow shadow">
                      <div class="text-center">
                        <h5 class="mb-0">20</h5>
          ...
          <BCol xl="6">
            <BCard no-body class="card-height-100">
              <BCardHeader class="
                ...
                <div class="flex-shrink-0">
                  <BButton variant="soft-primary" size="sm" class="shadow-none">
                    View All Activity
                  </BButton>
                </div>
              </BCardHeader>
        ...
        <BCard no-body class="card-height-100">
          <BCardHeader class="border-0 align-items-center d-flex">
            ...
            <div class="hstack gap-1 justify-content-end">
              <BButton variant="soft-secondary" size="sm" class="shadow-none">
                ALL
              </BButton>
              <BButton variant="soft-secondary" size="sm" class="shadow-none">
                1M
        ...
        <BCard no-body class="card-height-100">
          ...
          <BCardBody>
            ...
            <div class="px-2 py-2 mt-1">
              ...
              <BProgress striped class="mt-2 bg-primary-subtle bg-primary-subtle" :value="75" variant="primary" style="height: 6px" />

              <p class="mt-3 mb-1">
                California <span class="float-end">47%</span>
              </p>

              <BProgress striped class="mt-2 bg-primary-subtle" :value="47" variant="primary" style="height: 6px" />

              <p class="mt-3 mb-1">Texas <span class="float-end">82%</span></p>

              <BProgress striped class="mt-2 bg-primary-subtle" :value="82" variant="primary" style="height: 6px" />
            </div>
          </BCardBody>
          ...
          <BCardBody>
            <div class="d-flex align-items-center mb-3">
              ...
              <div class="flex-grow-1">
                ...
                <h5 class="fs-15 mb-0 fw-semibold">Half Sleeve T-Shirts (Blue)</h5>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div class="d-flex flex-wrap gap-2 select-color">
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="Out of Stock">
                      <button type="button" class="btn avatar-xs p-0 d-flex align-items-center justify-content-center shadow-none border rounded-circle fs-22 text-primary" disabled>
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </button>
                    </div>
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="03 Items Available">
                      <button type="button" class="btn avatar-xs p-0 d-flex align-items-center justify-content-center shadow-none border rounded-circle fs-22 text-secondary">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </button>
                    </div>
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="03 Items Available">
                      <button type="button" class="btn avatar-xs p-0 d-flex align-items-center justify-content-center shadow-none border rounded-circle fs-22 text-success">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </button>
                    </div>
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="02 Items Available">
                      <button type="button" class="btn avatar-xs p-0 d-flex align-items-center justify-content-center shadow-none border rounded-circle fs-22 text-info">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </button>
                    </div>
                  </div>
            ...
            <BCol lg="6">
              <BCardBody class="text-center">
                ...
                <div class="d-flex gap-2 justify-content-center mb-3">
                  <button type="button" class="btn avatar-xs p-0 shadow-none" v-b-tooltip.hover title="Google">
                    <span class="avatar-title rounded-circle bg-light text-body">
                      <i class="ri-google-line"></i>
                    </span>
                  </button>

                  <button type="button" class="btn avatar-xs p-0 shadow-none" v-b-tooltip.hover title="Linkedin">
                    <span class="avatar-title rounded-circle bg-light text-body">
                      <i class="ri-linkedin-line"></i>
                    </span>
                  </button>
                  <button type="button" class="btn avatar-xs p-0 shadow-none" v-b-tooltip.hover title="Dribbble">
                    <span class="avatar-title rounded-circle bg-light text-body">
