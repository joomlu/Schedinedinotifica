          ...
          <BCol sm="auto" class="ms-auto">
            <div class="list-grid-nav hstack gap-1">
              <BButton type="button" id="grid-view-button"
                class="btn btn-soft-info nav-link btn-icon fs-14 active filter-button shadow-none"><i class="ri-grid-fill"></i>
              </BButton>
              <BButton type="button" id="list-view-button"
                class="btn btn-soft-info nav-link  btn-icon fs-14 filter-button shadow-none"><i class="ri-list-unordered"></i>
              </BButton>
              <BDropdown variant="soft-info" right toggle-class="arrow-none" class="btn-icon fs-14 shadow-none" no-caret>
