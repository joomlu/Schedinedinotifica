                            ...
                            <div class="content">
                                ...
                                <BRow class="g-2">
                                    <BCol sm="6">
                                        <div class="d-flex border border-dashed p-2 rounded position-relative">
                                            <div class="flex-shrink-0 avatar-xs">
                                                <div class="avatar-title bg-danger-subtle text-danger fs-15 rounded shadow">
                                    ...
                                    <BCol sm="6">
                                        <div class="d-flex border border-dashed p-2 rounded position-relative">
                                            <div class="flex-shrink-0 avatar-xs">
                                                <div class="avatar-title bg-info-subtle text-info fs-15 rounded shadow">
                        ...
                        <div class="timeline-item left">
                            ...
                            <div class="content">
                                ...
                                <div class="avatar-group mb-2">
                                    <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Christi">
                                        <img src="@assets/images/users/avatar-4.jpg" alt=""
                                            class="rounded-circle avatar-xs">
                                    </BLink>
                                    <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Frank Hook">
                                        <img src="@assets/images/users/avatar-3.jpg" alt=""
                                            class="rounded-circle avatar-xs">
                                    </BLink>
                                    <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="Ruby">
                                        <div class="avatar-xs">
                                    ...
                                    <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover title="more">
                                        <div class="avatar-xs">
                    ...
                    <div class="timeline-2">
                        ...
                        <div class="timeline-continue">
                                            ...
                                            <BRow class="border border-dashed rounded gx-2 p-2">
                                                <BCol cols="3">
                                                    <BLink href="javascript:void(0);"><img
                                                            ...
                                                            class="img-fluid rounded shadow"></BLink>
                                                </BCol>
                                                <BCol cols="3">
                                                    <BLink href="javascript:void(0);"><img
                            ...
                            <BRow class="timeline-right">
                                ...
                                <BCol cols="12">
                                    <div class="timeline-box">
                                        <div class="timeline-text shadow">
