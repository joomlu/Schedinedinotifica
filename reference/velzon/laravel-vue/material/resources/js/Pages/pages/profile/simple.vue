                      ...
                      <div>
                        <div class="d-flex align-items-center py-3">
                          ...
                          <div class="flex-shrink-0 ms-2">
                            <BButton type="button" variant="outline-success shadow-none" size="sm">
                  ...
                  <BCard no-body>
                    <BCardBody>
                      ...
                      <div class="d-flex mb-4">
                        <div class="flex-shrink-0">
                          <img src="@assets/images/small/img-4.jpg" alt="" height="50" class="rounded shadow" />
                        </div>
                      ...
                      <div class="d-flex mb-4">
                        <div class="flex-shrink-0">
                          <img src="@assets/images/small/img-5.jpg" alt="" height="50" class="rounded shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3 overflow-hidden">
                          <BLink href="javascript:void(0);">
                            <h6 class="text-truncate fs-14">
                      ...
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="@assets/images/small/img-6.jpg" alt="" height="50" class="rounded shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3 overflow-hidden">
                          <BLink href="javascript:void(0);">
                            <h6 class="text-truncate fs-14">
                                    ...
                                    <BCollapse id="collapseFive" visible>
                                      <div class="accordion-body ms-2 ps-5">
                                        ...
                                        <div class="avatar-group">
                                          <BLink href="javascript: void(0);" class="avatar-group-item shadow" v-b-tooltip.hover
                                            title="Christi">
                                  ...
                                  <div class="accordion-item border-0">
                                    ...
                                    <BCollapse id="collapse8" visible>
                                      <div class="accordion-body ms-2 ps-5 fst-italic">
                                        ...
                                        <BRow class="mt-2">
                                          <BCol xxl="6">
                                            <BRow class="border border-dashed gx-2 p-2 shadow">
                                              <BCol cols="3">
                        ...
                        <swiper :slides-per-view="3" :space-between="50">
                          <swiper-slide>
                            <div class="swiper-slide">
                              <BCard no-body class="profile-project-card profile-project-success mb-0">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                          ...
                          <swiper-slide>
                            <div class="swiper-slide">
                              <BCard no-body class="profile-project-card profile-project-danger mb-0">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                                    <div class="flex-grow-1 text-muted overflow-hidden">
                                      <h5 class="fs-14 text-truncate mb-1">
                          ...
                          <swiper-slide>
                            <div class="swiper-slide">
                              <BCard no-body class="profile-project-card profile-project-info mb-0">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                                    <div class="flex-grow-1 text-muted overflow-hidden">
                                      <h5 class="fs-14 text-truncate mb-1">
                          ...
                          <swiper-slide>
                            <div class="swiper-slide">
                              <BCard no-body class="profile-project-card profile-project-warning mb-0">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                                    <div class="flex-grow-1 text-muted overflow-hidden">
                                      <h5 class="fs-14 text-truncate mb-1">
            ...
            <BTab class="nav-item pt-4">
              ...
              <BCard no-body>
                <BCardBody>
                  <BRow>
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card profile-project-warning">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card profile-project-success">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card profile-project-info">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card profile-project-primary">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card shadow profile-project-danger">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card mb-xxl-0 profile-project-info">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card mb-xxl-0 profile-project-success">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card mb-sm-0 profile-project-danger">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card mb-0 profile-project-primary">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
