                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            <BButton variant="outline-primary" class="shadow-none" type="button"
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            ...
                                            <BButton variant="outline-success" class="shadow-none" type="button"
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <BInputGroup>
                                            <BButton variant="outline-primary shadow-none">Button</BButton>
                                            <BFormSelect id="inputGroupSelect03" v-model="selectedOption3" aria-label="Example select with button addon">
                                                <option value="">Choose...</option>
                                                <option value="1">One</option>
                                                <option value="2">Two</option>
                                                <option value="3">Three</option>
                                    ...
                                    <BCol lg="6">
                                        <BInputGroup>
                                            <BFormSelect id="inputGroupSelect04" v-model="selectedOption4" aria-label="Example select with button addon">
                                                <option value="">Choose...</option>
                                                <option value="1">One</option>
                                                <option value="2">Two</option>
                                                <option value="3">Three</option>
                                            </BFormSelect>
                                            <BButton variant="outline-secondary shadow-none">Button</BButton>
                                        </BInputGroup>
                                    </BCol>
                                </BRow>
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            <BButton variant="outline-primary" type="button"
                                                id="inputGroupFileAddon03">Button</BButton>
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            ...
                                            <BButton variant="outline-success" type="button"
                                                id="inputGroupFileAddon04">Button</BButton>
                                        </div>
                                    </BCol>
                                </BRow>
                            </div>
