                                ...
                                <ul class="nav nav-pills progress-bar-tab custom-nav" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link rounded-pill" id="pills-gen-info-tab" type="button"
                                            ...
                                            @click="toggleTab(1, 0);">1</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link rounded-pill" id="pills-info-desc-tab" type="button"
                                            role="tab" :class="{ active: activeTab == 2, done: activeTab > 2 }"
                                            @click="toggleTab(2, 50);">2</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link rounded-pill" id="pills-success-tab" type="button"
                                            role="tab" :class="{ active: activeTab == 3, done: activeTab > 3 }"
                                            @click="toggleTab(3, 100);">3</button>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="d-flex align-items-start gap-3 mt-4">
                                        ...
                                        <button type="button"
                                            ...
                                            @click="toggleTab(3, 100);"><i
                                                class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Submit</button>
                                    </div>
                                </div>
                        ...
                        <form action="#">
                            ...
                            <div class="step-arrow-nav mb-4">
                                ...
                                <ul class="nav nav-pills custom-nav nav-justified" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="steparrow-gen-info-tab" type="button"
                                            :class="{ active: activeTabArrow == 1, done: activeTabArrow > 1 }"
                                            @click="toggleTabArrow(1);">General</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="steparrow-description-info-tab" type="button"
                                            :class="{ active: activeTabArrow == 2, done: activeTabArrow > 2 }"
                                            @click="toggleTabArrow(2);">Description</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-experience-tab" type="button"
                                            :class="{ active: activeTabArrow == 3, done: activeTabArrow > 3 }"
                                            @click="toggleTabArrow(3);">Finish</button>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <BRow class="gy-5">
                                <BCol lg="3">
                                    <div class="nav flex-column custom-nav nav-pills" role="tablist"
                                        ...
                                        <button class="nav-link" id="v-pills-bill-info-tab" type="button" role="tab"
                                            :class="{ active: activeTabVerti == 1, done: activeTabVerti > 1 }"
                                        ...
                                        <button class="nav-link" id="v-pills-bill-address-tab" type="button" role="tab"
                                            :class="{ active: activeTabVerti == 2, done: activeTabVerti > 2 }"
                                        ...
                                        <button class="nav-link" id="v-pills-payment-tab" type="button" role="tab"
                                            :class="{ active: activeTabVerti == 3, done: activeTabVerti > 3 }"
                                        ...
                                        <button class="nav-link" id="v-pills-finish-tab" type="button" role="tab"
                                            :class="{ active: activeTabVerti == 4, done: activeTabVerti > 4 }"
