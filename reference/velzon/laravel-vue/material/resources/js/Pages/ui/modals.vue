                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="hstack gap-2 justify-content-center">
                                                <BLink href="javascript:void(0);"
                                                    class="btn btn-link shadow-none link-success fw-medium" @click="modalShow3 = false">
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            ...
                            <BModal v-model="modalShow4" hide-footer title="Tooltips and Popovers Modal"
                                ...
                                <div class="modal-footer v-modal-footer">
                                    <div class="mx-auto">
                                        <BLink href="javascript:void(0);" class="btn btn-link fw-medium shadow-none">
                                            Read More
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BModal v-model="modalShow7" hide-footer title="Fullscreen Modal Heading"
                                    ...
                                    <div class="modal-footer v-modal-footer">
                                        <BLink href="javascript:void(0);" class="btn btn-link link-success shadow-none fw-medium"
                                ...
                                <BModal v-model="modalShow8" hide-footer title="Extra large Modal" class="v-modal-custom"
                                    ...
                                    <div class="modal-footer v-modal-footer">
                                        <BLink href="javascript:void(0);" class="btn btn-link shadow-none link-success fw-medium"
                                ...
                                <BModal v-model="modalShow9" hide-footer title="Large Modal" class="v-modal-custom"
                                    ...
                                    <div class="modal-footer v-modal-footer">
                                        <BLink href="javascript:void(0);" class="btn btn-link link-success fw-medium shadow-none"
