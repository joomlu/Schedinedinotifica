                        ...
                        <div class="live-preview">
                            <div>
                                <div>
                                    <div class="d-flex align-items-start flex-wrap gap-4">
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg" class="avatar-md rounded shadow"
                                                alt="rounded" />
                                            <p>
                                                <code>.rounded</code>
                                            </p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg" class="avatar-md rounded-top shadow"
                                                alt="rounded-top" />
                                            <p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg" class="avatar-md rounded-end shadow"
                                                alt="rounded-end" />
                                            <p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg"
                                                class="avatar-md rounded-bottom" alt="rounded-bottom shadow" />
                                            <p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg"
                                                class="avatar-md rounded-start" alt="rounded-start shadow" />
                                            <p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg"
                                                class="avatar-md rounded-circle" alt="rounded-circle shadow" />
                                            <p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/small/img-2.jpg"
                                                class="avatar-md w-auto rounded-pill" alt="rounded-pill shadow" />
                                            <p>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-start flex-wrap gap-4">
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-0 shadow"
                                                alt="rounded-0" />
                                            <p>
                                                <code>.rounded-0</code>
                                            </p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-1 shadow"
                                                alt="rounded-1" />
                                            <p>
                                                <code>.rounded-1</code>
                                            </p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-2 shadow"
                                                alt="rounded-2" />
                                            <p>
                                                <code>.rounded-2</code>
                                            </p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-3 shadow"
                                                alt="rounded-3" />
                                            <p>
                                                <code>.rounded-3</code>
                                            </p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-4 shadow"
                                                alt="rounded-4">
                                            <p><code>.rounded-4</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-5 shadow"
                                                alt="rounded-5">
                        ...
                        <div class="live-preview">
                            ...
                            <div class="mt-5">
                                ...
                                <BCol md="5" class="vstack gap-2 mx-auto">
                                    ...
                                    <BButton variant="outline-secondary" class="shadow-none">Cancel</BButton>
                                </BCol>
                            </div>
                        </div>
                        ...
                        <div class="live-preview">
                            ...
                            <div class="mt-5">
                                ...
                                <div class="hstack gap-3">
                                    ...
                                    <div class="vr"></div>
                                    <BButton variant="outline-secondary" class="shadow-none">Reset</BButton>
                                </div>
                            </div>
                        </div>
