...
<template>
    <Layout>
        <PageHeader title="Typography" pageTitle="Base UI" />
        <BRow>
            <BCol xxl="6">
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle class="mb-0">Font Family</BCardTitle>
                    </BCardHeader>
...
<code>&lt;h6 class=&quot;mb-1&quot;&gt;h6. Bootstrap heading &lt;small class=&quot;text-muted&quot;&gt;Semibold 0.8125rem (13px)&lt;/small&gt;&lt;/h6&gt;</code></pre>
            ...
            <BCol xxl="6">
                <BCard no-body>
                    <CardHeader title="Display Headings" />
...
&lt;/blockquote&gt;</code></pre>
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <CardHeader title="Blockquote Background Color" />
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            <BRow class="gy-4">
                                <BCol xl="4" md="6">
                                    <blockquote class="blockquote custom-blockquote blockquote-primary rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote class="blockquote custom-blockquote blockquote-secondary rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote class="blockquote custom-blockquote blockquote-success rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote class="blockquote custom-blockquote blockquote-info rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote class="blockquote custom-blockquote blockquote-danger rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote class="blockquote custom-blockquote blockquote-warning rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote class="blockquote custom-blockquote blockquote-dark rounded mb-0 shadow">
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            <BRow class="gy-4">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote
                                        class="blockquote custom-blockquote blockquote-outline blockquote-secondary rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote
                                        class="blockquote custom-blockquote blockquote-outline blockquote-success rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote
                                        class="blockquote custom-blockquote blockquote-outline blockquote-info rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote
                                        class="blockquote custom-blockquote blockquote-outline blockquote-danger rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote
                                        class="blockquote custom-blockquote blockquote-outline blockquote-warning rounded mb-0 shadow">
                                ...
                                <BCol xl="4" md="6">
                                    <blockquote
                                        class="blockquote custom-blockquote blockquote-outline blockquote-dark rounded mb-0 shadow">
...
<code>&lt;p&gt;&lt;em&gt;This line rendered as italicized text.&lt;/em&gt;&lt;/p&gt;</code></pre>
            ...
            <BCol xxl="6">
                <BCard no-body>
                    <CardHeader title="Unstyled List" />
...
&lt;/ul&gt;</code></pre>
        ...
        <BRow>
            <BCol xl="12">
                <BCard no-body>
                    <CardHeader title="Description List Alignment" />
...
&lt;/dl&gt;</code></pre>
        ...
        <BRow>
            <BCol xxl="6">
                <BCard no-body>
                    <CardHeader title="Text Wrapping and Overflow" />
                    ...
                    <BCardBody>
                        <div class="live-preview">
                            <div>
                                ...
                                <BBadge variant="primary" class="text-wrap" style="width: 6rem;">This text should wrap.
                                </BBadge>
                            </div>
                            <div class="mt-4">
                                <p class="text-muted">
...
<code>&lt;p class=&quot;fs-6&quot;&gt;.fs-6 text&lt;/p&gt;</code></pre>
        ...
        <BRow>
            <BCol xxl="6">
                <BCard no-body>
                    <CardHeader title="Font weight and italics" />
...
<code>&lt;p class=&quot;lh-lg mb-0&quot;&gt;This is a long paragraph written to show how the line-height of an element is affected by our utilities. Classes are applied to the element itself or sometimes the parent element.&lt;/p&gt;</code></pre>
        ...
        <BRow>
            <BCol xxl="6">
                <BCard no-body>
                    <CardHeader title="Text Transform" />
...
<code>&lt;p class=&quot;text-capitalize mb-0&quot;&gt;CapiTaliZed text.&lt;/p&gt;</code></pre>
            ...
            <BCol xxl="6">
                <BCard no-body>
                    <CardHeader title="Text Decoration" />
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            ...
                            <BLink href="#" class="text-decoration-none">This link has its text decoration removed</BLink>
                        </div>
...
<code>&lt;a href=&quot;#&quot; class=&quot;text-decoration-none&quot;&gt;This link has its text decoration removed&lt;/a&gt;</code></pre>
        ...
        <BRow>
            <BCol xxl="6">
                <BCard no-body>
                    <CardHeader title="Text Truncation" />
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            <BRow>
                                <BCol cols="2" class="text-truncate">This text is quite long, and will be truncated once
                                    displayed.</BCol>
                            </BRow>
