    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
      <BRow class="g-4">
        ...
        <BCol>
          <div class="p-2">
            ...
            <div class="hstack text-muted gap-1">
              <div class="me-2">
                <i class="ri-map-pin-user-line me-1 fs-16 align-bottom text-body"></i>California, United
                States
              </div>
              <div>
        ...
        <BCol cols="12" lg="auto" order-lg="0" class="order-last">
          <BRow class="text text-center">
            <BCol lg="6" cols="4">
              <div class="p-2">
                <h4 class=" mb-1">24.3K</h4>
                <p class="fs-14 mb-0 text-muted">Followers</p>
              </div>
            </BCol>
            <BCol lg="6" cols="4">
              <div class="p-2">
                <h4 class="mb-1">1.3K</h4>
                <p class="fs-14 mb-0 text-muted">Following</p>
              </div>
            </BCol>
          </BRow>
        </BCol>
