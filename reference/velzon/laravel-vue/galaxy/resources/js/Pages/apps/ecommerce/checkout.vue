                ...
                <BTabs nav-class="nav-pills nav-justified custom-nav">
                    ...
                    <div class="mt-4">
                      <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="flex-shrink-0">
                          <BButton type="button" variant="primary" size="sm" class="mb-3">
                            Add Address
                          </BButton>
                        </div>
                      </div>
                      <BRow class="gy-3">
                        <BCol lg="4" sm="6">
                          ...
                          ">
                            <div>
                              <BLink href="#" class="d-block text-body p-1 px-2">
                        ...
                        <BCol lg="4" sm="6">
                          <div class="form-check card-radio">
                            ...
                            <label class="form-check-label bg-transparent" for="shippingAddress02">
                              <span class="
                                mb-4
                                fw-semibold
                                d-block
                  ...
                  <BTab class="nav-item nav-link fs-15 p-3">
                    ...
                    <div class="collapse show" id="paymentmethodCollapse">
                      <BCard no-body class="p-4 border shadow-none mb-0 mt-4">
                        <BRow class="gy-3">
                          <BCol md="12">
                  ...
                  <BTab class="nav-item nav-link fs-15 p-3">
                    ...
                    <div class="text-center py-5">
                      <div class="mb-4">
                        <lottie colors="primary:#8c68cd,secondary:#4788ff" :options="defaultOptions" :height="120"
                          :width="120" />
                      </div>
                      ...
                      <h3 class="fw-semibold">
                        Order ID:
                        <Link href="/ecommerce/order-details" class="text-decoration-underline">VZ2451</Link>
                      </h3>
                    </div>
                  </BTab>
                </BTabs>
              ...
              <table class="table table-borderless align-middle mb-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <h5 class="fs-14">
                        <Link href="/ecommerce/product-details" class="text-body">Sweatshirt for Men (Pink)
                        </Link>
                      </h5>
                  ...
                  <tr>
                    ...
                    <td>
                      <h5 class="fs-14">
                        <Link href="/ecommerce/product-details" class="text-body">Noise Evolve Smartwatch
                        </Link>
                      </h5>
                  ...
                  <tr>
                    ...
                    <td>
                      <h5 class="fs-14">
                        <Link href="/ecommerce/product-details" class="text-body">350 ml Glass Grocery Container
                        </Link>
                      </h5>
