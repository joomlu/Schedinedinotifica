    ...
    <Layout>
        ...
        <div class="tasks-board mb-3" id="kanbanboard">
            <div class="tasks-list">
                ...
                <div class="my-3">
                    <BButton variant="soft-primary" class="w-100" @click="modalShow2 = !modalShow2">Add More</BButton>
                </div>
            </div>
            <div class="tasks-list">
                <div class="d-flex mb-3">
        ...
        <BModal v-model="modalShow1" header-class="p-3 bg-primary-subtle" content-class="border-0" hide-footer
