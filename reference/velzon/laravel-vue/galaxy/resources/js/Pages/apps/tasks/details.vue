...
<template>
    <Layout>
            ...
            <BCol xxl="3">
                <BCard no-body>
                    <BCardBody class="text-center">
                        ...
                        <div class="mb-2">
                            <lottie colors="primary:#8c68cd,secondary:#4788ff" :options="defaultOptions" :height="90"
                                :width="90" />
                        </div>
                        ...
                        <div class="text-muted">
                            ...
                            <div class="pt-3 border-top border-top-dashed mt-4">
                                ...
                                <div class="hstack flex-wrap gap-2 fs-15">
                                    <BBadge variant="primary-subtle" tag="div" class="fw-medium bg-primary-subtle text-primary">UI/UX
                                    </BBadge>
                                    <BBadge variant="primary-subtle" tag="div" class="fw-medium bg-primary-subtle text-primary">
                                        Dashboard</BBadge>
                                    <BBadge variant="primary-subtle" tag="div" class="fw-medium bg-primary-subtle text-primary">
                                        Design</BBadge>
                                </div>
                                ...
                                <form class="mt-4">
                                    <BRow class="g-3">
                                        ...
                                        <BCol cols="12" class="text-end">
                                            <BButton type="button" variant="ghost-primary" class="btn-icon me-1"><i
        ...
        <BModal v-model="modalShow" hide-footer title="Team Members" body-class="p-4" content-class="border-0"
            header-class="p-3 ps-4 bg-primary-subtle" class="v-modal-custom" centered>
