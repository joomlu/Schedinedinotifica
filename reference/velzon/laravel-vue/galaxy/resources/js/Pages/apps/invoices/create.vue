            ...
            <BCardBody class="p-4">
              <div class="table-responsive">
                <table class="invoice-table table table-borderless table-nowrap mb-0">
                  ...
                  <tbody id="newlink">
                    ...
                    <tr v-for="n in count" :key="n" :id="n" class="product">
                      ...
                      <td class="product-removal">
                        <BLink href="javascript:void(0)" class="btn btn-danger">Delete</BLink>
                      </td>
                    </tr>
                  ...
                  <tr>
                    <td colspan="9">
                      <BLink @click="new_link" class="btn btn-soft-primary fw-medium"><i
              ...
              <div class="mt-4">
                ...
                <textarea class="form-control alert alert-primary" id="exampleFormControlTextarea1" placeholder="Notes"
                  rows="2"
              ...
              <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                <BButton type="button" variant="soft-primary" @click="createinvoice">
