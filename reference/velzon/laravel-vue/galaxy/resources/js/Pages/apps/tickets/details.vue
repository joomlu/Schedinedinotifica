...
<template>
    <Layout>
        <BRow>
            <BCol lg="12">
                <BCard no-body class="mt-n4 mx-n4 card-border-effect-none mb-n5 border-bottom-0 border-start-0 rounded-0">
                    <div>
                    ...
                    <BCardBody class="p-4">
                        ...
                        <p class="text-muted">It would also help to know what the errors are - it could be something
                            ...
                            pleasing to look at. <BLink href="javascript:void(0);"
                                class="link-primary text-decoration-underline">Example</BLink>
                        </p>
