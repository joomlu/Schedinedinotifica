  ...
  <Layout>
            ...
            <div class="d-flex justify-content-between">
              <div>
                ...
                <p class="mb-0 text-muted">
                  <BBadge class="bg-success-subtle text-success mb-0">
          ...
          <BCardBody>
            <div class="d-flex justify-content-between">
              <div>
                ...
                <p class="mb-0 text-muted">
                  <BBadge class="bg-danger-subtle text-danger mb-0">
              ...
              <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                ...
                <tbody class="list form-check-all">
                  <tr v-for="(data, index) of resultQuery" :key="index">
                    ...
                    <td class="id">
                      <Link href="/apps/tickets-details" class="fw-medium link-primary">{{ data.id }}</Link>
                    </td>
                    <td class="tasks_name">
                      {{ data.title }}
                    </td>
                    ...
                    <td>
                      <BDropdown toggle-class="btn btn-soft-primary btn-sm arrow-none" size="sm" variant="primary"
                        no-caret>
                        <template #button-content> <i class="ri-more-fill align-middle"></i> </template>
                        <BDropdownItem href="/apps/tickets-details"><i
    ...
    <BModal v-model="deleteModal" modal-class="zoomIn" hide-footer no-close-on-backdrop centered>
      <div class="mt-2 text-center">
        <lottie class="avatar-xl" colors="primary:#8c68cd,secondary:#f06548" :options="defaultOptions1" :height="75"
          :width="75" />
