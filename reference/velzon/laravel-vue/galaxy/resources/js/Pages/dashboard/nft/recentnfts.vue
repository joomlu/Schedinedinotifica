                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <Link href="/apps/nft-item-detail">Abstract Face
                                                Painting</Link>
                                        </h6>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <Link href="/apps/nft-item-detail">Robotic Body
                                                Art</Link>
                                        </h6>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <Link href="/apps/nft-item-detail">Smillevers
                                                Crypto</Link>
                                        </h6>
                                        <p class="text-muted mb-0">Artworks</p>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <Link href="/apps/nft-item-detail">Creative
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <Link href="/apps/nft-item-detail">The
                                                Chirstoper</Link>
                                        </h6>
