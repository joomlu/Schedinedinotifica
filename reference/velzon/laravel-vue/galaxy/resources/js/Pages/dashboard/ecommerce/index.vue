...
<template>
  <Layout>
    <PageHeader title="Ecommerce" pageTitle="Dashboard" />
    <BRow>
      <BCol>
        <div class="h-100">
                ...
                <div class="mt-3 mt-lg-0">
                  <form action="javascript:void(0);">
                    <BRow class="g-3 mb-0 align-items-center">
                      <BCol sm="auto">
                        <div class="input-group">
                          <flat-pickr v-model="date" :config="config"
                            class="form-control dash-filter-picker shadow"></flat-pickr>
                      ...
                      <div class="col-auto">
                        <BButton type="button" variant="soft-primary" class="btn-icon waves-effect layout-rightside-btn"
                          @click="rightcolumn">
      ...
      <div class="col-auto layout-rightside-col d-block">
        ...
        <div class="layout-rightside">
          <BCard no-body class="h-100 rounded-0 card-border-effect-none">
            <BCardBody class="p-0">
              <div class="p-3">
