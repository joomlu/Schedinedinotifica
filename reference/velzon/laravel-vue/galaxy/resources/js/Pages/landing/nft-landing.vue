...
<template>
    <div class="layout-wrapper landing">
                    ...
                    <BCol lg="8" sm="10">
                        <div class="text-center">
                            <h1 class="display-4 fw-medium mb-4 lh-base text-white">Discover Digital Art & Collect
                                <span class="text-primary">NFT Marketplace</span>
                            </h1>
                    ...
                    <BCol lg="4">
                        <BCard no-body class="text-center border shadow-none">
                            <BCardBody class="py-5 px-4">
                                ...
                                <BLink href="#!" class="btn btn-primary">Change Wallet</BLink>
                            </BCardBody>
                        </BCard>
                    </BCol>
                        ...
                        <div class="b-card no-body shadow-none">
                            <BCardBody>
                                ...
                                <p class="text-muted fs-14">You have to choose whether to use a hot wallet a cold
                                    wallet.</p>
                                <BLink href="#!" class="link-primary fs-14">Read More <i
                ...
                <BRow class="align-items-center gy-4">
                    ...
                    <BCol sm="auto">
                        <div>
                            ...
                            <Link href="/apps/nft-explore" class="btn bg-gradient btn-primary">Discover More
                            </Link>
                        </div>
                    </BCol>
        ...
        <BButton variant="primary" @click="topFunction" class="btn-icon landing-back-top" id="back-to-top">
