...
<template>
    <div class="layout-wrapper landing">
        ...
        <section class="section job-hero-section bg-light pb-0" id="hero">
            <BContainer>
                <BRow class="justify-content-between align-items-center">
                    <BCol lg="6">
                        <div>
                            <h1 class="display-6 fw-medium text-capitalize mb-3 lh-base">Find your next job and build
                                your dream here</h1>
                    ...
                    <BCol lg="4">
                        <div class="position-relative home-img text-center mt-5 mt-lg-0">
                            <BCard no-body class="card-bg-fill p-3 rounded shadow-lg inquiry-box">
                            ...
                            <BCard no-body class="card-bg-fill p-3 rounded shadow-lg application-box">
                    ...
                    <BCol lg="3" md="6">
                        <BCard no-body class="shadow-lg">
                            <BCardBody class="p-4">
                                ...
                                <h6 class="fs-18 mb-2">Register Account</h6>
                                <p class="text-muted mb-0 fs-17">First, You need to make a account.</p>
                            </BCardBody>
                        </BCard>
                    </BCol>
                    <BCol lg="3" md="6">
                        <BCard no-body class="shadow-none card-border-effect-none border-0">
                            <BCardBody class="p-4">
                                <h1 class="fw-bold display-5 ff-secondary mb-4 text-success position-relative">
                                    <div class="job-icon-effect"></div>
                                    <span>2</span>
                                </h1>
                                <h6 class="fs-18 mb-2">Create Resume</h6>
                                <p class="text-muted mb-0 fs-17">Create a resume for your job.</p>
                            </BCardBody>
                        </BCard>
                    </BCol>
                    <BCol lg="3" md="6">
                    ...
                    <BCol lg="3" md="6">
                        <BCard no-body class="shadow-none card-border-effect-none border-0">
                            <BCardBody class="p-4">
                                ...
                                <h6 class="fs-18 mb-2">Apply Job</h6>
                                <p class="text-muted mb-0 fs-17">Apply to the company and wait for interview.</p>
                            </BCardBody>
                        </BCard>
                    </BCol>
                </BRow>
                ...
                <BRow class="align-items-center justify-content-lg-between justify-content-center gy-4">
                    <BCol lg="5" sm="7">
                        <div class="about-img-section mb-5 mb-lg-0 text-center">
                            <BCard no-body class=" card-bg-fill rounded shadow-lg inquiry-box d-none d-lg-block">
                            ...
                            <BCard no-body class="feedback-box card-bg-fill">
                ...
                <BRow class="align-items-center gy-4">
                    ...
                    <BCol lg="4" sm="7" cols="10" order="1" order-lg="2" class="ms-lg-auto mx-auto">
                        <div>
                            ...
                            <BCard no-body class="shadow-lg bg-info mb-0 features-company-widgets rounded-3 card-bg-fill">
                                <BCardBody>
                                    ...
                                    <div class="d-flex gap-1">
                                        ...
                                        <BLink href="#" v-b-tooltip.hover title="More Companies">
                                            <div class="avatar-xs">
                                                <div
                                                    class="avatar-title fs-11 rounded-circle bg-light text-white">
                                                    1k+
                                                </div>
                                            </div>
                                        </BLink>
        ...
        <BButton variant="secondary" @click="topFunction" class="btn-icon landing-back-top" id="back-to-top">
