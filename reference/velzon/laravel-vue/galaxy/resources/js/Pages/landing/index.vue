                    ...
                    <BCol lg="8" sm="10">
                        <div class="text-center mt-lg-5 pt-5">
                            <h1 class="display-6 fw-semibold mb-3 lh-base">The better way to manage your website with
                                <span class="text-primary">Velzon </span>
                            </h1>
                            ...
                            <div class="d-flex gap-2 justify-content-center mt-4">
                                ...
                                <Link href="/pages/pricing" class="btn btn-soft-primary">View Plans <i
                        ...
                        <BCard no-body class="plan-box mb-0">
                            <BCardBody class="p-4 m-2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-4">
                                        <Link href="javascript:void(0);" class="btn btn-soft-primary w-100">Get
                                            Started</Link>
                                    </div>
                                </div>
                            </BCardBody>
                        ...
                        <div class="text-center mb-5">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                <BButton type="button" pill variant="primary" class="btn-label"><i
                                    ...
                                    Us</BButton>
                                <BButton type="button" pill variant="soft-secondary" class="btn-label"><i
