...
<template>
    <Layout>
        <PageHeader title="Marketplace" pageTitle="NFT Marketplace" />
        <BRow>
            <BCol xl="8">
                <BRow>
                    <BCol lg="4" md="6">
            ...
            <BCol xl="4">
                <BAlert variant="danger" :model-value="true" show>
                ...
                <BCard no-body class="bg-primary pattern">
                    <BCardBody class="p-4">
                        ...
                        <div class="hstack gap-2">
                            <Link href="/apps/nft-create" class="btn btn-success">Create NFT</Link>
                            <Link href="/apps/nft-explore" class="btn btn-danger">Explore Now</Link>
                        </div>
                    </BCardBody>
                </BCard>
            </BCol>
            ...
            <BCol lg="12">
                <div class="d-lg-flex align-items-center mb-4">
                    ...
                    <div class="flex-shrink-0 mt-4 mt-lg-0">
                        <Link href="/apps/nft-explore" class="btn btn-soft-secondary">View All <i
        ...
        <BRow class="row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
            <BCol>
                <BCard no-body class="explore-box">
                    <BCardBody>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0">
                                <Link href="/apps/nft-item-detail" class="text-reset">Patterns arts & culture</Link>
                            </h6>
                        </div>
                    </BCardBody>
                </BCard>
                ...
                <BCard no-body class="explore-box">
                    <BCardBody>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0">
                                <Link href="/apps/nft-item-detail" class="text-reset">Evolved Reality</Link>
                            </h6>
                        </div>
                    </BCardBody>
                </BCard>
                ...
                <BCard no-body class="explore-box">
                    <BCardBody>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0">
                                <Link href="/apps/nft-item-detail" class="text-body">Creative filtered portrait</Link>
                            </h6>
                        </div>
                    </BCardBody>
                </BCard>
        ...
        <BRow>
            <BCol lg="12">
                <div class="d-lg-flex align-items-center mb-4">
                    ...
                    <div class="flex-shrink-0 mt-4 mt-lg-0">
                        <Link href="/apps/nft-creators" class="btn btn-soft-secondary">View All <i
                                class="ri-arrow-right-line align-bottom"></i></Link>
                    </div>
                </div>
            </BCol>
            ...
            <BCol>
                <BCard no-body class="explore-box card-animate">
                    ...
                    <BCardBody>
                        ...
                        <h5 class="mb-1 fs-16">
                            <Link href="/apps/nft-item-detail" class="text-body">Trendy Fashion Portraits</Link>
                        </h5>
                ...
                <BCard no-body class="explore-box card-animate">
                    ...
                    <BCardBody>
                        <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                            34.12k </p>
                        <h5 class="mb-1 fs-16">
                            <Link href="/apps/nft-item-detail" class="text-body">Smillevers Crypto</Link>
                        </h5>
                ...
                <BCard no-body>
                    ...
                    <BCardBody class="text-center">
                        ...
                        <h5 class="mt-3 mb-1 fs-16">
                            <Link href="#!" class="text-body">Tonya Noble</Link>
                        </h5>
                        <p class="text-muted">5048 Products</p>
                        <div>
                            <BButton variant="primary" size="sm">Follow</BButton>
                        </div>
                    </BCardBody>
                </BCard>
            </BCol>
                ...
                <BCard no-body>
                    ...
                    <BCardBody class="text-center">
                        <img src="@assets/images/nft/img-04.jpg" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                        <h5 class="mt-3 mb-1 fs-16">
                            <Link href="#!" class="text-body">Kevin Dawson</Link>
                        </h5>
                        <p class="text-muted">649 Products</p>
                        <div>
                            <BButton variant="soft-primary" size="sm">Unfollow</BButton>
                        </div>
                    </BCardBody>
                </BCard>
            </BCol>
                ...
                <BCard no-body>
                    ...
                    <BCardBody class="text-center">
                        <img src="@assets/images/nft/img-06.jpg" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                        <h5 class="mt-3 mb-1 fs-16">
                            <Link href="#!" class="text-body">Herbert Stokes</Link>
                        </h5>
                ...
                <BCard no-body>
                    ...
                    <BCardBody class="text-center">
                        <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                        <h5 class="mt-3 mb-1 fs-16">
                            <Link href="#!" class="text-body">Thomas Taylor</Link>
                        </h5>
                ...
                <BCard no-body>
                    ...
                    <BCardBody class="text-center">
                        <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                        <h5 class="mt-3 mb-1 fs-16">
                            <Link href="#!" class="text-body">James Price</Link>
                        </h5>
...
<style scoped>
.pattern{
    background-image: url('./../../../../images/nft/bg-pattern.png');
}
</style>
