    ...
    <div class="layout-wrapper landing">
                    ...
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#marketplace"
                                @click.prevent="scrollToSection('marketplace')">Marketplace</a>
                        </li>
                        <li class="nav-item">
        ...
        <section class="section" id="wallet">
            <BContainer>
                ...
                <BRow class="g-4">
                    <BCol lg="4">
                        <BCard no-body class="text-center border shadow-none material-shadow">
                    ...
                    <BCol lg="8">
                        <div class="text-center mb-5">
                            ...
                            <ul class="nav nav-pills filter-btns justify-content-center" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <BButton variant="link" class="nav-link fw-medium" data-filter="artwork">Artwork
                                    </BButton>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <BButton variant="link" class="nav-link fw-medium" data-filter="music">Music</BButton>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <BButton variant="link" class="nav-link fw-medium" data-filter="games">Games</BButton>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <BButton variant="link" class="nav-link fw-medium" data-filter="crypto-card">Crypto
                                        Card</BButton>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <BButton variant="link" class="nav-link fw-medium" data-filter="3d-style">3d
                                        Style</BButton>
                                </li>
                            </ul>
                        </div>
                        ...
                        <BCard no-body>
                            <BCardBody>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <BDropdown variant="ghost-primary" right toggle-class="btn-icon" class="float-end"
                                            no-caret>
