...
<template>
    <BCard no-body>
        <BCardHeader class="d-flex align-items-center">
            ...
            <Link href="/apps/nft-collection" type="button"
    ...
    <BCard no-body>
        <BCardHeader class="d-flex align-items-center">
            ...
            <Link href="/apps/nft-creators" type="button"
                class="btn btn-soft-primary btn-sm flex-shrink-0 material-shadow-none">
                See All <i class="ri-arrow-right-line align-bottom"></i>
            </Link>
        </BCardHeader>
                            ...
                            <div class="d-flex">
                                ...
                                <div>
                                    <div class="dropdown float-end">
                                        <BButton variant="ghost-primary" class="btn-icon dropdown" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <Link class="dropdown-item"
                                                    href="javascript:void(0);">View</Link>
                                            </li>
                                            <li>
                                                <Link class="dropdown-item"
                                                    href="javascript:void(0);">Share</Link>
                                            </li>
                                            <li>
