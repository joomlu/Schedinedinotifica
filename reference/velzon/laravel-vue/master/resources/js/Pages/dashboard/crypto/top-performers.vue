  ...
  <BCard no-body class="card-height-100">
    <BCardHeader class="align-items-center d-flex">
      ...
      <div class="hstack gap-1">
        <BButton type="button" variant="soft-info" class="material-shadow-none" size="sm">1D</BButton>
        <BButton type="button" variant="soft-info" class="material-shadow-none" size="sm">7D</BButton>
        <BButton type="button" variant="soft-info" class="material-shadow-none" size="sm">1H</BButton>
        <BButton type="button" variant="soft-primary" class="material-shadow-none" size="sm">1M</BButton>
      </div>
    </BCardHeader>
    <BCardBody class="p-0">
      <ul class="list-group list-group-flush border-dashed mb-0">
        <li class="list-group-item d-flex align-items-center" v-for="(item, index) of topPerformers" :key="index">
          <div class="flex-shrink-0">
            <img :src="`${item.img}`" class="avatar-xs material-shadow" alt="" />
          </div>
