...
import { columnDatalabelChart, gradientDonutChart } from "./data";
...
<template>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <apexchart class="apex-charts" type="bar" height="275" dir="ltr" :series="columnDatalabelChart.series"
    ...
    <div class="col-xl-3">
        <div class="card">
            ...
            <div class="card-body">
                <simpleBar data-simplebar class="mx-n3 px-3" style="height: 375px;">
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <apexchart class="apex-charts" type="donut" height="210" dir="ltr" :series="gradientDonutChart.series"
