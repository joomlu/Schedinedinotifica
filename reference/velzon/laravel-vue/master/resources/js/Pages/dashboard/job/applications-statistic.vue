            ...
            setTimeout(() => {
                switch (this.layoutTheme) {
                    ...
                    case "creative":
                        this.chartOptions = {
                            ...this.chartOptions,
                            colors: getChartColorsArray('["--vz-info", "--vz-secondary", "--vz-success"]')
                        };
                        break;
                    case "minimal":
                        this.chartOptions = {
                    ...
                    case "interactive":
                        this.chartOptions = {
                            ...this.chartOptions,
                            colors: getChartColorsArray('["--vz-secondary", "--vz-info", "--vz-primary"]')
                        };
                        break;
                    case "classic":
                        this.chartOptions = {
                ...
                <BCardHeader>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <Link href="/jobs/candidate-lists" class="link-primary">View All <i
                    ...
                    <BCol col lg="6">
                        <BCardBody class="text-center">
                            ...
                            <div class="d-flex gap-2 justify-content-center mb-3">
                                <BButton variant="link" class="btn avatar-xs p-0 material-shadow-none"
