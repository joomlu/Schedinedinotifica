              ...
              <div class="d-flex">
                ...
                <div class="flex-shrink-0">
                  <div class="d-flex gap-1 align-items-center">
                    <BButton type="button" variant="transparent" class="btn avatar-xs mt-n1 p-0 favourite-btn material-shadow-none"
                    ...
                    <BDropdown variant="link"
                      toggle-class="btn btn-link text-muted p-1 mt-n2 py-0 text-decoration-none fs-15 material-shadow-none" no-caret
              ...
              <div class="flex-grow-1">
                <div class="avatar-group">
                  <BLink href="javascript: void(0);" v-for="( subitem, index ) of  item.subItem " :key="index"
                    class="avatar-group-item material-shadow-none" v-b-tooltip.hover title="Darline Williams">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                  <div class="d-flex gap-1 align-items-center my-n2">
                    ...
                    <BDropdown variant="link"
                      toggle-class="btn btn-link text-muted p-1 mt-n2 py-0 text-decoration-none fs-15" no-caret
                      menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                      <template #button-content>
                        <MoreHorizontalIcon class="icon-sm"></MoreHorizontalIcon>
                      </template>
