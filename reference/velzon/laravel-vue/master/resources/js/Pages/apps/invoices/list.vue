  ...
  <Layout>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <div class="d-flex gap-2 flex-wrap">
                  ...
                  <Link href="/invoices/create" class="btn btn-danger"><i class="ri-add-line align-bottom me-1"></i>
                    Create Invoice</Link>
                </div>
              </div>
            </div>
              ...
              <BRow class="g-3">
                <BCol xxl="5" sm="12">
                  <div class="search-box">
                    <input type="text" class="form-control search bg-light border-light" v-model="searchQuery" placeholder="Search for customer, email, country, status or something...">
                    <i class="ri-search-line search-icon"></i>
                  </div>
                </BCol>
                <BCol xxl="3" sm="4">

                  <flat-pickr v-model="date" :config="config" class="form-control bg-light border-light" placeholder="Select date"></flat-pickr>
                </BCol>
                <BCol xxl="3" sm="4">
                  <div class="input-light">

                    <Multiselect class="form-control" v-model="status1" :close-on-select="true" :searchable="true" :create-option="true" :options="[
                      { value: 'all', label: 'all' },
                ...
                <table class="table align-middle table-nowrap" id="invoiceTable">
                  ...
                  <tbody class="list form-check-all">
                    <tr v-for="(item, index) of resultQuery" :key="index">
                      ...
                      <td class="id">
                        <Link href="/invoices/detail" class="fw-medium link-primary">{{ item.invoiceId }}
                        </Link>
                      </td>
                      ...
                      <td>
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="btn btn-soft-secondary btn-sm" no-caret menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                          <template #button-content><i class="ri-more-fill align-middle"></i></template>
                          <BDropdownItem href="/invoices/detail"><i class="ri-eye-fill align-bottom me-2 text-muted"></i>View</BDropdownItem>
                          <BDropdownItem href="/invoices/create"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>Edit</BDropdownItem>
    ...
    <BModal v-model="deleteModal" modal-class="zoomIn" hide-footer no-close-on-backdrop centered>
      <div class="mt-2 text-center">
        <lottie class="avatar-xl" colors="primary:#f7b84b,secondary:#f06548" :options="defaultOptions1" :height="75" :width="75" />
