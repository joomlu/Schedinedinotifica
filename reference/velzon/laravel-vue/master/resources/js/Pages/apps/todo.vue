...
export default {
        ...
        return {
            ...
            selectedimage: [],
            options: [
                { name: 'James Forbes', value: avatar2.jpg },
                { name: 'John Robles', value: avatar3.jpg },
                { name: 'Mary Gant', value: avatar4.jpg },
                { name: 'Curtis Saenz', value: avatar1.jpg },
                { name: 'Virgie Price', value: avatar5.jpg },
                { name: 'Anthony Mills', value: avatar10.jpg },
                { name: 'Marian Angel', value: avatar6.jpg },
                { name: 'Johnnie Walton', value: avatar7.jpg },
                { name: 'Donna Weston', value: avatar8.jpg },
                { name: 'Diego Norris', value: avatar9.jpg },
            ]
        };
    },
    components: {
