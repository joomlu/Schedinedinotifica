                                ...
                                <BCol md="auto">
                                    <div class="hstack gap-1 flex-wrap">
                                        <BButton variant="link"
                                            class="btn py-0 fs-16 favourite-btn material-shadow-none active">
                                            <i class="ri-star-fill" @click="toggleFavourite"></i>
                                        </BButton>
                                        <BButton variant="link" class="btn py-0 fs-16 text-body material-shadow-none">
                                ...
                                <BCard no-body>
                                    <BCardBody>
                                        <div class="text-muted">
                                            ...
                                            <div>
                                                <BButton type="button" variant="link"
                                                    class="link-success p-0 material-shadow-none">Read
                                                    more</BButton>
                                            </div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-shrink-0 ms-2">
                                                                    <div class="d-flex gap-1">
                                                                        <BButton size="sm" variant="link"
                                                                            class="btn btn-icon text-muted fs-18"><i
                                                                                class="ri-download-2-line"></i></BButton>
                                                                        <BDropdown variant="link"
                                                                            toggle-class="btn btn-icon btn-sm fs-18 text-muted"
                                                                            no-caret menu-class="dropdown-menu-end"
                                                        ...
                                                        <div class="border rounded border-dashed p-2">
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-3">
                                                                    <div class="avatar-sm">
                                                                        <div
                                                                            class="avatar-title bg-light text-secondary rounded fs-24 material-shadow">
                                                                ...
                                                                <div class="flex-shrink-0 ms-2">
                                                                    <div class="d-flex gap-1">
                                                                        <BButton size="sm" variant="link"
                                                                            class="btn btn-icon text-muted fs-18 material-shadow"><i
                                                                                class="ri-download-2-line"></i></BButton>
                                                                        <BDropdown variant="link"
                                                                            toggle-class="btn btn-icon btn-sm fs-18 text-muted material-shadow"
                                                                            no-caret menu-class="dropdown-menu-end"
                                                                            :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                                                            <template #button-content>
                                                                                <i class="ri-more-fill"></i>
                                    ...
                                    <BCardHeader class="align-items-center d-flex py-0">
                                        ...
                                        <div class="flex-shrink-0">
                                            <BDropdown variant="link" class="card-header-dropdown"
                                                toggle-class="text-reset dropdown-btn" no-caret
                                            ...
                                            <BRow class="g-3">
                                                ...
                                                <BCol cols="12" class="text-end">
                                                    <BButton type="button" variant="ghost-secondary"
                                                        class="btn-icon waves-effect me-1 material-shadow-none">
                                    ...
                                    <BCardHeader class="align-items-center d-flex border-bottom-dashed">
                                        ...
                                        <div class="flex-shrink-0">
                                            <BButton type="button" variant="soft-danger" size="sm"
                                                class="material-shadow-none"><i class="ri-share-line me-1 align-bottom"></i>
                                                Invite Member
                                            </BButton>
                                        </div>
                                    </BCardHeader>
                                            ...
                                            <div class="vstack gap-3">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="d-flex align-items-center gap-1">
                                                            <BButton type="button" variant="light" size="sm"
                                                                class="material-shadow-none">Message
                                                            </BButton>

                                                            <BDropdown variant="link"
                                                                toggle-class="btn btn-icon btn-sm fs-16 material-shadow-none text-muted"
                                                                no-caret menu-class="dropdown-menu-end"
                                                                :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                                                <template #button-content>
                                                                    <i class="ri-more-fill"></i>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="d-flex align-items-center gap-1">
                                                            ...
                                                            <BDropdown variant="link"
                                                                toggle-class="btn btn-icon btn-sm fs-16 text-muted material-shadow-none"
                                                                no-caret menu-class="dropdown-menu-end"
                                                                :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                                                <template #button-content>
                                                                    <i class="ri-more-fill"></i>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="d-flex align-items-center gap-1">
                                                            <BButton type="button" variant="light" size="sm"
                                                                xlass="material-shadow-none">Message
                                                            </BButton>
                                                            <BDropdown variant="link"
                                                                toggle-class="btn btn-icon btn-sm fs-16 text-muted material-shadow-none"
                                                                no-caret menu-class="dropdown-menu-end"
                                            ...
                                            <div class="border rounded border-dashed p-2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0 ms-2">
                                                        <div class="d-flex gap-1">
                                                            <BButton size="sm" variant="link"
                                                                class="btn btn-icon text-muted fs-18 material-shadow-none"><i
                                                                    class="ri-download-2-line"></i></BButton>
                                                            <BDropdown variant="link"
                                                                toggle-class="btn btn-icon btn-sm fs-18 material-shadow-none text-muted"
                                                                no-caret menu-class="dropdown-menu-end"
                                                                :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                                                <template #button-content>
                                                                    <i class="ri-more-fill"></i>
                                        ...
                                        <table class="table table-borderless align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <BDropdown variant="link"
                                                            toggle-class="btn btn-soft-secondary btn-sm btn-icon" no-caret
                                            ...
                                            <BRow class="align-items-center">
                                                <BCol>
                                                    <div class="flex-shrink-0 me-2"
                                                        style="position: absolute; top: 8px; right: 70px;">
                                                        <BButton variant="link" class="fs-16 p-0 favourite-btn">
                                                            <i class="ri-star-fill"></i>
                                                        </BButton>
                                                    </div>
                                                </BCol>
                                                <BDropdown variant="link" toggle-class="text-end" no-caret
                                                    menu-class="dropdown-menu-end">
                                                    <template #button-content>
                                        ...
                                        <div class="col team-settings">
                                            <BRow class="align-items-center">
                                                <BCol>
                                                    <div class="flex-shrink-0 me-2"
                                                        style="position: absolute; top: 8px; right: 70px;">
                                                        <BButton variant="link" class="fs-16 p-0 favourite-btn active">
                                                            <i class="ri-star-fill"></i>
                                                        </BButton>
                                                    </div>
                                                </BCol>
                                    ...
                                    <BRow class="align-items-center team-row">
                                        <div class="col team-settings">
                                            <BRow class="align-items-center">
                                                <BCol>
                                                    <div class="flex-shrink-0 me-2"
                                                        style="position: absolute; top: 8px; right: 68px;">
                                                        <BButton variant="link" class="fs-16 p-0 favourite-btn">
                                                            <i class="ri-star-fill"></i>
                                                        </BButton>
                                                    </div>
