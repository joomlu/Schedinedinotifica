            ...
            <BCol xl="6">
                <BCard no-body>
                    ...
                    <BCardBody>
                        ...
                        <div class="mx-n3">
                            <simplebar data-simplebar data-simplebar-direction="rtl" style="max-height: 220px;"
                                class="px-3">
                                <p>If several languages coalesce, the grammar of the resulting language is more simple
                                    and regular than that of the individual languages. The new common language will be
                                    more simple and regular than the existing</p>
                            ...
                            <BCardBody>
                                ...
                                <div class="mx-n3">
                                    <simplebar data-simplebar data-simplebar-auto-hide="false"
                                        data-simplebar-track="primary" style="max-height: 275px;">
                                        ...
                                        <BLink href="#!" class="text-reset notification-item d-block dropdown-item active">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs me-3">
                    ...
                    <BCol xl="4" lg="6">
                        <BCard no-body>
                            ...
                            <BCardBody>
                                ...
                                <div class="mx-n3">
                                    <simplebar data-simplebar data-simplebar-auto-hide="false"
                                        data-simplebar-track="success" style="max-height: 274px;">
                    ...
                    <BCol xl="4" lg="6">
                        <BCard no-body>
                            ...
                            <BCardBody>
                                ...
                                <div class="mx-n3">
                                    <simplebar data-simplebar data-simplebar-auto-hide="false"
                                        data-simplebar-track="warning" style="max-height: 220px;" class="px-3">
                                        <div class="d-flex align-items-center py-3">
                                            ...
                                            <div class="flex-shrink-0 ms-2">
                                                <BButton variant="outline-success" size="sm" class="material-shadow-none"><i
                                ...
                                <div class="mx-n3">
                                    <simplebar data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="danger"
                                        ...
                                        <BLink href="#" class="d-flex align-items-center py-2">
                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                <div
                                                    class="avatar-title bg-light text-primary rounded-circle material-shadow">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                <div>
                                                    <div class="d-flex align-items-start">
                                                        <div class="flex-grow-1">
                                                            <BBadge tag="div" variant="success" class="bg-gradient mb-2"><i
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="hstack gap-3">
                                                                ...
                                                                <BDropdown variant="link" right
                                                                    toggle-class="text-muted p-0" no-caret>
