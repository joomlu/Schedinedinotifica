                ...
                <BCard no-body>
                    ...
                    <BCardBody>
                        <div class="live-preview">
                            ...
                            <BRow class="mt-4 align-items-center g-3">
...
&lt;/div&gt;</code></pre>
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <CardHeader title="Input Group Sizing" />

                    <BCardBody>
                        <p class="text-muted">Use <code>input-group-sm</code> class to set a small size input group and
                            <code>input-group-lg</code> class to input-group class to set a large size input group
                            respectively. no such class is required for a default size input group.
                        </p>
                        <div class="live-preview">
                            <BRow class="align-items-center g-3">
                                <BCol lg="4">
...
&lt;/div&gt;</code></pre>
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <CardHeader title="Multiple Inputs" />
...
&lt;/div&gt;</code></pre>
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <CardHeader title="Buttons, Checkboxs and Radios Group" />
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            <BButton variant="outline-primary" type="button" class="material-shadow-none"
                                                id="button-addon1">Button</BButton>
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            ...
                                            <BButton variant="outline-success" type="button" class="material-shadow-none"
                                                id="button-addon2">Button</BButton>
                                        </div>
                                    </BCol>
                                    <BCol lg="6">
                                        <div class="input-group">
                                            <BButton variant="primary" type="button">Button</BButton>
                                            <BButton variant="success" type="button">Button</BButton>
                                            <input type="text" class="form-control" placeholder=""
...
&lt;/div&gt;</code></pre>
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <CardHeader title="Buttons with dropdowns" />
                                ...
                                <BRow class="g-3">
                                    <BCol lg="6">
                                        <BInputGroup>
                                            ...
                                            <BFormInput type="text" class="form-control"
                                                aria-label="Text input with dropdown button"></BFormInput>
                                        </BInputGroup>
                                    </BCol>
                                    <BCol lg="6">
                                        <BInputGroup>
                                    ...
                                    <BCol lg="12">
                                        <BInputGroup>
                                            ...
                                            <BFormInput type="text" class="form-control"
                                                aria-label="Text input with 2 dropdown buttons"></BFormInput>
                                            <BDropdown variant="outline-secondary" text="Dropdown"
                                                class="material-shadow-none">
                                                <BDropdown-menu class="dropdown-menu-end">
                                                    <BDropdownItem href="#">Action</BDropdownItem>
                        ...
                        <div class="live-preview">
                                ...
                                <BRow class="g-3">
                                    <BCol lg="6">
                                        <BInputGroup>
                                            ...
                                            <BFormSelect id="inputGroupSelect01" v-model="selectedOption">
                                    ...
                                    <BCol lg="6">
                                        <BInputGroup>
                                            <BFormSelect id="inputGroupSelect02" v-model="selectedOption2">
                                                <option value="">Choose...</option>
                                                <option value="1">One</option>
                                                <option value="2">Two</option>
                                                <option value="3">Three</option>
                                            </BFormSelect>
                                            <label for="inputGroupSelect02" class="input-group-text">Options</label>
                                        </BInputGroup>
                                    </BCol>
                                    <BCol lg="6">
                                        <BInputGroup>
                                            <BButton variant="outline-primary" class="material-shadow-none">Button</BButton>
                                            <BFormSelect id="inputGroupSelect03" v-model="selectedOption3"
                                    ...
                                    <BCol lg="6">
                                        <BInputGroup>
                                            <BFormSelect id="inputGroupSelect04" v-model="selectedOption4"
                                                aria-label="Example select with button addon">
                                                <option value="">Choose...</option>
                                                <option value="1">One</option>
                                                <option value="2">Two</option>
                                            ...
                                            <BButton variant="outline-secondary" class="material-shadow-none">Button</BButton>
                                        </BInputGroup>
                                    </BCol>
                                </BRow>
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            <BButton variant="outline-primary" class="material-shadow-none" type="button" id="inputGroupFileAddon03">
                                                Button</BButton>
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            ...
                                            <BButton variant="outline-success" class="material-shadow-none" type="button" id="inputGroupFileAddon04">
                                                Button</BButton>
                                        </div>
                                    </BCol>
                                </BRow>
