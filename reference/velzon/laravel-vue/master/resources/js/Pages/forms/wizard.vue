                            ...
                            <div id="custom-progress-bar" class="progress-nav mb-4">
                                ...
                                <ul class="nav nav-pills progress-bar-tab custom-nav" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <BButton variant="link" class="nav-link rounded-pill" id="pills-gen-info-tab" role="tab" :class="{ active: activeTab == 1, done: activeTab > 1 }" @click="toggleTab(1, 0);">1</BButton>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <BButton variant="link" class="nav-link rounded-pill" id="pills-info-desc-tab" role="tab" :class="{ active: activeTab == 2, done: activeTab > 2 }" @click="toggleTab(2, 50);">2</BButton>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <BButton variant="link" class="nav-link rounded-pill" id="pills-success-tab" role="tab" :class="{ active: activeTab == 3, done: activeTab > 3 }" @click="toggleTab(3, 100);">3</BButton>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade" :class="activeTab == 1 && 'show active'" id="pills-gen-info" role="tabpanel" aria-labelledby="pills-gen-info-tab">
                                    ...
                                    <div class="d-flex align-items-start gap-3 mt-4">
                                        <BButton variant="success" class="btn-label right ms-auto nexttab nexttab" @click="toggleTab(2, 50);"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Go to
                                            more info</BButton>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" :class="activeTab == 2 && 'show active'" id="pills-info-desc" role="tabpanel" aria-labelledby="pills-info-desc-tab">
                                        ...
                                        <div class="text-center">
                                            <div class="profile-user position-relative d-inline-block mx-auto mb-2">
                                                ...
                                                <div class="avatar-xs p-0 rounded-circle profile-photo-edit position-absolute end-0 bottom-0">
                                                    <input id="profile-img-file-input" type="file" class="profile-img-file-input d-none" accept="image/png, image/jpeg">
                                    ...
                                    <div class="d-flex align-items-start gap-3 mt-4">
                                        <BButton variant="link" class="btn btn-link text-decoration-none btn-label previestab" @click="toggleTab(1, 0);"><i class="ri-arrow-left-line label-icon align-middle fs-lg me-2"></i> Back to
                                            General</BButton>

                                        <BButton variant="success" class="btn-label right ms-auto nexttab nexttab" @click="toggleTab(3, 100);"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Submit
                                        </BButton>
                                    </div>
                                </div>
                    ...
                    <BCardBody>
                        <form action="#">
                            <BLink class="navbar-brand d-block text-center pt-3 pb-4 mb-1" href="#">
                                <img src="@assets/images/logo-dark.png" class="card-logo mx-auto card-logo-dark" alt="logo dark" height="17">
                                <img src="@assets/images/logo-light.png" class="card-logo mx-auto card-logo-light" alt="logo light" height="17">
                            </BLink>
                            <div class="step-arrow-nav mb-4">

                                <ul class="nav nav-pills custom-nav nav-justified" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <BButton variant="link" class="nav-link" id="steparrow-gen-info-tab" :class="{ active: activeTabArrow == 1, done: activeTabArrow > 1 }" @click="toggleTabArrow(1);">General</BButton>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <BButton variant="link" class="nav-link" id="steparrow-description-info-tab" :class="{ active: activeTabArrow == 2, done: activeTabArrow > 2 }" @click="toggleTabArrow(2);">Description</BButton>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <BButton variant="link" class="nav-link" id="pills-experience-tab" :class="{ active: activeTabArrow == 3, done: activeTabArrow > 3 }" @click="toggleTabArrow(3);">Finish</BButton>
                                    </li>
                                </ul>
                            </div>

                            <div class="tab-content">
                                <div class="tab-pane fade" :class="activeTabArrow == 1 && 'show active'" id="steparrow-gen-info" role="tabpanel" aria-labelledby="steparrow-gen-info-tab">
                                    <div>
                                        <BRow>
                                            <BCol lg="6">
                                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-start gap-3 mt-4">
                                        <BButton variant="success" class="btn-label right ms-auto nexttab nexttab" @click="toggleTabArrow(2);"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Go to
                                            more info</BButton>
                                    </div>
                                </div>

                                <div class="tab-pane fade" :class="activeTabArrow == 2 && 'show active'" id="steparrow-description-info" role="tabpanel" aria-labelledby="steparrow-description-info-tab">
                                    <div>
                                        <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-start gap-3 mt-4">
                                        <BButton variant="light" class="btn-label previestab" @click="toggleTabArrow(1);"><i class="ri-arrow-left-line label-icon align-middle fs-lg me-2"></i> Back to
                                            General</BButton>
                                        <BButton variant="success" class="btn-label right ms-auto nexttab nexttab" @click="toggleTabArrow(3);"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Submit
                                        </BButton>
                                    </div>
                                </div>

                                <div class="tab-pane fade" :class="activeTabArrow == 3 && 'show active'" id="pills-experience" role="tabpanel">
                                    <div class="text-center">
                            ...
                            <BRow class="gy-5">
                                <BCol lg="3">
                                    <div class="nav flex-column custom-nav nav-pills" role="tablist" aria-orientation="vertical">
                                        <BButton variant="link" id="v-pills-bill-info-tab" type="button" role="tab" :class="{ active: activeTabVerti == 1, done: activeTabVerti > 1 }" @click="toggleTabVerti(1);">
                                            <span class="step-title me-2">
                                                <i class="ri-close-circle-fill step-icon me-2"></i> Step 1
                                            </span>
                                            Billing Info
                                        </BButton>
                                        <BButton variant="link" id="v-pills-bill-address-tab" type="button" role="tab" :class="{ active: activeTabVerti == 2, done: activeTabVerti > 2 }" @click="toggleTabVerti(2);">
                                            <span class="step-title me-2">
                                                <i class="ri-close-circle-fill step-icon me-2"></i> Step 2
                                            </span>
                                            Address
                                        </BButton>
                                        <BButton variant="link" id="v-pills-payment-tab" type="button" role="tab" :class="{ active: activeTabVerti == 3, done: activeTabVerti > 3 }" @click="toggleTabVerti(3);">
                                            <span class="step-title me-2">
                                                <i class="ri-close-circle-fill step-icon me-2"></i> Step 3
                                            </span>
                                            Payment
                                        </BButton>
                                        <BButton variant="link" id="v-pills-finish-tab" type="button" role="tab" :class="{ active: activeTabVerti == 4, done: activeTabVerti > 4 }" @click="toggleTabVerti(4);">
                                            <span class="step-title me-2">
                                ...
                                <BCol lg="6">
                                    <div class="px-lg-4">
                                        <div class="tab-content">
                                            <div class="tab-pane fade" id="v-pills-bill-info" role="tabpanel" :class="activeTabVerti == 1 && 'show active'">
                                                <div>
                                                    <h5>Billing Info</h5>
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    <BButton variant="success" class="btn btn-success btn-label right ms-auto nexttab nexttab" @click="toggleTabVerti(2);">
                                                        <i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Go
                                                        to Shipping
                                                    </BButton>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="v-pills-bill-address" role="tabpanel" :class="activeTabVerti == 2 && 'show active'">
                                                <div>
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    <BButton variant="light" class="btn-label previestab" @click="toggleTabVerti(1);"><i class="ri-arrow-left-line label-icon align-middle fs-lg me-2"></i>
                                                        Back to Billing Info</BButton>
                                                    <BButton variant="success" class="btn-label right ms-auto nexttab nexttab" @click="toggleTabVerti(3);"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Go
                                                        to Payment</BButton>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="v-pills-payment" role="tabpanel" :class="activeTabVerti == 3 && 'show active'">
                                                <div>
                                                    <h5>Payment</h5>
                                                    <p class="text-muted">Fill all information below</p>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    <BButton variant="light" class="btn-label previestab" @click="toggleTabVerti(2);"><i class="ri-arrow-left-line label-icon align-middle fs-lg me-2"></i>
                                                        Back to Shipping Info</BButton>
                                                    <BButton variant="success" class="btn-label right ms-auto nexttab nexttab" @click="toggleTabVerti(4);"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>
                                                        Order Complete</BButton>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="v-pills-finish" role="tabpanel" :class="activeTabVerti == 4 && 'show active'">
                                                <div class="text-center pt-4 pb-2">
                                                    <div class="mb-4">
                                                        <lottie colors="primary:#0ab39c,secondary:#405189" :options="defaultOptions" :height="120" :width="120" />
                                                    </div>
