        ...
        <div>
          <div class="d-flex profile-wrapper" style="position: absolute; right: 13px; top: 26px; ">
            <div class="d-flex justify-content-end">
              <Link href="/pages/profile-setting" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</Link>
            </div>
          </div>
                    ...
                    <BCardBody>
                      <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="flex-shrink-0">
                          <BDropdown variant="link" right toggle-class="p-0" no-caret>
                      ...
                      <div>
                        <div class="d-flex align-items-center py-3">
                          ...
                          <div class="flex-shrink-0 ms-2">
                            <BButton type="button" variant="outline-success" size="sm" class="material-shadow-none">
                                ...
                                <div class="accordion accordion-flush" id="weeklyExample">
                                  ...
                                  <div class="accordion-item border-0">
                                    <div class="accordion-header" id="heading7">
                                      <BLink class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapse7" aria-expanded="false">
                                        <div class="d-flex">
                                          <div class="avatar-xs">
                                          ...
                                          <div class="flex-grow-1 ms-3">
                                            <h6 class="fs-14 mb-1">
                                              ...
                                              <BBadge variant="success-subtle" class="bg-success-subtle text-success align-middle">Completed</BBadge>
                                            </h6>
                                ...
                                <div class="accordion accordion-flush" id="monthlyExample">
                                  ...
                                  <div class="accordion-item border-0">
                                    <div class="accordion-header" id="heading14">
                                      <BLink class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapse14" aria-expanded="true">
                                        <div class="d-flex">
                                          <div class="flex-shrink-0 avatar-xs">
                                            <div class="avatar-title bg-light text-muted rounded-circle material-shadow">
                                              <i class="ri-user-3-fill"></i>
                        ...
                        <swiper :slides-per-view="3" :space-between="50">
                          <swiper-slide>
                            <div class="swiper-slide">
                              <BCard no-body class="profile-project-card shadow-none profile-project-success mb- material-shadow">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                          ...
                          <swiper-slide>
                            <div class="swiper-slide">
                              <BCard no-body class="profile-project-card shadow-none profile-project-danger mb-0 material-shadow">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                                    <div class="flex-grow-1 text-muted overflow-hidden">
                                      <h5 class="fs-14 text-truncate mb-1">
                          ...
                          <swiper-slide>
                            <div class="swiper-slide">
                              <BCard no-body class="profile-project-card shadow-none profile-project-info mb-0 material-shadow">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                                    <div class="flex-grow-1 text-muted overflow-hidden">
                                      <h5 class="fs-14 text-truncate mb-1">
                          ...
                          <swiper-slide>
                            <div class="swiper-slide">
                              <BCard no-body class="profile-project-card shadow-none profile-project-warning mb-0 material-shadow">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                                    <div class="flex-grow-1 text-muted overflow-hidden">
                                      <h5 class="fs-14 text-truncate mb-1">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <div class="avatar-group mb-2">
                          <BLink href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Christi">
                            <img src="@assets/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-xs" />
                          </BLink>
                          <BLink href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                            <img src="@assets/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-xs" />
                          </BLink>
                          <BLink href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Ruby">
                            <div class="avatar-xs">
                              <div class="avatar-title rounded-circle bg-light text-primary">
                                R
                              </div>
                          ...
                          <BLink href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="more">
                            <div class="avatar-xs">
            ...
            <BTab class="nav-item pt-4">
              ...
              <BCard no-body>
                <BCardBody>
                  <BRow>
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card shadow-none profile-project-warning material-shadow">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card shadow-none profile-project-success material-shadow">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card shadow-none profile-project-info material-shadow">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card shadow-none profile-project-primary material-shadow">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card shadow-none profile-project-danger material-shadow">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card shadow-none mb-xxl-0 profile-project-info material-shadow">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card shadow-none mb-xxl-0 profile-project-success material-shadow">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card shadow-none mb-sm-0 profile-project-danger material-shadow">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                    ...
                    <BCol xxl="3" sm="6">
                      <BCard no-body class="profile-project-card shadow-none mb-0 profile-project-primary material-shadow">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                  ...
                  <BRow>
                    <BCol lg="12">
                        ...
                        <table class="table table-borderless align-middle mb-0">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>12 Dec 2021</td>
                              <td>
                                <BDropdown variant="light" toggle-class="px-1" class="btn-icon" no-caret>
                      ...
                      <div class="text-center mt-3">
                        <BLink href="javascript:void(0);" class="text-success"><i class="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i>
                          Load more
                        </BLink>
                      </div>
                    </BCol>
