    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          ...
          <BCardBody class="p-4">
            <BDropdown variant="transparent" right class="fw-medium text-reset mb-n1" no-caret
                      ...
                      <BCardBody>
                        <div class="d-sm-flex">
                          ...
                          <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                            <ul class="list-inline mb-2">
                              <li class="list-inline-item">
                                <BBadge variant="primary-subtle" class="bg-primary-subtle text-primary fs-11">Product
                                </BBadge>
                              </li>
                            </ul>
                            <h5>
                      ...
                      <BCardBody>
                        <div class="d-sm-flex">
                          ...
                          <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                            <ul class="list-inline mb-2">
                              <li class="list-inline-item">
                                <BBadge variant="danger-subtle" class="bg-danger-subtle text-danger fs-11">Design</BBadge>
                              </li>
                            </ul>
                            <h5>
