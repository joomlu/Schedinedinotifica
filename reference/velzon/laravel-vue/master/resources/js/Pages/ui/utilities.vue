...
<template>
    <Layout>
        <PageHeader title="Utilities" pageTitle="Base UI" />
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle class="mb-0">Borders</BCardTitle>
                    </BCardHeader>
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle class="mb-0">Border Radius</BCardTitle>
                    </BCardHeader>
                        ...
                        <div class="live-preview">
                            <div>
                                <div>
                                    <div class="d-flex align-items-start flex-wrap gap-4">
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg" class="avatar-md rounded material-shadow"
                                                alt="rounded" />
                                            <p>
                                                <code>.rounded</code>
                                            </p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg" class="avatar-md rounded-top material-shadow"
                                                alt="rounded-top" />
                                            <p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg" class="avatar-md rounded-end material-shadow"
                                                alt="rounded-end" />
                                            <p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg"
                                                class="avatar-md rounded-bottom material-shadow" alt="rounded-bottom " />
                                            <p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg"
                                                class="avatar-md rounded-start material-shadow" alt="rounded-start" />
                                            <p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-2.jpg"
                                                class="avatar-md rounded-circle material-shadow" alt="rounded-circle" />
                                            <p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/small/img-2.jpg"
                                                class="avatar-md w-auto rounded-pill material-shadow" alt="rounded-pill" />
                                            <p>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-start flex-wrap gap-4">
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-0 material-shadow"
                                                alt="rounded-0" />
                                            <p>
                                                <code>.rounded-0</code>
                                            </p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-1 material-shadow"
                                                alt="rounded-1" />
                                            <p>
                                                <code>.rounded-1</code>
                                            </p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-2 material-shadow"
                                                alt="rounded-2" />
                                            <p>
                                                <code>.rounded-2</code>
                                            </p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-3 material-shadow"
                                                alt="rounded-3" />
                                            <p>
                                                <code>.rounded-3</code>
                                            </p>
                                        ...
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-4 material-shadow"
                                                alt="rounded-4">
                                            <p><code>.rounded-4</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img src="@assets/images/users/avatar-1.jpg" class="avatar-md rounded-5 material-shadow"
                                                alt="rounded-5">
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle class="mb-0">Display Property</BCardTitle>
                    </BCardHeader>
        ...
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle class="mb-0">Custom Class</BCardTitle>
                    </BCardHeader>
        ...
        <BRow>
            <BCol xxl="6">
                <BCard no-body>
                    <CardHeader title="Stacks - Vertical" />
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            ...
                            <div class="mt-5">
                                ...
                                <BCol md="5" class="vstack gap-2 mx-auto">
                                    <BButton variant="primary" class="material-shadow">Save changes</BButton>
                                    <BButton variant="outline-secondary">Cancel</BButton>
                                </BCol>
                            </div>
                        </div>
                        ...
                        <div class="live-preview">
                            ...
                            <div class="mt-5">
                                ...
                                <div class="hstack gap-3">
                                    ...
                                    <div class="vr"></div>
                                    <BButton variant="outline-secondary material-shadow-none">Reset</BButton>
                                </div>
                            </div>
                        </div>
...
&lt;/div&gt;</code></pre>
        ...
        <BRow>
            <BCol xxl="6">
                <BCard no-body>
                    <CardHeader title="Text Selection" />
...
<code>&lt;p class=&quot;user-select-none mb-0&quot;&gt;This paragraph will not be selectable when clicked by the user.&lt;/p&gt;</code></pre>
            ...
            <BCol xxl="6">
                <BCard no-body>
                    <CardHeader title="Pointer Events" />
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            <div>
                                <p>
                                    <BLink href="#" class="text-success pe-none" tabindex="-1">This
                                        link</BLink> can not be
                                    clicked.
                                </p>
                                <p>
                                    <BLink href="#" class="text-success pe-auto">This link</BLink> can be
                                    clicked (this is
                                    default behavior).
                                </p>
                                <p class="pe-none mb-0">
                                    <BLink href="#" class="text-success" tabindex="-1">This link</BLink> can
                                    not be clicked
                                    because the
                                    <code>pointer-events</code> property is inherited from its
                                    parent. However,
                                    <BLink href="#" class="pe-auto">this link</BLink> has a
            ...
            <BCol xxl="6">
                <BCard no-body>
                    ...
                    <BCardBody>
                        ...
                        <div class="live-preview">
                            <BRow class="text-center" style="height: 255px;">
                                <BCol>
