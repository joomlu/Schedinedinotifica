                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted mb-2"><span class="text-danger">2 days left</span> notification to submit
                          the monthly sales report. <a href="javascript:void(0);"
                      ...
                      <div class="gallery-box card light mb-0">
                        ...
                        <div class="box-content px-3 py-2">
                          ...
                          <div class="d-flex align-items-center mt-1">
                            <div class="flex-grow-1 text-muted">by <a href="" class="text-body text-truncate">Erica
                                Kernan</a></div>
                            <div class="flex-shrink-0">
                              <div class="d-flex gap-3">
                                <BButton variant="link" size="sm"
                                  class="fs-xs text-body text-decoration-none px-0 material-shadow">
                    ...
                    <BCol xl="3" lg="4" sm="6">
                      <div class="gallery-box card light mb-0">
                        ...
                        <div class="box-content px-3 py-2">
                          ...
                          <div class="d-flex align-items-center mt-1">
                            <div class="flex-grow-1 text-muted">by <a href="" class="text-body text-truncate">Ron
                                Mackie</a></div>
                            <div class="flex-shrink-0">
                              <div class="d-flex gap-3">
                                <BButton variant="link" size="sm"
                    ...
                    <BCol xl="3" lg="4" sm="6">
                      <div class="gallery-box card mb-0">
                        ...
                        <div class="box-content px-3 py-2">
                          ...
                          <div class="d-flex align-items-center mt-1">
                            <div class="flex-grow-1 text-muted">by <a href="" class="text-body text-truncate">Nancy
                                Martino</a></div>
                            <div class="flex-shrink-0">
                              <div class="d-flex gap-3">
                                <BButton variant="link" size="sm"
                    ...
                    <BCol class="d-md-none d-xl-block" xl="3" lg="4" sm="6">
                      <div class="gallery-box card mb-0">
                        ...
                        <div class="box-content px-3 py-2">
                          ...
                          <div class="d-flex align-items-center mt-1">
                            <div class="flex-grow-1 text-muted">by <a href="" class="text-body text-truncate">Henry
                                Baird</a></div>
                            <div class="flex-shrink-0">
                              <div class="d-flex gap-3">
                                <BButton variant="link" size="sm"
                ...
                <BOffcanvas v-model="rightOffcanvas" placement="end" title="Recent Acitivity" header-class="border-bottom"
                  ...
                  <simplebar data-simplebar style="height: calc(100vh - 112px);">
                    <div class="acitivity-timeline p-4">
                      ...
                      <div class="acitivity-item py-3 d-flex">
                        <div class="flex-shrink-0 avatar-xs acitivity-avatar material-shadow">
                          <div class="avatar-title bg-success-subtle text-success rounded-circle">
                            N
                          </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                          ...
                          <div class="avatar-group mb-2">
                            <a href="javascript: void(0);" class="avatar-group-item material-shadow"
                              data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Christi">
                              <img src="@assets/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-xs">
                            </a>
                            <a href="javascript: void(0);" class="avatar-group-item material-shadow"
                            ...
                            <a href="javascript: void(0);" class="avatar-group-item material-shadow"
                              data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title=" Ruby">
                              <div class="avatar-xs">
                                <div class="avatar-title rounded-circle bg-light text-primary">
                                  R
                                </div>
                            ...
                            <a href="javascript: void(0);" class="avatar-group-item material-shadow"
                              data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="more">
                              <div class="avatar-xs">
                                <div class="avatar-title rounded-circle">
                                  2+
                                </div>
