        ...
        <BCard no-body>
          ...
          <BCardBody>
            ...
            <div class="live-preview">
              <BAccordion>
                <BAccordionItem title="How to create a group booking ?" visible class="material-shadow">
                ...
                <BAccordionItem title="Why do we use it ?" class="material-shadow">
                ...
                <BAccordionItem title="Where does it come from ?" class="material-shadow">
                  ...
                  <div class="
                    ...
                    <div class="accordion-item mt-2">
                      <h2 class="accordion-header" id="accordionnesting3Example2">
                        <BButton variant="link" class="accordion-button collapsed" data-bs-toggle="collapse"
