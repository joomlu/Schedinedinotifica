  ...
  <Layout>
              ...
              <BCol lg class="border-end">
                <div class="mt-3 mt-lg-0 py-4 px-3">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                      <h2 class="mb-0">
                        $<count-to :startVal="0" :endVal="1596.50" :duration="5000" :decimals="2"></count-to>0
                      </h2>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-info-subtle rounded-circle fs-2 ">
                    <UsersIcon class="text-info material-shadow" width="24" height="24"></UsersIcon>
                  </span>
                </div>
              </div>
            </div>
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-info-subtle rounded-circle fs-2 material-shadow">
                    <ActivityIcon class="text-info" width="24" height="24"></ActivityIcon>
                  </span>
                </div>
              </div>
            </div>
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-white bg-opacity-25 rounded-circle fs-2 material-shadow">
                    <ClockIcon class="text-white" width="24" height="24"></ClockIcon>
                  </span>
                </div>
              </div>
            </div>
          ...
          <BCardBody>
            <div class="d-flex justify-content-between">
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-info-subtle rounded-circle fs-2 material-shadow">
                    <ExternalLinkIcon class="text-info" width="24" height="24"></ExternalLinkIcon>
                  </span>
                </div>
              </div>
            </div>
    ...
    <BRow>
      <BCol xl="3" md="6">
        <BCard no-body class="card-height-100">
          <BCardBody>
            <BDropdown variant="link" right toggle-class="text-decoration-none p-0" class="float-end" no-caret>
      ...
      <BCol xxl="4" xl="6">
        <BCard no-body class="card-height-100">
          <BCardHeader class="align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
              <BButton variant="soft-primary" size="sm" class="material-shadow">
                Export Report
              </BButton>
            </div>
          </BCardHeader>
        ...
        <BCard no-body class="card-height-100">
          <BCardHeader class="border-0 align-items-center d-flex">
            ...
            <div class="hstack gap-1 justify-content-end">
              <BButton variant="soft-secondary" size="sm" class="material-shadow-none">
                ALL
              </BButton>
              <BButton variant="soft-secondary" size="sm" class="material-shadow-none">
                1M
              ...
              <BButton variant="soft-primary" size="sm" class="material-shadow-none">
                1Y
              </BButton>
            </div>
          </BCardHeader>
      ...
      <BCol xxl="4" xl="6">
        <BCard no-body class="card-height-100">
          <BCardHeader class="border-bottom-dashed align-items-center d-flex">
            ...
            <div>
              <BDropdown text="BTC" variant="primary-subtle" size="sm" right no-caret>
                  ...
                  <div class="d-flex flex-wrap gap-2 select-color">
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="Out of Stock">
                      <BButton variant="link"
                        class="avatar-xs p-0 d-flex align-items-center justify-content-center border material-shadow-none rounded-circle fs-22 text-primary"
                        disabled>
                    ...
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="03 Items Available">
                      <BButton variant="link"
                        class="avatar-xs p-0 d-flex align-items-center justify-content-center border material-shadow-none rounded-circle fs-22 text-secondary">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </BButton>
                    </div>
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="03 Items Available">
                      <BButton variant="link"
                        class="avatar-xs p-0 d-flex align-items-center justify-content-center border material-shadow-none rounded-circle fs-22 text-success">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </BButton>
                    </div>
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="02 Items Available">
                      <BButton variant="link"
                        class="avatar-xs p-0 d-flex align-items-center justify-content-center border material-shadow-none rounded-circle fs-22 text-info">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </BButton>
                    </div>
                  </div>
              ...
              <BCol xl="6">
                ...
                <ul class="clothes-size list-unstyled hstack gap-2 mb-0">
                  <li>
                    <input type="radio" name="sizes" id="color-1" disabled />
                    <label
                      class="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center material-shadow-none rounded-circle"
                      for="color-1">S</label>
                  </li>
                  <li>
                    <input type="radio" name="sizes" id="color-2" />
            ...
            <BCol lg="6">
              <BCardBody class="text-center">
                ...
                <div class="d-flex gap-2 justify-content-center mb-3">
                  <BButton variant="link" class="avatar-xs p-0 material-shadow-none" v-b-tooltip.hover title="Google">
                    <span class="avatar-title rounded-circle bg-light text-body">
                      <i class="ri-google-line"></i>
                    </span>
                  </BButton>

                  <BButton variant="link" class="avatar-xs p-0 material-shadow-none" v-b-tooltip.hover title="Linkedin">
                    <span class="avatar-title rounded-circle bg-light text-body">
                      <i class="ri-linkedin-line"></i>
                    </span>
                  </BButton>
                  <BButton variant="link" class="avatar-xs p-0 material-shadow-none" v-b-tooltip.hover title="Dribbble">
                    <span class="avatar-title rounded-circle bg-light text-body">
