...
const basicColumnChart = {
    ...
    chartOptions: {
        ...
        colors: getChartColorsArray('["--vz-gray-300", "--vz-primary", "--vz-info"]'),
        xaxis: {
            categories: [
                "Feb",
                "Mar",
...
const columnStackedChart = {
    ...
    chartOptions: {
        ...
        colors: getChartColorsArray('["--vz-primary", "--vz-info", "--vz-gray-300"]'),
    },
};
...
const columnNegativeChart = {
    ...
    chartOptions: {
        colors: getChartColorsArray('["--vz-info", "--vz-primary", "--vz-gray-300"]'),
        chart: {
            type: "bar",
            height: 350,
            toolbar: {
