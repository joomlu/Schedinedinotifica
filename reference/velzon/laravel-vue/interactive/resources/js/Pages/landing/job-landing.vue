            ...
            <BContainer fluid class="custom-container">
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        <li class="nav-item">
                            <BLink class="nav-link fw-normal" href="#hero" @click.prevent="scrollToSection('hero')">Home
                            </BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fw-normal" href="#process" @click.prevent="scrollToSection('process')">
                                Process
                            </BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fw-normal" href="#categories" @click.prevent="scrollToSection('categories')">
                                Categories</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fw-normal" href="#findJob" @click.prevent="scrollToSection('findJob')">Find
                                Jobs</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fw-normal" href="#candidates" @click.prevent="scrollToSection('candidates')">
                                Candidates</BLink>
                        </li>
                        <li class="nav-item">
                ...
                <BRow class="justify-content-center">
                    <BCol lg="8">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted fs-16">A creative person has the ability to invent and develop original
                ...
                <BRow class="justify-content-center">
                    <BCol lg="7">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted fs-16">Post a job to tell us about your project. We'll quickly match you with
                ...
                <BRow class="align-items-center gy-4">
                    <BCol sm>
                        <div>
                            ...
                            <p class="text-white-50 mb-0 fs-16">Create new account and refer your friend</p>
                        </div>
                    </BCol>
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <div class="hstack gap-2">
                                            ...
                                            <BBadge variant="secondary-subtle" class="bg-secondary-subtle text-secondary">
                                                Product</BBadge>
                                            <BBadge variant="info-subtle" class="bg-info-subtle text-info">Business
                                            </BBadge>
                                        </div>
                                    </div>
                                    <div>
                ...
                <BRow class="align-items-center gy-4">
                    <BCol lg="6" order="2" order-lg="1">
                        <div class="text-muted mt-5 mt-lg-0">
                            ...
                            <p class="ff-secondary mb-2 fs-16">The demand for content writing services is growing. This is
                                ...
                                demand.</p>
                            <p class="mb-4 ff-secondary fs-16">A Content Writer is a professional who writes informative and
                ...
                <BRow class="justify-content-center">
                    <BCol lg="8">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted fs-16 mb-4">We thrive when coming up with innovative ideas but also
                    ...
                    <BCol lg="4" md="6">
                        <BCard no-body>
                            ...
                            <BCardBody>
                                ...
                                <p class="text-muted fs-15">One disadvantage of Lorum Ipsum is that in Latin certain
                    ...
                    <BCol lg="4" md="6">
                        <BCard no-body>
                            ...
                            <BCardBody>
                                ...
                                <p class="text-muted fs-15">Due to its widespread use as filler text for layouts,
                    ...
                    <BCol lg="4" md="6">
                        <BCard no-body>
                            ...
                            <BCardBody>
                                ...
                                <p class="text-muted fs-15">Intrinsically incubate intuitive opportunities and real-time
                ...
                <BRow class="align-items-center gy-4">
                    <BCol sm="">
                        <div>
                            ...
                            <p class="text-white text-opacity-75 mb-0 fs-16">Subscribe & get all related jobs notification.</p>
                        </div>
                    </BCol>
