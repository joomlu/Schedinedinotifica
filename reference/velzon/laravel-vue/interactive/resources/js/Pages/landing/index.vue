            ...
            <BContainer>
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        ...
                        <li class="nav-item">
                            <BLink class="nav-link fs-15" href="#services" @click.prevent="scrollToSection('services')">Services</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15" href="#features" @click.prevent="scrollToSection('features')">Features</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15" href="#plans" @click.prevent="scrollToSection('plans')">Plans</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15" href="#reviews" @click.prevent="scrollToSection('reviews')">Reviews</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15" href="#team" @click.prevent="scrollToSection('team')">Team</BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link fs-15" href="#contact" @click.prevent="scrollToSection('contact')">Contact</BLink>
                        </li>
                    </ul>
                    ...
                    <BCol lg="4">
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div>
                                    <Link href="#" class="fs-14 fw-medium">Learn More <i
                                            class="ri-arrow-right-s-line align-bottom"></i></Link>
                                </div>
                            </div>
                        </div>
                    </BCol>
                    ...
                    <BCol lg="8">
                        <div class="text-center mb-5">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <div>
                                    <h5 class="fs-14 mb-0">Annual <BBadge variant="danger-subtle"
                        ...
                        <BCard no-body class="plan-box mb-0">
                            <BCardBody class="p-4 m-2">
                                ...
                                <div>
                                    ...
                                    <div class="mt-4">
                                        <Link href="javascript:void(0);" class="btn btn-soft-success w-100">Get
                                            Started</Link>
                                    </div>
                                </div>
                            </BCardBody>
                                            ...
                                            <BRow class="justify-content-center">
                                                <BCol cols="10">
                                                    <div class="text-white-50">
                                                        <p class="fs-19 ff-secondary mb-4">" I am givng 5 stars. Theme
                                    ...
                                    <swiper-slide>
                                        <div class="swiper-slide">
                                            <BRow class="justify-content-center">
                                                <BCol cols="10">
                                                    <div class="text-white-50">
                                                        <p class="fs-19 ff-secondary mb-4">" Amazing template, Redux
                        ...
                        <div class="text-sm-end mt-3 mt-sm-0">
                            <ul class="list-inline mb-0 footer-social-link">
                                <li class="list-inline-item">
                                    <Link href="javascript: void(0);" class="avatar-xs d-block">
