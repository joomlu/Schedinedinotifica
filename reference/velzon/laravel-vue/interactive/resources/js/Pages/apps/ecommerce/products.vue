            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingBrands">
                <button class="accordion-button bg-transparent shadow-none" type="button" v-b-toggle.flush-collapseBrands>
                  ...
                  <BBadge variant="info" class="rounded-pill align-middle ms-1">2</BBadge>
                </button>
              </h2>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingDiscount">
                <button class="accordion-button bg-transparent shadow-none collapsed" type="button"
                  ...
                  <BBadge variant="info" class="rounded-pill align-middle ms-1">1</BBadge>
                </button>
              </h2>
          ...
          <BCard no-body>
            <BCardHeader class="border-0">
              <BRow class="g-4">
                <BCol sm="auto">
                  <div>
                    <Link href="/ecommerce/add-product" class="btn btn-info"><i
              ...
              <BRow class="align-items-center">
                <BCol>
                  <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                    <li class="nav-item">
                      <BLink class="nav-link text-body active fw-semibold" data-bs-toggle="tab" href="#productnav-all" role="tab">
                        All
                          ...
                          <td data-column-id="product" class="gridjs-td">
                            <span>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                  <h5 class="fs-14 mb-1">
                                    <Link href="/ecommerce/product-details" class="text-body">{{ data.name }}
                                    </Link>
                                  </h5>
                            ...
                            <span>
                              <div class="dropdown">
                                <BDropdown variant="link" toggle-class="btn btn-soft-secondary btn-sm dropdown arrow-none"
                                  ...
                                  <BDropdownItem href="/ecommerce/product-details"><i
                                        class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                      View</BDropdownItem>
                                  <BDropdownItem href="/ecommerce/add-product"> <i
