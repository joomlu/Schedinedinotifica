                ...
                <BCard no-body id="demo">
                    ...
                    <BCardBody class="p-4">
                        <BRow class="g-3">
                            <BCol lg="3" cols="6">
                                ...
                                <h5 class="fs-15 mb-0"><span id="invoice-no">{{ invoiceId }}</span></h5>
                            </BCol>
                            <BCol lg="3" cols="6">
                                <p class="text-muted mb-2 text-uppercase fw-semibold">Date</p>
                                <h5 class="fs-15 mb-0"><span id="invoice-date">{{ date }}</span> <small
                            ...
                            <BCol lg="3" cols="6">
                                ...
                                <h5 class="fs-15 mb-0">$<span id="total-amount">{{ total_amount }}</span></h5>
                            </BCol>
                        </BRow>
                    </BCardBody>
                    ...
                    <BCardBody class="p-4">
                            ...
                            <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                ...
                                <tbody id="products-list">
                                    ...
                                    <tr class="border-top border-top-dashed mt-2">
                                        <td colspan="3"></td>
                                        <td colspan="2" class="fw-semibold p-0">
                                            <table
                        ...
                        <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                            <BLink href="javascript:window.print()" class="btn btn-info"><i
