          ...
          <BCardHeader>
            <div class="d-flex align-items-center">
              ...
              <div class="toolbar d-flex align-items-start justify-content-center flex-wrap gap-2">
                <BButton type="button" variant="soft-info" size="sm" class="timeline-btn" id="one_month">
                  1M
                </BButton>
                <BButton type="button" variant="soft-info" size="sm" class="timeline-btn" id="six_months">
                  6M
                </BButton>
                <BButton type="button" variant="soft-info" size="sm" class="timeline-btn" id="one_year">
                  1Y
                </BButton>
          ...
          <BCardHeader class="border-bottom-dashed d-flex align-items-center">
            ...
            <div class="flex-shrink-0">
              <b-btn-group class="btn-group">
                ...
                <BButton type="button" variant="outline-primary" size="sm">
                  Overall
                </BButton>
              </b-btn-group>
            </div>
