  ...
  setup() {
    return {
      ...
      jobsummarychartchartOptions: {
        ...
        colors: getChartColorsArray('["--vz-info","--vz-secondary", "--vz-primary", "--vz-danger"]'),
        fill: {
          opacity: 0.06,
          colors: getChartColorsArray('["--vz-info","--vz-secondary", "--vz-primary", "--vz-danger"]'),
          type: "solid",
      ...
      userbydevicechartOptions: {
        ...
        colors: getChartColorsArray('["--vz-secondary", "--vz-danger", "--vz-primary"]'),
      },
      ...
      visitorgraphchartOptions: {
        ...
        colors: getChartColorsArray('["--vz-primary", "--vz-danger", "--vz-secondary", "--vz-success","--vz-warning", "--vz-success"]'),
        plotOptions: {
          treemap: {
            distributed: true,
            enableShades: false,
