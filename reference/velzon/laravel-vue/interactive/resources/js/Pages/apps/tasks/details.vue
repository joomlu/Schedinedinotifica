                ...
                <BCard no-body>
                    <BCardBody class="text-center">
                        ...
                        <div class="hstack gap-2 justify-content-center">
                            <BButton variant="info" size="sm"><i class="ri-stop-circle-line align-bottom me-1"></i>
                                Stop</BButton>
                    ...
                    <BCardBody>
                        ...
                        <div class="table-card">
                            <table class="table mb-0">
                                <tbody>
                                    <tr>
                                        <td class="fw-semibold">Tasks No</td>
                                        <td>#VLZ456</td>
                                    </tr>
                                    <tr>
                                        <td class="fw-semibold">Tasks Title</td>
                        ...
                        <ul class="list-unstyled vstack gap-3 mb-0">
                            <li>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <h6 class="mb-1">
                                            <Link href="/pages/profile" class="text-body">Tonya Noble</Link>
                                        </h6>
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <h6 class="mb-1">
                                            <Link href="/pages/profile" class="text-body">Thomas Taylor</Link>
                                        </h6>
                    ...
                    <BCardBody>
                        ...
                        <div class="vstack gap-2">
                            ...
                            <div class="mt-2 text-center">
                                <BButton type="button" variant="info">View more</BButton>
                            </div>
                        </div>
                    </BCardBody>
                </BCard>
                        ...
                        <div class="text-muted">
                            ...
                            <div class="pt-3 border-top border-top-dashed mt-4">
                                ...
                                <div class="hstack flex-wrap gap-2 fs-15">
                                    <BBadge variant="info-subtle" tag="div" class="fw-semibold bg-info-subtle text-info">UI/UX
                                    </BBadge>
                                    <BBadge variant="info-subtle" tag="div" class="fw-semibold bg-info-subtle text-info">
                                        Dashboard</BBadge>
                                    <BBadge variant="info-subtle" tag="div" class="fw-semibold bg-info-subtle text-info">
                                        Design</BBadge>
                                </div>
                ...
                <BCard no-body>
                    <BCardBody>
                        <BTabs  nav-class="nav-tabs-custom card-header-tabs border-bottom-0">
                            <BTab active title="Comments (5)" class="nav-item fw-semibold pt-4" style="position: relative; top: 10px;">
                                ...
                                <simplebar data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                    <div class="d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-14">
                                                <Link href="/pages/profile" class="text-body">Joseph Parker</Link> <small
                                    ...
                                    <div class="d-flex mb-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-14">
                                                <Link href="/pages/profile" class="text-body">Thomas Taylor</Link> <small
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-14">
                                                <Link href="/pages/profile" class="text-body">Tonya Noble</Link> <small
                                ...
                                <form class="mt-4">
                                    <BRow class="g-3">
                                        ...
                                        <BCol cols="12" class="text-end">
                                            <BButton type="button" variant="ghost-info" class="btn-icon me-1"><i
                            ...
                            <BTab title=" Attachments File (4)" class="nav-item fw-semibold pt-4" style="position: relative; top: 10px;">
                            ...
                            <BTab title="Time Entries (9 hrs 13 min)" class="nav-item fw-semibold pt-4" style="position: relative; top: 10px;">
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 ms-2">
                                                            <Link href="/pages/profile" class="fw-medium text-body">Thomas
                                                                Taylor</Link>
                                                        </div>
                                                    </div>
                                                </th>
                                                ...
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="@assets/images/users/avatar-10.jpg" alt=""
                                                            class="rounded-circle avatar-xxs">
                                                        <div class="flex-grow-1 ms-2">
                                                            <Link href="/pages/profile" class="fw-medium text-body">Tonya
                                                                Noble</Link>
                                                        </div>
                                                    </div>
                                                </th>
