          ...
          <BCardBody>
            ...
            <h3 class="mb-2">
              $ <count-to :duration="5000" :startVal="0" :endVal="74854"></count-to><small
                class="text-muted fs-14">.68k</small>
            </h3>
          ...
          <BCardBody>
            ...
            <h3 class="mb-2">
              $<count-to :duration="5000" :startVal="0" :endVal="74361"></count-to><small
                class="text-muted fs-14">.34k</small>
            </h3>
          ...
          <BCardBody>
            ...
            <h3 class="mb-2">
              $<count-to :duration="5000" :startVal="0" :endVal="97685"></count-to><small
                class="text-muted fs-14">.22k</small>
            </h3>
            ...
            <BCard no-body class="card-animate">
              <BCardBody class="bg-info-subtle">
                <div class="d-flex mb-3">
                  ...
                  <div class="flex-shrink-0">
                    <BLink href="javascript:void(0);" class="fw-semibold">Bitcoin (BTC)</BLink>
                  </div>
                </div>
                <h3 class="mb-2">
                  $245<small class="text-muted fs-14">.65k</small>
                </h3>
            ...
            <BCard no-body class="card-animate">
              <BCardBody class="bg-info-subtle">
                <div class="d-flex mb-3">
                  ...
                  <div class="flex-shrink-0">
                    <BLink href="javascript:void(0);" class="fw-semibold">Ethereum (ETH)</BLink>
                  </div>
                </div>
                <h3 class="mb-2">
                  $24<small class="text-muted fs-14">.74k</small>
                </h3>
                <h6 class="text-muted mb-0">Send - Receive (Previous Month)</h6>
              </BCardBody>
            </BCard>
            ...
            <BCard no-body class="card-animate">
              <BCardBody class="bg-info-subtle">
                <div class="d-flex mb-3">
                  ...
                  <div class="flex-shrink-0">
                    <BLink href="javascript:void(0);" class="fw-semibold">Monero (XMR)</BLink>
                  </div>
                </div>
                <h3 class="mb-2">
                  $124<small class="text-muted fs-14">.36k</small>
                </h3>
                <h6 class="text-muted mb-0">Send - Receive (Previous Month)</h6>
              </BCardBody>
            </BCard>
    ...
    <BRow class="align-items-center mb-4 g-3">
      ...
      <BCol sm="auto" class="ms-auto">
        <div class="d-flex gap-2">
          ...
          <BLink href="javascript:void(0);" class="btn btn-primary">Withdraw</BLink>
        </div>
      </BCol>
    </BRow>
