...
<template>
    <Layout>
                ...
                <div class="d-flex mb-3">
                    ...
                    <div class="flex-shrink-0">
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="p-0 arrow-none"
                            ...
                            <template #button-content><span class="fw-semibold text-muted fs-14">Priority<i
        ...
        <BModal v-model="modalShow" header-class="p-3 bg-info-subtle" content-class="border-0" hide-footer
                ...
                <BRow>
                    ...
                    <div class="mt-4">
                        <div class="hstack gap-2 justify-content-end">
                            ...
                            <BButton type="button" variant="primary" id="addNewBoard">Add Board</BButton>
                        </div>
                    </div>
                </BRow>
            </b-form>
