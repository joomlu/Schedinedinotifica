            ...
            <BRow class="justify-content-between gy-3">
              ...
              <BCol lg="auto">
                <div class="d-md-flex text-nowrap gap-2">
                  <BButton variant="primary" class="add-btn"><i class="ri-add-fill me-1 align-bottom"></i> Add Categories
                  </BButton>
                  ...
                  <BDropdown variant="link" right toggle-class="text-decoration-none arrow-none p-0"
                    ...
                    <template #button-content> <span class="fs-18 btn btn-soft-secondary"><i class="ri-more-2-fill"></i></span>
                    </template>
