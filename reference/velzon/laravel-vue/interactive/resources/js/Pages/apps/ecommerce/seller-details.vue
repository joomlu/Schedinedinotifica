            ...
            <form action="#">
              ...
              <div class="text-end">
                <BButton type="submit" variant="primary">
                  <i class="ri-mail-send-line align-bottom me-1"></i> Send Messages
                </BButton>
              </div>
            </form>
          </BCardBody>
      ...
      <BCol xxl="9">
        <BCard no-body>
          <BCardHeader class="border-0 align-items-center d-flex">
            ...
            <div>
              <BButton type="button" variant="soft-info" size="sm" class="me-1">
                ALL
              </BButton>
              <BButton type="button" variant="soft-info" size="sm" class="me-1">
                1M
          ...
          <BCol sm="auto">
            <div>
              <Link href="/ecommerce/add-product" class="btn btn-info"><i
                  class="ri-add-line align-bottom me-1"></i> Add New</Link>
            </div>
          </BCol>
          <BCol sm>
