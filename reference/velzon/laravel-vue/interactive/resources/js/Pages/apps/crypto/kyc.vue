...
<template>
  <Layout>
    ...
    <BModal v-model="modalShow" body-class="p-0" header-class="p-3" title-class="text-uppercase fw-bold" hide-footer
              ...
              <BRow class="text-center justify-content-center">
                <BCol lg="11">
                  ...
                  <div class="hstack justify-content-center gap-2">
                    <BButton type="button" variant="ghost-info" @click="modalShow = false">
                      Done
