...
<template>
    <Layout>
        ...
        <BRow class="row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
            <BCol>
                <BCard no-body>
                    <BLink class="card-header bg-primary-subtle border-0" role="button" v-b-toggle.leadDiscovered>
                        <h5 class="card-title text-uppercase fw-semibold mb-1 fs-15">Lead Discovered</h5>
                        <p class="text-muted mb-0">$265,200 <span class="fw-semibold">4 Deals</span></p>
                    </BLink>
                </BCard>
                <BCollapse id="leadDiscovered" visible>
                    <BCard no-body class="mb-1">
                        ...
                        <BCollapse class="border-top border-top-dashed" id="leadDiscovered1">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">Nesta Technologies <BBadge tag="small" variant="danger-subtle"
            ...
            <BCol>
                <BCard no-body>
                    <BLink class="card-header bg-info-subtle border-0" role="button" v-b-toggle.contactInitiated>
                        <h5 class="card-title text-uppercase fw-semibold mb-1 fs-15">Contact Initiated</h5>
                        <p class="text-muted mb-0">$108,700 <span class="fw-semibold">5 Deals</span></p>
                    </BLink>
                </BCard>
                <BCollapse id="contactInitiated" visible>
                    ...
                    <BCard no-body class="mb-1">
                        ...
                        <BCollapse class="border-top border-top-dashed" id="contactInitiated2">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">Zoetic Fashion <BBadge tag="small" variant="warning-subtle"
                    ...
                    <BCard no-body class="mb-1">
                        ...
                        <BCollapse class="border-top border-top-dashed" id="contactInitiated3">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">Micro Design <BBadge tag="small" variant="success-subtle"
            ...
            <BCol>
                <BCard no-body>
                    <BLink class="card-header bg-primary-subtle border-0" role="button" v-b-toggle.needsIdentified>
                        <h5 class="card-title text-uppercase fw-bold mb-1 fs-15">Needs Identified</h5>
                        <p class="text-muted mb-0">$708,200 <span class="fw-semibold">7 Deals</span></p>
                    </BLink>
                </BCard>
                <BCollapse id="needsIdentified" visible>
                    <BCard no-body class="mb-1">
                        ...
                        <BCollapse class="border-top border-top-dashed" id="needsIdentified1">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">Alexis Clarke <BBadge tag="small" variant="danger-subtle"
                    ...
                    <BCard no-body class="mb-1">
                        ...
                        <BCollapse class="border-top border-top-dashed" id="needsIdentified2">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">Meta4Systems <BBadge variant="warning-subtle"
                    ...
                    <BCard no-body class="mb-1">
                        ...
                        <BCollapse class="border-top border-top-dashed" id="needsIdentified3">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">Syntyce Solutions <BBadge variant="danger-subtle"
                    ...
                    <BCard no-body class="mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <BCollapse class="border-top border-top-dashed" id="needsIdentified4">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">Themesbrand <BBadge tag="small" variant="danger-subtle"
                    ...
                    <BCard no-body class="mb-1">
                        ...
                        <BCollapse class="border-top border-top-dashed" id="needsIdentified6">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">iTest Factory <BBadge variant="warning-subtle" tag="small"
                    ...
                    <BCard no-body>
                        ...
                        <BCollapse class="border-top border-top-dashed" id="needsIdentified7">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">Meta4Systems <BBadge tag="small" variant="success-subtle"
            ...
            <BCol>
                <BCard no-body>
                    <BLink class="card-header bg-info-subtle border-0" role="button" v-b-toggle.meetingArranged>
                        <h5 class="card-title text-uppercase fw-bold mb-1 fs-15">Meeting Arranged</h5>
                        <p class="text-muted mb-0">$44,900 <span class="fw-semibold">3 Deals</span></p>
                    </BLink>
                </BCard>
            ...
            <BCol>
                <BCard no-body>
                    <BLink class="card-header bg-primary-subtle" role="button" v-b-toggle.offerAccepted>
                        <h5 class="card-title text-uppercase fw-bold mb-1 fs-15">Offer Accepted</h5>
                        <p class="text-muted mb-0">$819,300 <span class="fw-semibold">8 Deals</span></p>
                    </BLink>
                </BCard>
                <BCollapse id="offerAccepted" visible>
                    ...
                    <BCard no-body class="mb-1 ribbon-box ribbon-fill ribbon-sm">
                        ...
                        <BCollapse class="border-top border-top-dashed" id="offerAccepted2">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">Nesta Technologies <BBadge tag="small" variant="warning-subtle"
                    ...
                    <BCard no-body class="mb-1">
                        ...
                        <BCollapse class="border-top border-top-dashed" id="offerAccepted4">
                            <BCardBody>
                                <h6 class="fs-15 mb-1">Nesta Technologies <BBadge tag="small" variant="success-subtle"
