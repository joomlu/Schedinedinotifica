                    ...
                    <div class="table-responsive table-card">
                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <BLink href="#!" class="fw-medium text-body">#VZ2112</BLink>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <BLink href="#!" class="fw-medium text-body">#VZ2111</BLink>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <BLink href="#!" class="fw-medium text-body">#VZ2109</BLink>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                    ...
                                    <td>
                                        <h5 class="fs-14 fw-medium mb-0">4.9<span class="text-muted fs-12 ms-1">(89
                                                Rating)</span></h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <BLink href="#!" class="fw-medium text-body">#VZ2108</BLink>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                    ...
                                    <td>
                                        <h5 class="fs-14 fw-medium mb-0">4.3<span class="text-muted fs-12 ms-1">(47
                                                Rating)</span></h5>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="fs-14 fw-medium mb-0">4.7<span class="text-muted fs-12 ms-1">(161
                                                Rating)</span></h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <BLink href="#!" class="fw-medium text-body">#VZ2110</BLink>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                    ...
                                    <td>
                                        <h5 class="fs-14 fw-medium mb-0">4.7<span class="text-muted fs-12 ms-1">(3.21k
                                                Rating)</span></h5>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="fs-14 fw-medium mb-0">4.7<span class="text-muted fs-12 ms-1">(2.93k
                                                Rating)</span></h5>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="fs-14 fw-medium mb-0">4.7<span class="text-muted fs-12 ms-1">(4.31k
                                                Rating)</span></h5>
                                    </td>
                                </tr>
                            </tbody>
            ...
            <BCard no-body class="card-height-100">
                ...
                <BCardBody>
                    ...
                    <div class="px-2 py-2 mt-4">
                        <p class="mb-1 fs-15 d-flex" style="justify-content: space-between;">Canada <span >75%</span></p>
                        <BProgress striped :value="75" class="mt-2" variant="secondary" style="height: 6px;" />

                        <p class="mt-3 fs-15 mb-1 d-flex" style="justify-content: space-between;">Greenland <span >47%</span>
                        </p>
                        <BProgress striped :value="47" class="mt-2" variant="secondary" style="height: 6px;" />

                        <p class="mt-3 fs-15 mb-1 d-flex" style="justify-content: space-between;">Russia <span >82%</span></p>
                        <BProgress striped :value="82" class="mt-2" variant="secondary" style="height: 6px;" />
                    </div>
                </BCardBody>
            </BCard>
        </BCol>
