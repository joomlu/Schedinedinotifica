    ...
    return {
      ...
      portfolioChart: {
        ...
        chartOptions: {
          ...
          colors: getChartColorsArray('["--vz-primary", "--vz-primary-rgb, 0.80", "--vz-primary-rgb, 0.6", "--vz-primary-rgb, 0.4"]'),
        },
      },
      topReferralsChart: {
        series: [{
    ...
    <BRow>
            ...
            <BRow class="align-items-end">
              <BCol sm="8">
                <div class="p-3">
                  ...
                  <div class="mt-3">
                    <Link href="/pages/profile" class="btn btn-primary">Upgrade Account!</Link>
                  </div>
                </div>
              </BCol>
              <BCol sm="4">
      ...
      <BCol xl="4">
        <BCard no-body class="bg-primary">
          <BCardBody class="p-0">
            <BAlert variant="info" class="rounded-top alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center" show>
              ...
              <div class="flex-shrink-0">
                <div class="avatar-md me-3">
                  <span class="avatar-title bg-info-subtle rounded-circle fs-1">
                    <i class="ri-gift-2-line text-info"></i>
                  </span>
                </div>
              </div>
              <div>
                ...
                <div class="mt-3">
                  <Link href="/pages/profile" class="btn btn-primary">Get a Free Gift</Link>
                </div>
              </div>
            </div>
          </BCardBody>
        ...
        <BCard no-body class="card-height-100">
          <BCardHeader class="border-0 align-items-center d-flex">
            ...
            <div class="hstack gap-1 justify-content-end">
              <BButton variant="soft-info" size="sm">
                ALL
              </BButton>
              <BButton variant="soft-info" size="sm">
                1M
