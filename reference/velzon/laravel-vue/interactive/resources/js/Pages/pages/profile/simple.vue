                  ...
                  <BCard no-body>
                    <BCardBody>
                      ...
                      <BProgress class="animated-progress custom-progress progress-label">
                        <BProgressBar :value="30" variant="info">
                      ...
                      <div>
                        <div class="d-flex align-items-center py-3">
                          ...
                          <div class="flex-shrink-0 ms-2">
                            <BButton type="button" variant="outline-info" size="sm">
                  ...
                  <BRow>
                    <BCol lg="12">
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <BLink href="javascript:void(0)" class="text-body">Artboard-documents.zip</BLink>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <BLink href="javascript:void(0);" class="text-body">Bank Management System</BLink>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <BLink href="javascript:void(0);" class="text-body">Tour-video.mp4</BLink>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <BLink href="javascript:void(0);" class="text-body">Account-statement.xsl</BLink>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <BLink href="javascript:void(0);" class="text-body">Project Screenshots Collection</BLink>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                      ...
                      <div class="text-center mt-3">
                        <BLink href="javascript:void(0);" class="text-info"><i
