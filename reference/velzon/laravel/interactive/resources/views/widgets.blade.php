            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-sm-4">
                            <div class="px-3">
                                <img src="{{ URL::asset('build/images/user-illustarator-2.png') }}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card bg-primary">
                <div class="card-body p-0">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-sm-4">
                            <div class="px-3">
                                <img src="{{ URL::asset('build/images/user-illustarator-1.png') }}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="d-flex p-3">
                        ...
                        <div>
                            ...
                            <div class="mt-3">
                                <a href="pages-pricing" class="btn btn-primary">Get a Free Gift</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- end card-body-->
                ...
                <div class="card-body p-0">
                    <div>
                        <div id="countries_charts"
                            data-colors='["--vz-info", "--vz-info", "--vz-info", "--vz-info", "--vz-primary", "--vz-info", "--vz-info", "--vz-info", "--vz-info", "--vz-info"]'
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    <div id="portfolio_donut_charts"
                        data-colors='["--vz-primary", "--vz-primary-rgb, 0.80", "--vz-primary-rgb, 0.6", "--vz-primary-rgb, 0.4"]'
                        class="apex-charts" dir="ltr"></div>
