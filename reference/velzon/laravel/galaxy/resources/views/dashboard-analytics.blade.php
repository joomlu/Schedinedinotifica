                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body p-0">
                                <div class="alert alert-primary border-0 rounded-0 rounded-top m-0 d-flex align-items-center"
                                    role="alert">
                                ...
                                <div class="row align-items-end">
                                    <div class="col-sm-8">
                                        <div class="p-3">
                                            ...
                                            <div class="mt-3">
                                                <a href="pages-pricing" class="btn btn-primary">Upgrade Account!</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                ...
                <div class="card-body p-0">
                    <div>
                        <div id="audiences-sessions-country-charts"
                            data-colors='["--vz-primary", "--vz-secondary",  "--vz-secondary-bg"]' class="apex-charts"
                            dir="ltr"> </div>
                    </div>
                </div><!-- end cardbody -->
            </div><!-- end card -->
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    <div id="user_device_pie_charts"
                        data-colors='["--vz-primary", "--vz-primary-rgb, .75", "--vz-primary-rgb, 0.60"]'
                        class="apex-charts" dir="ltr"></div>
