        ...
        <div class="col-xl-6">
            <div class="card card-height-100">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a href="#!" class="btn btn-soft-secondary btn-sm">View All Companies <i
        ...
        <div class="col-xxl-8">
            <div class="card card-height-100">
                ...
                <div class="card-body p-0 pb-2">
                    <div class="w-100">
                        <div id="line_chart_dashed" data-colors='["--vz-secondary", "--vz-success", "--vz-primary"]'
