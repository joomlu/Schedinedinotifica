    ...
    <div class="row dash-nft">
                                ...
                                <div class="col-xxl-8">
                                    <div class="">
                                        ...
                                        <div class="row g-0 text-center">
                                            <div class="col-6 col-sm-4">
                                                <div class="p-3 border border-dashed border-start-0">
                                                    <h5 class="mb-1 fs-16"><span class="counter-value"
                                        ...
                                        <div id="line_chart_basic"
                                            data-colors='["--vz-primary","--vz-secondary", "--vz-light"]'
                                ...
                                <div class="col-xxl-4">
                                    <div class="border-start p-4 h-100 d-flex flex-column">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <h4 class="ff-secondary fw-bold mt-4"><i
                                                    class="mdi mdi-ethereum text-primary"></i> 346.12 ETH</h4>
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    ...
                                                    <h4 class="fs-18 ff-secondary fw-semibold mb-0">342.74 ETH</h4>
                                                </div>

                                                <div>
                                                    <p class="fs-14 text-muted mb-1">Highest Bid</p>
                                                    <h4 class="fs-18 ff-secondary fw-semibold mb-0">346.67 ETH</h4>
                                                </div>
                                            </div>
        ...
        <div class="col-xxl-3">
            <div class="card">
                ...
                <div>
                    <div id="market-overview" data-colors='["--vz-success", "--vz-secondary"]' class="apex-charts mt-n4">
                    </div>
                </div>
            </div>
                        ...
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    37.41k </p>
                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="text-body">Walking On
                                        Air</a></h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    19.29k </p>
                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="text-body">Filtered
                                        Portrait</a></h5>
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    8.42k </p>
                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="text-body">Patterns
                                        Arts & Culture</a></h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                            <div class="card-footer border-top border-top-dashed">
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    15.93k </p>
                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="text-body">Evolved
                                        Reality</a></h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <a href="#!">
                                                        <h6 class="mb-1">The Cat X Takashi</h6>
                                                    </a>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details"
                                                        class="text-body">Abstract Face Painting</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details"
                                                        class="text-body">Long-tailed Macaque</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details"
                                                        class="text-body">Robotic Body Art</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details"
                                                        class="text-body">Smillevers Crypto</a></h6>
                                                <p class="text-muted fs-13 mb-0">Artworks</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details"
                                                        class="text-body">Creative Filtered Portrait</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="apps-nft-item-details" class="text-body">The
                                                        Chirstoper</a></h6>
