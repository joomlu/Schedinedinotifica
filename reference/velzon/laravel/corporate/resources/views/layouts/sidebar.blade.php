                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="apps-file-manager" class="nav-link"> @lang('translation.file-manager')</a>
                            </li>
                            <li class="nav-item">
                                <a href="apps-todo" class="nav-link"> @lang('translation.to-do')</a>
                            </li>
                            <li class="nav-item">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-slope"
                                                class="nav-link"><span>@lang('translation.slope')</span>
                                                <span
                                                    class="badge badge-pill bg-success">@lang('translation.new')</span></a>
                                        </li>
                                    </ul>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-feather" class="nav-link"><span>@lang('translation.feather')Feather</span>
