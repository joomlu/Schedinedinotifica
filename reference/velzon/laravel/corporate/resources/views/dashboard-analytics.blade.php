                                ...
                                <div class="row align-items-end">
                                    <div class="col-sm-8">
                                        <div class="p-3">
                                            ...
                                            <div class="mt-3">
                                                <a href="pages-pricing" class="btn btn-secondary">Upgrade Account!</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <h4 class="mt-4 fs-22 ff-secondary fw-semibold"><span class="counter-value"
                                                data-target="28.05">0</span>k</h4>
                        ...
                        <div class="card-body p-0">
                            <div>
                                <div id="countries_charts"
                                    data-colors='["--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-secondary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary"]'
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card card-height-100">
                ...
                <div class="card-body p-0">
                    <div>
                        <div id="audiences-sessions-country-charts" data-colors='["--vz-secondary", "--vz-primary"]'
                            class="apex-charts" dir="ltr"> </div>
                    </div>
                </div><!-- end cardbody -->
            </div><!-- end card -->
