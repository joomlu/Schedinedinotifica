            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                        ...
                        <i data-feather="layout" class="icon-dual"></i> <span>@lang('translation.layouts')</span><span
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-slope" class="nav-link"><span
                                                   >@lang('translation.slope')</span> <span
                                                    class="badge badge-pill bg-success"
                                                   >@lang('translation.new')</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-feather" class="nav-link"><span
