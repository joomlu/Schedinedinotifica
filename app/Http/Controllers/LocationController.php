...
class LocationController extends Controller
{
    ...
    {
        Log::info('Petición a nations', $request->all());
        ...
        Log::info('Respuesta de nations', ['count' => count($items)]);
        return response()->json($items);
    }

    public function regions(Request $request)
    {
        Log::info('Petición a regions', $request->all());
        $q = trim((string) $request->input('q', ''));
        ...
        Log::info('Respuesta de regions', ['count' => count($items)]);
        return response()->json($items);
    }
