...
class ProprietariController extends Controller
{
    public function indexProforme(Request $request)
    {
        ...
        return view('shared.proforme.index', [
            ...
            'proforme' => $proforme,
            'q' => $q,
            'ownerRoutePrefix' => 'superadmin.proprietari',
            'indexRoute' => 'superadmin.proforme.index',
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('superadmin.proprietari.form', $this->buildFormViewData(
            new Proprietario(),
            $admins,
            'create'
        ));
    ...
    public function update(Request $request, int $id)
    {
        ...
        $proprietario->update($this->extractProprietarioPayload($data, $proprietario) + [
            'admin_id' => $data['admin_id'] ?? $proprietario->admin_id,
        ]);
        $this->syncProprietarioAccessUser($proprietario->fresh(), $data);

        return redirect()
            ->route('superadmin.proprietari.index')
    ...
    public function destroy(int $id)
    {
        ...
        return redirect()->route('superadmin.proprietari.index')->with('status', 'Proprietario spostato nel cestino.');
    }
    ...
    public function storeProforma(Request $request, int $id)
    {
        ...
        return redirect()->route('superadmin.proprietari.proforme.show', ['id' => $proprietario->id, 'fatturazione' => $proforma->id])
    ...
    private function buildFormViewData(Proprietario $proprietario, $admins, string $mode): array
    {
    ...
    private function normalizeCustomProformaRow(array $riga): ?array
    {
        ...
        return $this->normalizeProformaRow(array_merge($riga, [
            'selected' => true,
