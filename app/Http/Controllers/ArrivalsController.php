...
class ArrivalsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $schedina->create([
            ...
            'exent' => $request->exent,
            'arrive' => $request->arrive ? \Carbon\Carbon::parse($request->arrive)->format('d/m/Y') : null,
            'departure' => $request->departure ? \Carbon\Carbon::parse($request->departure)->format('d/m/Y') : null,
            ...
            'oa_date_nac' => $request->oa_date_nac ? \Carbon\Carbon::parse($request->oa_date_nac)->format('d/m/Y') : null,
            ...
            'or_published_date' => $request->or_published_date ? \Carbon\Carbon::parse($request->or_published_date)->format('d/m/Y') : null,
            'or_expire' => $request->or_expire ? \Carbon\Carbon::parse($request->or_expire)->format('d/m/Y') : null,
