    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel"><?php echo app('translator')->get('translation.new'); ?> <?php echo app('translator')->get('translation.TypeStreet'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
            </div>
            <div class="modal-body">
<form method="POST" action="<?php echo e(route('typestreet.store')); ?>">
<?php echo csrf_field(); ?> 
<div>
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"><?php echo app('translator')->get('translation.TypeStreet'); ?></h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $typestreet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typestreets): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($typestreets->id); ?></td>
                                <td><?php echo e($typestreets->name); ?></td>
...
return confirm('Sei sicuro di eliminare definitivamente questo elemento?')" type="button"  class="btn btn-danger btn-icon waves-effect waves-light">
                      <i class="ri-delete-bin-5-line"></i><a>     
                                ...
                                <div id="ModalEdit<?php echo e($typestreets->id); ?>" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="myModalEditLabel"><?php echo app('translator')->get('translation.edit'); ?> <?php echo app('translator')->get('translation.TypeStreet'); ?></h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                                            </div>
                                            <div class="modal-body">
                                                    <form method="POST" action="<?php echo e(route('typestreet.update', $typestreets->id)); ?>">
                                                    <?php echo csrf_field(); ?> 
                                                    <?php echo method_field('PUT'); ?> 
                                                                <div>
                                                                    <label for="basiInput" class="form-label"><?php echo app('translator')->get('translation.Name'); ?></label>
                                                                    <input type="text" name="name" value="<?php echo e($typestreets->name); ?>" class="form-control" id="basiInput">
                                                                </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal"><?php echo app('translator')->get('translation.close'); ?></button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jorgeluccitelli/Herd/Schedinedinotifica/resources/views/typestreet/list.blade.php ENDPATH**/ ?>