                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body p-0 pb-3">
                                <div id="Market_chart" data-colors='["--vz-success-rgb, 0.75", "--vz-danger-rgb, 0.75"]'
                                    class="apex-charts" dir="ltr"></div>
                            </div><!-- end cardbody -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                        ...
                        <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$53,914.025</td>
                                    <td>1.25634801</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-primary">Trade</a>
                                    </td>
                                </tr><!-- end -->
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/usdt.svg')); ?>" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/dash.svg')); ?>" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/doge.svg')); ?>" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                            <div>
                    ...
                    <div class="tab-content p-0">
                        ...
                        <div class="tab-pane" id="sell-tab" role="tabpanel">
                            ...
                            <div class="p-3">
                                ...
                                <div class="mt-3 pt-2">
                                    <button type="button" class="btn btn-primary w-100">Sell
                                        Coin</button>
                                </div>
                            </div>
                        </div><!-- end tab pane -->
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush border-dashed mb-0">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/eth.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/aave.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/doge.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/bnb.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/ltc.svg')); ?>" class="avatar-xs" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    <div class="d-flex align-middle">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" class="rounded img-fluid" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" class="rounded img-fluid" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" class="rounded img-fluid" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" class="rounded img-fluid" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jorgeluccitelli/Herd/Schedinedinotifica/resources/views/dashboard-crypto.blade.php ENDPATH**/ ?>