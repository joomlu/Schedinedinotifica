<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Groups'); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> <?php echo app('translator')->get('translation.Groups'); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel"><?php echo app('translator')->get('translation.new'); ?> <?php echo app('translator')->get('translation.Group'); ?></h5>
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"><?php echo app('translator')->get('translation.Groups'); ?></h5>
            </div>
            <div class="card-body">
                    ...
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a  href="<?php echo e(route('group.destroy',['id' => $group->id] )); ?>" onclick="
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jorgeluccitelli/Herd/Schedinedinotifica/resources/views/group/list.blade.php ENDPATH**/ ?>