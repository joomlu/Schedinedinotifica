            ...
            <div class="card">
                ...
                <div class="card-body pb-0">
                    <div id="sales-forecast-chart"
                        data-colors='["--vz-primary-rgb, 0.75", "--vz-primary", "--vz-primary-rgb, 0.55"]'
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body pb-0">
                    <div id="deal-type-charts"
                        data-colors='["--vz-primary-rgb, 0.15", "--vz-primary-rgb, 0.35", "--vz-primary-rgb, 0.45"]'
                        class="apex-charts" dir="ltr"></div>
                </div><!-- end card body -->
            </div><!-- end card -->
        </div><!-- end col -->
        ...
        <div class="col-xxl-6">
            <div class="card card-height-100">
                ...
                <div class="card-body px-0">
                    ...
                    <div id="revenue-expenses-charts" data-colors='["--vz-primary", "--vz-info"]' class="apex-charts"
                        dir="ltr"></div>
                </div>
            </div><!-- end card -->
        </div><!-- end col -->
                        ...
                        <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>Absternet LLC</td>
                                    <td>Sep 20, 2021</td>
                                    <td><img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt=""
                                ...
                                <tr>
                                    <td>Raitech Soft</td>
                                    <td>Sep 23, 2021</td>
                                    <td><img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>William PVT</td>
                                    <td>Sep 27, 2021</td>
                                    <td><img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>Loiusee LLP</td>
                                    <td>Sep 30, 2021</td>
                                    <td><img src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>Apple Inc.</td>
                                    <td>Sep 30, 2021</td>
                                    <td><img src="<?php echo e(URL::asset('build/images/users/avatar-6.jpg')); ?>" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                        <a href="#javascript: void(0);" class="text-body fw-medium">Vitoria Rodrigues</a>
                                    </td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>William PVT</td>
                                    <td><img src="<?php echo e(URL::asset('build/images/users/avatar-7.jpg')); ?>" alt=""
                                            class="avatar-xs rounded-circle me-2">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jorgeluccitelli/Herd/Schedinedinotifica/resources/views/dashboard-crm.blade.php ENDPATH**/ ?>