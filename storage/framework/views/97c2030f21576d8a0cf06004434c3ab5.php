<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.SubGroups1'); ?> <?php $__env->stopSection(); ?>
...
<form method="POST" action="<?php echo e(route('subgroup1.store')); ?>">
<?php echo csrf_field(); ?> 
<div>
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"><?php echo app('translator')->get('translation.SubGroups1'); ?></h5>
            </div>
            <div class="card-body">
                                ...
                                <div id="ModalEdit<?php echo e($group->id); ?>" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    <form method="POST" action="<?php echo e(route('subgroup1.update', $group->id)); ?>">
                                                    <?php echo csrf_field(); ?> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jorgeluccitelli/Herd/Schedinedinotifica/resources/views/subgroup1/list.blade.php ENDPATH**/ ?>